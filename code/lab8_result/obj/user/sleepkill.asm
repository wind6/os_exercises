...
read(int fd, void *base, size_t len) {
  ...
  800147:	c7 04 24 a0 18 80 00 	movl   $0x8018a0,(%esp)
...
write(int fd, void *base, size_t len) {
  ...
  800171:	83 ec 18             	sub    $0x18,%esp
    cprintf("[user_write]\n");
  800174:	c7 04 24 b0 18 80 00 	movl   $0x8018b0,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80029a:	c7 04 24 be 18 80 00 	movl   $0x8018be,(%esp)
  ...
  8002b8:	c7 04 24 c9 18 80 00 	movl   $0x8018c9,(%esp)
  ...
  8002ce:	c7 04 24 db 18 80 00 	movl   $0x8018db,(%esp)
  ...
  8002e4:	c7 04 24 ee 18 80 00 	movl   $0x8018ee,(%esp)
  ...
  8002fa:	c7 04 24 01 19 80 00 	movl   $0x801901,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80033a:	c7 04 24 14 19 80 00 	movl   $0x801914,(%esp)
  ...
  800353:	e8 7e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  800358:	c7 04 24 2e 19 80 00 	movl   $0x80192e,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80038a:	c7 04 24 30 19 80 00 	movl   $0x801930,(%esp)
  ...
  8003a3:	e8 2e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  8003a8:	c7 04 24 2e 19 80 00 	movl   $0x80192e,(%esp)
...
exit(int error_code) {
  ...
  8008e5:	c7 04 24 4c 19 80 00 	movl   $0x80194c,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a51:	00 
  800a52:	c7 44 24 04 5f 19 80 	movl   $0x80195f,0x4(%esp)
  800a59:	00 
  ...
  800a76:	c7 44 24 08 66 19 80 	movl   $0x801966,0x8(%esp)
  800a7d:	00 
  800a7e:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a85:	00 
  800a86:	c7 04 24 80 19 80 00 	movl   $0x801980,(%esp)
  800a8d:	e8 de f8 ff ff       	call   800370 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a92:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a99:	00 
  800a9a:	c7 44 24 04 92 19 80 	movl   $0x801992,0x4(%esp)
  800aa1:	00 
  ...
  800abe:	c7 44 24 08 9a 19 80 	movl   $0x80199a,0x8(%esp)
  800ac5:	00 
  800ac6:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800acd:	00 
  800ace:	c7 04 24 80 19 80 00 	movl   $0x801980,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c16:	05 c4 1b 80 00       	add    $0x801bc4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d7a:	8b 04 85 e8 1b 80 00 	mov    0x801be8(,%eax,4),%eax
  ...
  800e93:	c7 44 24 0c de 1b 80 	movl   $0x801bde,0xc(%esp)
  800e9a:	00 
  ...
  800ec6:	75 05                	jne    800ecd <vprintfmt+0x1c9>
                p = "(null)";
  800ec8:	be e1 1b 80 00       	mov    $0x801be1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017f4:	75 18                	jne    80180e <main+0x31>
        sleep(~0);
  8017f6:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  8017fd:	e8 81 f1 ff ff       	call   800983 <sleep>
        exit(0xdead);
  801802:	c7 04 24 ad de 00 00 	movl   $0xdead,(%esp)
  801809:	e8 c6 f0 ff ff       	call   8008d4 <exit>
    }
    assert(pid > 0);
  80180e:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801813:	7f 24                	jg     801839 <main+0x5c>
  801815:	c7 44 24 0c 40 1d 80 	movl   $0x801d40,0xc(%esp)
  80181c:	00 
  80181d:	c7 44 24 08 48 1d 80 	movl   $0x801d48,0x8(%esp)
  801824:	00 
  801825:	c7 44 24 04 0b 00 00 	movl   $0xb,0x4(%esp)
  80182c:	00 
  80182d:	c7 04 24 5d 1d 80 00 	movl   $0x801d5d,(%esp)
  801834:	e8 e7 ea ff ff       	call   800320 <__panic>

    sleep(100);
  801839:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  801840:	e8 3e f1 ff ff       	call   800983 <sleep>
    assert(kill(pid) == 0);
  801845:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801849:	89 04 24             	mov    %eax,(%esp)
  80184c:	e8 f2 f0 ff ff       	call   800943 <kill>
  801851:	85 c0                	test   %eax,%eax
  801853:	74 24                	je     801879 <main+0x9c>
  801855:	c7 44 24 0c 6e 1d 80 	movl   $0x801d6e,0xc(%esp)
  80185c:	00 
  80185d:	c7 44 24 08 48 1d 80 	movl   $0x801d48,0x8(%esp)
  801864:	00 
  801865:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  80186c:	00 
  80186d:	c7 04 24 5d 1d 80 00 	movl   $0x801d5d,(%esp)
  801874:	e8 a7 ea ff ff       	call   800320 <__panic>
    cprintf("sleepkill pass.\n");
  801879:	c7 04 24 7d 1d 80 00 	movl   $0x801d7d,(%esp)
  801880:	e8 8c eb ff ff       	call   800411 <cprintf>
    return 0;
