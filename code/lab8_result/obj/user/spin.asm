...
read(int fd, void *base, size_t len) {
  ...
  800147:	c7 04 24 20 19 80 00 	movl   $0x801920,(%esp)
...
write(int fd, void *base, size_t len) {
  ...
  800171:	83 ec 18             	sub    $0x18,%esp
    cprintf("[user_write]\n");
  800174:	c7 04 24 30 19 80 00 	movl   $0x801930,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80029a:	c7 04 24 3e 19 80 00 	movl   $0x80193e,(%esp)
  ...
  8002b8:	c7 04 24 49 19 80 00 	movl   $0x801949,(%esp)
  ...
  8002ce:	c7 04 24 5b 19 80 00 	movl   $0x80195b,(%esp)
  ...
  8002e4:	c7 04 24 6e 19 80 00 	movl   $0x80196e,(%esp)
  ...
  8002fa:	c7 04 24 81 19 80 00 	movl   $0x801981,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80033a:	c7 04 24 94 19 80 00 	movl   $0x801994,(%esp)
  ...
  800353:	e8 7e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  800358:	c7 04 24 ae 19 80 00 	movl   $0x8019ae,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80038a:	c7 04 24 b0 19 80 00 	movl   $0x8019b0,(%esp)
  ...
  8003a3:	e8 2e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  8003a8:	c7 04 24 ae 19 80 00 	movl   $0x8019ae,(%esp)
...
exit(int error_code) {
  ...
  8008e5:	c7 04 24 cc 19 80 00 	movl   $0x8019cc,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a51:	00 
  800a52:	c7 44 24 04 df 19 80 	movl   $0x8019df,0x4(%esp)
  800a59:	00 
  ...
  800a76:	c7 44 24 08 e6 19 80 	movl   $0x8019e6,0x8(%esp)
  800a7d:	00 
  800a7e:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a85:	00 
  800a86:	c7 04 24 00 1a 80 00 	movl   $0x801a00,(%esp)
  800a8d:	e8 de f8 ff ff       	call   800370 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a92:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a99:	00 
  800a9a:	c7 44 24 04 12 1a 80 	movl   $0x801a12,0x4(%esp)
  800aa1:	00 
  ...
  800abe:	c7 44 24 08 1a 1a 80 	movl   $0x801a1a,0x8(%esp)
  800ac5:	00 
  800ac6:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800acd:	00 
  800ace:	c7 04 24 00 1a 80 00 	movl   $0x801a00,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c16:	05 44 1c 80 00       	add    $0x801c44,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d7a:	8b 04 85 68 1c 80 00 	mov    0x801c68(,%eax,4),%eax
  ...
  800e93:	c7 44 24 0c 5e 1c 80 	movl   $0x801c5e,0xc(%esp)
  800e9a:	00 
  ...
  800ec6:	75 05                	jne    800ecd <vprintfmt+0x1c9>
                p = "(null)";
  800ec8:	be 61 1c 80 00       	mov    $0x801c61,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017e6:	c7 04 24 c0 1d 80 00 	movl   $0x801dc0,(%esp)
  ...
  801800:	75 0e                	jne    801810 <main+0x33>
        cprintf("I am the child. spinning ...\n");
  801802:	c7 04 24 e7 1d 80 00 	movl   $0x801de7,(%esp)
  801809:	e8 03 ec ff ff       	call   800411 <cprintf>
        while (1);
  80180e:	eb fe                	jmp    80180e <main+0x31>
    }else if (pid<0) {
  801810:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801815:	79 1c                	jns    801833 <main+0x56>
        panic("fork child error\n");
  801817:	c7 44 24 08 05 1e 80 	movl   $0x801e05,0x8(%esp)
  80181e:	00 
  80181f:	c7 44 24 04 0d 00 00 	movl   $0xd,0x4(%esp)
  801826:	00 
  801827:	c7 04 24 17 1e 80 00 	movl   $0x801e17,(%esp)
  80182e:	e8 ed ea ff ff       	call   800320 <__panic>
    }
    cprintf("I am the parent. Running the child...\n");
  801833:	c7 04 24 24 1e 80 00 	movl   $0x801e24,(%esp)
  80183a:	e8 d2 eb ff ff       	call   800411 <cprintf>

    yield();
  80183f:	e8 f2 f0 ff ff       	call   800936 <yield>
    yield();
  801844:	e8 ed f0 ff ff       	call   800936 <yield>
    yield();
  801849:	e8 e8 f0 ff ff       	call   800936 <yield>
    
    cprintf("I am the parent.  Killing the child...\n");
  80184e:	c7 04 24 4c 1e 80 00 	movl   $0x801e4c,(%esp)
  801855:	e8 b7 eb ff ff       	call   800411 <cprintf>

    assert((ret = kill(pid)) == 0);
  80185a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80185e:	89 04 24             	mov    %eax,(%esp)
  801861:	e8 dd f0 ff ff       	call   800943 <kill>
  801866:	89 44 24 18          	mov    %eax,0x18(%esp)
  80186a:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80186f:	74 24                	je     801895 <main+0xb8>
  801871:	c7 44 24 0c 74 1e 80 	movl   $0x801e74,0xc(%esp)
  801878:	00 
  801879:	c7 44 24 08 8b 1e 80 	movl   $0x801e8b,0x8(%esp)
  801880:	00 
  801881:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801888:	00 
  801889:	c7 04 24 17 1e 80 00 	movl   $0x801e17,(%esp)
  801890:	e8 8b ea ff ff       	call   800320 <__panic>
    cprintf("kill returns %d\n", ret);
  801895:	8b 44 24 18          	mov    0x18(%esp),%eax
  801899:	89 44 24 04          	mov    %eax,0x4(%esp)
  80189d:	c7 04 24 a0 1e 80 00 	movl   $0x801ea0,(%esp)
  8018a4:	e8 68 eb ff ff       	call   800411 <cprintf>

    assert((ret = waitpid(pid, NULL)) == 0);
  8018a9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8018b0:	00 
  8018b1:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018b5:	89 04 24             	mov    %eax,(%esp)
  8018b8:	e8 5f f0 ff ff       	call   80091c <waitpid>
  8018bd:	89 44 24 18          	mov    %eax,0x18(%esp)
  8018c1:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8018c6:	74 24                	je     8018ec <main+0x10f>
  8018c8:	c7 44 24 0c b4 1e 80 	movl   $0x801eb4,0xc(%esp)
  8018cf:	00 
  8018d0:	c7 44 24 08 8b 1e 80 	movl   $0x801e8b,0x8(%esp)
  8018d7:	00 
  8018d8:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  8018df:	00 
  8018e0:	c7 04 24 17 1e 80 00 	movl   $0x801e17,(%esp)
  8018e7:	e8 34 ea ff ff       	call   800320 <__panic>
    cprintf("wait returns %d\n", ret);
  8018ec:	8b 44 24 18          	mov    0x18(%esp),%eax
  8018f0:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018f4:	c7 04 24 d4 1e 80 00 	movl   $0x801ed4,(%esp)
  8018fb:	e8 11 eb ff ff       	call   800411 <cprintf>

    cprintf("spin may pass.\n");
  801900:	c7 04 24 e5 1e 80 00 	movl   $0x801ee5,(%esp)
  801907:	e8 05 eb ff ff       	call   800411 <cprintf>
    return 0;
