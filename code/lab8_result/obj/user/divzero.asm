...
read(int fd, void *base, size_t len) {
  ...
  800147:	c7 04 24 20 18 80 00 	movl   $0x801820,(%esp)
...
write(int fd, void *base, size_t len) {
  ...
  800171:	83 ec 18             	sub    $0x18,%esp
    cprintf("[user_write]\n");
  800174:	c7 04 24 30 18 80 00 	movl   $0x801830,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80029a:	c7 04 24 3e 18 80 00 	movl   $0x80183e,(%esp)
  ...
  8002b8:	c7 04 24 49 18 80 00 	movl   $0x801849,(%esp)
  ...
  8002ce:	c7 04 24 5b 18 80 00 	movl   $0x80185b,(%esp)
  ...
  8002e4:	c7 04 24 6e 18 80 00 	movl   $0x80186e,(%esp)
  ...
  8002fa:	c7 04 24 81 18 80 00 	movl   $0x801881,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80033a:	c7 04 24 94 18 80 00 	movl   $0x801894,(%esp)
  ...
  800353:	e8 7e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  800358:	c7 04 24 ae 18 80 00 	movl   $0x8018ae,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80038a:	c7 04 24 b0 18 80 00 	movl   $0x8018b0,(%esp)
  ...
  8003a3:	e8 2e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  8003a8:	c7 04 24 ae 18 80 00 	movl   $0x8018ae,(%esp)
...
exit(int error_code) {
  ...
  8008e5:	c7 04 24 cc 18 80 00 	movl   $0x8018cc,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a51:	00 
  800a52:	c7 44 24 04 df 18 80 	movl   $0x8018df,0x4(%esp)
  800a59:	00 
  ...
  800a76:	c7 44 24 08 e6 18 80 	movl   $0x8018e6,0x8(%esp)
  800a7d:	00 
  800a7e:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a85:	00 
  800a86:	c7 04 24 00 19 80 00 	movl   $0x801900,(%esp)
  800a8d:	e8 de f8 ff ff       	call   800370 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a92:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a99:	00 
  800a9a:	c7 44 24 04 12 19 80 	movl   $0x801912,0x4(%esp)
  800aa1:	00 
  ...
  800abe:	c7 44 24 08 1a 19 80 	movl   $0x80191a,0x8(%esp)
  800ac5:	00 
  800ac6:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800acd:	00 
  800ace:	c7 04 24 00 19 80 00 	movl   $0x801900,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c16:	05 44 1b 80 00       	add    $0x801b44,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d7a:	8b 04 85 68 1b 80 00 	mov    0x801b68(,%eax,4),%eax
  ...
  800e93:	c7 44 24 0c 5e 1b 80 	movl   $0x801b5e,0xc(%esp)
  800e9a:	00 
  ...
  800ec6:	75 05                	jne    800ecd <vprintfmt+0x1c9>
                p = "(null)";
  800ec8:	be 61 1b 80 00       	mov    $0x801b61,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017e3:	83 ec 10             	sub    $0x10,%esp
    cprintf("value is %d.\n", 1 / zero);
  8017e6:	8b 0d 48 21 80 00    	mov    0x802148,%ecx
  8017ec:	b8 01 00 00 00       	mov    $0x1,%eax
  8017f1:	99                   	cltd   
  8017f2:	f7 f9                	idiv   %ecx
  8017f4:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017f8:	c7 04 24 c0 1c 80 00 	movl   $0x801cc0,(%esp)
  8017ff:	e8 0d ec ff ff       	call   800411 <cprintf>
    panic("FAIL: T.T\n");
  801804:	c7 44 24 08 ce 1c 80 	movl   $0x801cce,0x8(%esp)
  80180b:	00 
  80180c:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  801813:	00 
  801814:	c7 04 24 d9 1c 80 00 	movl   $0x801cd9,(%esp)
  80181b:	e8 00 eb ff ff       	call   800320 <__panic>
