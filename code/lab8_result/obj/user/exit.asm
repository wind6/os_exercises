...
read(int fd, void *base, size_t len) {
  ...
  800147:	c7 04 24 40 19 80 00 	movl   $0x801940,(%esp)
...
write(int fd, void *base, size_t len) {
  ...
  800171:	83 ec 18             	sub    $0x18,%esp
    cprintf("[user_write]\n");
  800174:	c7 04 24 50 19 80 00 	movl   $0x801950,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80029a:	c7 04 24 5e 19 80 00 	movl   $0x80195e,(%esp)
  ...
  8002b8:	c7 04 24 69 19 80 00 	movl   $0x801969,(%esp)
  ...
  8002ce:	c7 04 24 7b 19 80 00 	movl   $0x80197b,(%esp)
  ...
  8002e4:	c7 04 24 8e 19 80 00 	movl   $0x80198e,(%esp)
  ...
  8002fa:	c7 04 24 a1 19 80 00 	movl   $0x8019a1,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80033a:	c7 04 24 b4 19 80 00 	movl   $0x8019b4,(%esp)
  ...
  800353:	e8 7e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  800358:	c7 04 24 ce 19 80 00 	movl   $0x8019ce,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80038a:	c7 04 24 d0 19 80 00 	movl   $0x8019d0,(%esp)
  ...
  8003a3:	e8 2e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  8003a8:	c7 04 24 ce 19 80 00 	movl   $0x8019ce,(%esp)
...
exit(int error_code) {
  ...
  8008e5:	c7 04 24 ec 19 80 00 	movl   $0x8019ec,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a51:	00 
  800a52:	c7 44 24 04 ff 19 80 	movl   $0x8019ff,0x4(%esp)
  800a59:	00 
  ...
  800a76:	c7 44 24 08 06 1a 80 	movl   $0x801a06,0x8(%esp)
  800a7d:	00 
  800a7e:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a85:	00 
  800a86:	c7 04 24 20 1a 80 00 	movl   $0x801a20,(%esp)
  800a8d:	e8 de f8 ff ff       	call   800370 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a92:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a99:	00 
  800a9a:	c7 44 24 04 32 1a 80 	movl   $0x801a32,0x4(%esp)
  800aa1:	00 
  ...
  800abe:	c7 44 24 08 3a 1a 80 	movl   $0x801a3a,0x8(%esp)
  800ac5:	00 
  800ac6:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800acd:	00 
  800ace:	c7 04 24 20 1a 80 00 	movl   $0x801a20,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c16:	05 64 1c 80 00       	add    $0x801c64,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d7a:	8b 04 85 88 1c 80 00 	mov    0x801c88(,%eax,4),%eax
  ...
  800e93:	c7 44 24 0c 7e 1c 80 	movl   $0x801c7e,0xc(%esp)
  800e9a:	00 
  ...
  800ec6:	75 05                	jne    800ecd <vprintfmt+0x1c9>
                p = "(null)";
  800ec8:	be 81 1c 80 00       	mov    $0x801c81,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017e6:	c7 04 24 e0 1d 80 00 	movl   $0x801de0,(%esp)
  8017ed:	e8 1f ec ff ff       	call   800411 <cprintf>
    if ((pid = fork()) == 0) {
  8017f2:	e8 fc f0 ff ff       	call   8008f3 <fork>
  8017f7:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  8017fb:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801800:	75 3c                	jne    80183e <main+0x61>
        cprintf("I am the child.\n");
  801802:	c7 04 24 07 1e 80 00 	movl   $0x801e07,(%esp)
  801809:	e8 03 ec ff ff       	call   800411 <cprintf>
        yield();
  80180e:	e8 23 f1 ff ff       	call   800936 <yield>
        yield();
  801813:	e8 1e f1 ff ff       	call   800936 <yield>
        yield();
  801818:	e8 19 f1 ff ff       	call   800936 <yield>
        yield();
  80181d:	e8 14 f1 ff ff       	call   800936 <yield>
        yield();
  801822:	e8 0f f1 ff ff       	call   800936 <yield>
        yield();
  801827:	e8 0a f1 ff ff       	call   800936 <yield>
        yield();
  80182c:	e8 05 f1 ff ff       	call   800936 <yield>
        exit(magic);
  801831:	a1 10 20 80 00       	mov    0x802010,%eax
  801836:	89 04 24             	mov    %eax,(%esp)
  801839:	e8 96 f0 ff ff       	call   8008d4 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  80183e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801842:	89 44 24 04          	mov    %eax,0x4(%esp)
  801846:	c7 04 24 18 1e 80 00 	movl   $0x801e18,(%esp)
  80184d:	e8 bf eb ff ff       	call   800411 <cprintf>
    }
    assert(pid > 0);
  801852:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801857:	7f 24                	jg     80187d <main+0xa0>
  801859:	c7 44 24 0c 3a 1e 80 	movl   $0x801e3a,0xc(%esp)
  801860:	00 
  801861:	c7 44 24 08 42 1e 80 	movl   $0x801e42,0x8(%esp)
  801868:	00 
  801869:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  801870:	00 
  801871:	c7 04 24 57 1e 80 00 	movl   $0x801e57,(%esp)
  801878:	e8 a3 ea ff ff       	call   800320 <__panic>
    cprintf("I am the parent, waiting now..\n");
  80187d:	c7 04 24 64 1e 80 00 	movl   $0x801e64,(%esp)
  801884:	e8 88 eb ff ff       	call   800411 <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  801889:	8d 44 24 18          	lea    0x18(%esp),%eax
  80188d:	89 44 24 04          	mov    %eax,0x4(%esp)
  801891:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801895:	89 04 24             	mov    %eax,(%esp)
  801898:	e8 7f f0 ff ff       	call   80091c <waitpid>
  80189d:	85 c0                	test   %eax,%eax
  80189f:	75 0d                	jne    8018ae <main+0xd1>
  8018a1:	8b 54 24 18          	mov    0x18(%esp),%edx
  8018a5:	a1 10 20 80 00       	mov    0x802010,%eax
  8018aa:	39 c2                	cmp    %eax,%edx
  8018ac:	74 24                	je     8018d2 <main+0xf5>
  8018ae:	c7 44 24 0c 84 1e 80 	movl   $0x801e84,0xc(%esp)
  8018b5:	00 
  8018b6:	c7 44 24 08 42 1e 80 	movl   $0x801e42,0x8(%esp)
  8018bd:	00 
  8018be:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  8018c5:	00 
  8018c6:	c7 04 24 57 1e 80 00 	movl   $0x801e57,(%esp)
  8018cd:	e8 4e ea ff ff       	call   800320 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  8018d2:	8d 44 24 18          	lea    0x18(%esp),%eax
  8018d6:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018da:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018de:	89 04 24             	mov    %eax,(%esp)
  8018e1:	e8 36 f0 ff ff       	call   80091c <waitpid>
  8018e6:	85 c0                	test   %eax,%eax
  8018e8:	74 09                	je     8018f3 <main+0x116>
  8018ea:	e8 11 f0 ff ff       	call   800900 <wait>
  8018ef:	85 c0                	test   %eax,%eax
  8018f1:	75 24                	jne    801917 <main+0x13a>
  8018f3:	c7 44 24 0c b0 1e 80 	movl   $0x801eb0,0xc(%esp)
  8018fa:	00 
  8018fb:	c7 44 24 08 42 1e 80 	movl   $0x801e42,0x8(%esp)
  801902:	00 
  801903:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  80190a:	00 
  80190b:	c7 04 24 57 1e 80 00 	movl   $0x801e57,(%esp)
  801912:	e8 09 ea ff ff       	call   800320 <__panic>
    cprintf("waitpid %d ok.\n", pid);
  801917:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80191b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80191f:	c7 04 24 d8 1e 80 00 	movl   $0x801ed8,(%esp)
  801926:	e8 e6 ea ff ff       	call   800411 <cprintf>

    cprintf("exit pass.\n");
  80192b:	c7 04 24 e8 1e 80 00 	movl   $0x801ee8,(%esp)
  801932:	e8 da ea ff ff       	call   800411 <cprintf>
    return 0;
