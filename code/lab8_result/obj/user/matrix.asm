...
read(int fd, void *base, size_t len) {
  ...
  800147:	c7 04 24 c0 1b 80 00 	movl   $0x801bc0,(%esp)
...
write(int fd, void *base, size_t len) {
  ...
  800171:	83 ec 18             	sub    $0x18,%esp
    cprintf("[user_write]\n");
  800174:	c7 04 24 d0 1b 80 00 	movl   $0x801bd0,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80029a:	c7 04 24 de 1b 80 00 	movl   $0x801bde,(%esp)
  ...
  8002b8:	c7 04 24 e9 1b 80 00 	movl   $0x801be9,(%esp)
  ...
  8002ce:	c7 04 24 fb 1b 80 00 	movl   $0x801bfb,(%esp)
  ...
  8002e4:	c7 04 24 0e 1c 80 00 	movl   $0x801c0e,(%esp)
  ...
  8002fa:	c7 04 24 21 1c 80 00 	movl   $0x801c21,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80033a:	c7 04 24 34 1c 80 00 	movl   $0x801c34,(%esp)
  ...
  800353:	e8 7e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  800358:	c7 04 24 4e 1c 80 00 	movl   $0x801c4e,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80038a:	c7 04 24 50 1c 80 00 	movl   $0x801c50,(%esp)
  ...
  8003a3:	e8 2e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  8003a8:	c7 04 24 4e 1c 80 00 	movl   $0x801c4e,(%esp)
...
exit(int error_code) {
  ...
  8008e5:	c7 04 24 6c 1c 80 00 	movl   $0x801c6c,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a51:	00 
  800a52:	c7 44 24 04 7f 1c 80 	movl   $0x801c7f,0x4(%esp)
  800a59:	00 
  ...
  800a76:	c7 44 24 08 86 1c 80 	movl   $0x801c86,0x8(%esp)
  800a7d:	00 
  800a7e:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a85:	00 
  800a86:	c7 04 24 a0 1c 80 00 	movl   $0x801ca0,(%esp)
  800a8d:	e8 de f8 ff ff       	call   800370 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a92:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a99:	00 
  800a9a:	c7 44 24 04 b2 1c 80 	movl   $0x801cb2,0x4(%esp)
  800aa1:	00 
  ...
  800abe:	c7 44 24 08 ba 1c 80 	movl   $0x801cba,0x8(%esp)
  800ac5:	00 
  800ac6:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800acd:	00 
  800ace:	c7 04 24 a0 1c 80 00 	movl   $0x801ca0,(%esp)
  ...
  800ae7:	e8 29 0f 00 00       	call   801a15 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c16:	05 e4 1e 80 00       	add    $0x801ee4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d7a:	8b 04 85 08 1f 80 00 	mov    0x801f08(,%eax,4),%eax
  ...
  800e93:	c7 44 24 0c fe 1e 80 	movl   $0x801efe,0xc(%esp)
  800e9a:	00 
  ...
  800ec6:	75 05                	jne    800ecd <vprintfmt+0x1c9>
                p = "(null)";
  800ec8:	be 01 1f 80 00       	mov    $0x801f01,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  8017e4:	c7 45 e8 0a 00 00 00 	movl   $0xa,-0x18(%ebp)
    for (i = 0; i < size; i ++) {
  8017eb:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8017f2:	eb 65                	jmp    801859 <work+0x7c>
        for (j = 0; j < size; j ++) {
  8017f4:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  8017fb:	eb 50                	jmp    80184d <work+0x70>
            mata[i][j] = matb[i][j] = 1;
  ...
  801842:	89 0c 85 40 30 80 00 	mov    %ecx,0x803040(,%eax,4)
...
work(unsigned int times) {
    ...
    for (i = 0; i < size; i ++) {
        for (j = 0; j < size; j ++) {
  801849:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  80184d:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801850:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801853:	7c a8                	jl     8017fd <work+0x20>
static int matc[MATSIZE][MATSIZE];
...
work(unsigned int times) {
    int i, j, k, size = MATSIZE;
    for (i = 0; i < size; i ++) {
  801855:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801859:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80185c:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80185f:	7c 93                	jl     8017f4 <work+0x17>
        for (j = 0; j < size; j ++) {
            mata[i][j] = matb[i][j] = 1;
        }
    }
    ...
    yield();
  801861:	e8 d0 f0 ff ff       	call   800936 <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  801866:	e8 eb f0 ff ff       	call   800956 <getpid>
  80186b:	8b 55 08             	mov    0x8(%ebp),%edx
  80186e:	89 54 24 08          	mov    %edx,0x8(%esp)
  801872:	89 44 24 04          	mov    %eax,0x4(%esp)
  801876:	c7 04 24 60 20 80 00 	movl   $0x802060,(%esp)
  80187d:	e8 8f eb ff ff       	call   800411 <cprintf>

    while (times -- > 0) {
  801882:	e9 5c 01 00 00       	jmp    8019e3 <work+0x206>
        for (i = 0; i < size; i ++) {
  801887:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80188e:	e9 b6 00 00 00       	jmp    801949 <work+0x16c>
            for (j = 0; j < size; j ++) {
  801893:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  80189a:	e9 9a 00 00 00       	jmp    801939 <work+0x15c>
                matc[i][j] = 0;
  ...
  8018b0:	c7 04 85 80 33 80 00 	movl   $0x0,0x803380(,%eax,4)
  8018b7:	00 00 00 00 
                for (k = 0; k < size; k ++) {
  8018bb:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8018c2:	eb 69                	jmp    80192d <work+0x150>
  ...
  8018d5:	8b 0c 85 80 33 80 00 	mov    0x803380(,%eax,4),%ecx
  ...
  8018ed:	8b 1c 85 40 30 80 00 	mov    0x803040(,%eax,4),%ebx
  ...
  801905:	8b 04 85 e0 31 80 00 	mov    0x8031e0(,%eax,4),%eax
  80190c:	0f af c3             	imul   %ebx,%eax
  80190f:	01 c1                	add    %eax,%ecx
  ...
  801922:	89 0c 85 80 33 80 00 	mov    %ecx,0x803380(,%eax,4)
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
                matc[i][j] = 0;
                for (k = 0; k < size; k ++) {
  801929:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  80192d:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801930:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801933:	7c 8f                	jl     8018c4 <work+0xe7>
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  801935:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801939:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80193c:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80193f:	0f 8c 5a ff ff ff    	jl     80189f <work+0xc2>
    yield();
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
  801945:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801949:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80194c:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80194f:	0f 8c 3e ff ff ff    	jl     801893 <work+0xb6>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
  ...
  80195c:	eb 79                	jmp    8019d7 <work+0x1fa>
            for (j = 0; j < size; j ++) {
  80195e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801965:	eb 64                	jmp    8019cb <work+0x1ee>
  ...
  801978:	8b 0c 85 80 33 80 00 	mov    0x803380(,%eax,4),%ecx
  ...
  801990:	89 0c 85 e0 31 80 00 	mov    %ecx,0x8031e0(,%eax,4)
  ...
  8019c0:	89 0c 85 40 30 80 00 	mov    %ecx,0x803040(,%eax,4)
        ...
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  8019c7:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  8019cb:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8019ce:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8019d1:	7c 94                	jl     801967 <work+0x18a>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        ...
        for (i = 0; i < size; i ++) {
  8019d3:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8019d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8019da:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8019dd:	0f 8c 7b ff ff ff    	jl     80195e <work+0x181>
  ...
  8019e6:	8d 50 ff             	lea    -0x1(%eax),%edx
  8019e9:	89 55 08             	mov    %edx,0x8(%ebp)
  8019ec:	85 c0                	test   %eax,%eax
  8019ee:	0f 85 93 fe ff ff    	jne    801887 <work+0xaa>
            for (j = 0; j < size; j ++) {
                mata[i][j] = matb[i][j] = matc[i][j];
            }
        }
    ...
    cprintf("pid %d done!.\n", getpid());
  8019f4:	e8 5d ef ff ff       	call   800956 <getpid>
  8019f9:	89 44 24 04          	mov    %eax,0x4(%esp)
  8019fd:	c7 04 24 80 20 80 00 	movl   $0x802080,(%esp)
  801a04:	e8 08 ea ff ff       	call   800411 <cprintf>
    exit(0);
  801a09:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801a10:	e8 bf ee ff ff       	call   8008d4 <exit>
...
int
main(void) {
  801a15:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  801a19:	83 e4 f0             	and    $0xfffffff0,%esp
  801a1c:	ff 71 fc             	pushl  -0x4(%ecx)
  801a1f:	55                   	push   %ebp
  801a20:	89 e5                	mov    %esp,%ebp
  801a22:	56                   	push   %esi
  801a23:	53                   	push   %ebx
  801a24:	51                   	push   %ecx
  801a25:	83 ec 2c             	sub    $0x2c,%esp
  801a28:	89 e0                	mov    %esp,%eax
  801a2a:	89 c3                	mov    %eax,%ebx
    int pids[total];
  801a2c:	b8 15 00 00 00       	mov    $0x15,%eax
  801a31:	83 e8 01             	sub    $0x1,%eax
  801a34:	89 45 e0             	mov    %eax,-0x20(%ebp)
  801a37:	b8 15 00 00 00       	mov    $0x15,%eax
  801a3c:	c1 e0 02             	shl    $0x2,%eax
  801a3f:	8d 50 03             	lea    0x3(%eax),%edx
  801a42:	b8 10 00 00 00       	mov    $0x10,%eax
  801a47:	83 e8 01             	sub    $0x1,%eax
  801a4a:	01 d0                	add    %edx,%eax
  801a4c:	be 10 00 00 00       	mov    $0x10,%esi
  801a51:	ba 00 00 00 00       	mov    $0x0,%edx
  801a56:	f7 f6                	div    %esi
  801a58:	6b c0 10             	imul   $0x10,%eax,%eax
  801a5b:	29 c4                	sub    %eax,%esp
  801a5d:	8d 44 24 0c          	lea    0xc(%esp),%eax
  801a61:	83 c0 03             	add    $0x3,%eax
  801a64:	c1 e8 02             	shr    $0x2,%eax
  801a67:	c1 e0 02             	shl    $0x2,%eax
  801a6a:	89 45 dc             	mov    %eax,-0x24(%ebp)
    memset(pids, 0, sizeof(pids));
  801a6d:	b8 15 00 00 00       	mov    $0x15,%eax
  801a72:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801a79:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801a7c:	89 54 24 08          	mov    %edx,0x8(%esp)
  801a80:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801a87:	00 
  801a88:	89 04 24             	mov    %eax,(%esp)
  801a8b:	e8 c4 fb ff ff       	call   801654 <memset>

    int i;
    for (i = 0; i < total; i ++) {
  801a90:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801a97:	eb 70                	jmp    801b09 <main+0xf4>
        if ((pids[i] = fork()) == 0) {
  801a99:	e8 55 ee ff ff       	call   8008f3 <fork>
  801a9e:	8b 55 dc             	mov    -0x24(%ebp),%edx
  801aa1:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  801aa4:	89 04 8a             	mov    %eax,(%edx,%ecx,4)
  801aa7:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801aaa:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801aad:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801ab0:	85 c0                	test   %eax,%eax
  801ab2:	75 42                	jne    801af6 <main+0xe1>
            srand(i * i);
  801ab4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801ab7:	0f af 45 e4          	imul   -0x1c(%ebp),%eax
  801abb:	89 04 24             	mov    %eax,(%esp)
  801abe:	e8 23 f8 ff ff       	call   8012e6 <srand>
            int times = (((unsigned int)rand()) % total);
  801ac3:	e8 5e f7 ff ff       	call   801226 <rand>
  801ac8:	ba 15 00 00 00       	mov    $0x15,%edx
  801acd:	89 d1                	mov    %edx,%ecx
  801acf:	ba 00 00 00 00       	mov    $0x0,%edx
  801ad4:	f7 f1                	div    %ecx
  801ad6:	89 d0                	mov    %edx,%eax
  801ad8:	89 45 d8             	mov    %eax,-0x28(%ebp)
            times = (times * times + 10) * 100;
  801adb:	8b 45 d8             	mov    -0x28(%ebp),%eax
  801ade:	0f af 45 d8          	imul   -0x28(%ebp),%eax
  801ae2:	83 c0 0a             	add    $0xa,%eax
  801ae5:	6b c0 64             	imul   $0x64,%eax,%eax
  801ae8:	89 45 d8             	mov    %eax,-0x28(%ebp)
            work(times);
  801aeb:	8b 45 d8             	mov    -0x28(%ebp),%eax
  801aee:	89 04 24             	mov    %eax,(%esp)
  801af1:	e8 e7 fc ff ff       	call   8017dd <work>
        }
        if (pids[i] < 0) {
  801af6:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801af9:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801afc:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801aff:	85 c0                	test   %eax,%eax
  801b01:	79 02                	jns    801b05 <main+0xf0>
            goto failed;
  801b03:	eb 5d                	jmp    801b62 <main+0x14d>
main(void) {
    int pids[total];
    memset(pids, 0, sizeof(pids));
    ...
    int i;
    for (i = 0; i < total; i ++) {
  801b05:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801b09:	b8 15 00 00 00       	mov    $0x15,%eax
  801b0e:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801b11:	7c 86                	jl     801a99 <main+0x84>
        if (pids[i] < 0) {
            goto failed;
        }
    }
    ...
    cprintf("fork ok.\n");
  801b13:	c7 04 24 94 20 80 00 	movl   $0x802094,(%esp)
  801b1a:	e8 f2 e8 ff ff       	call   800411 <cprintf>

    for (i = 0; i < total; i ++) {
  801b1f:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801b26:	eb 1b                	jmp    801b43 <main+0x12e>
        if (wait() != 0) {
  801b28:	e8 d3 ed ff ff       	call   800900 <wait>
  801b2d:	85 c0                	test   %eax,%eax
  801b2f:	74 0e                	je     801b3f <main+0x12a>
            cprintf("wait failed.\n");
  801b31:	c7 04 24 9e 20 80 00 	movl   $0x80209e,(%esp)
  801b38:	e8 d4 e8 ff ff       	call   800411 <cprintf>
            goto failed;
  801b3d:	eb 23                	jmp    801b62 <main+0x14d>
        }
    }
    ...
    for (i = 0; i < total; i ++) {
  801b3f:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801b43:	b8 15 00 00 00       	mov    $0x15,%eax
  801b48:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801b4b:	7c db                	jl     801b28 <main+0x113>
            cprintf("wait failed.\n");
            goto failed;
        }
    }
    ...
    cprintf("matrix pass.\n");
  801b4d:	c7 04 24 ac 20 80 00 	movl   $0x8020ac,(%esp)
  801b54:	e8 b8 e8 ff ff       	call   800411 <cprintf>
    return 0;
  801b59:	b8 00 00 00 00       	mov    $0x0,%eax
  801b5e:	89 dc                	mov    %ebx,%esp
  801b60:	eb 51                	jmp    801bb3 <main+0x19e>

failed:
    for (i = 0; i < total; i ++) {
  801b62:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801b69:	eb 22                	jmp    801b8d <main+0x178>
        if (pids[i] > 0) {
  801b6b:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b6e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801b71:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801b74:	85 c0                	test   %eax,%eax
  801b76:	7e 11                	jle    801b89 <main+0x174>
            kill(pids[i]);
  801b78:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b7b:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801b7e:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801b81:	89 04 24             	mov    %eax,(%esp)
  801b84:	e8 ba ed ff ff       	call   800943 <kill>
...
failed:
    for (i = 0; i < total; i ++) {
  801b89:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801b8d:	b8 15 00 00 00       	mov    $0x15,%eax
  801b92:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801b95:	7c d4                	jl     801b6b <main+0x156>
        if (pids[i] > 0) {
            kill(pids[i]);
        }
    }
    panic("FAIL: T.T\n");
  801b97:	c7 44 24 08 ba 20 80 	movl   $0x8020ba,0x8(%esp)
  801b9e:	00 
  801b9f:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  801ba6:	00 
  801ba7:	c7 04 24 c5 20 80 00 	movl   $0x8020c5,(%esp)
  801bae:	e8 6d e7 ff ff       	call   800320 <__panic>
}
  ...
  801bb8:	5e                   	pop    %esi
  801bb9:	5d                   	pop    %ebp
  801bba:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801bbd:	c3                   	ret    
