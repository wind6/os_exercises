...
umain(int argc, char *argv[]) {
  ...
  800ae7:	e8 a8 0d 00 00       	call   801894 <main>
...
forkchild(const char *cur, char branch) {
  ...
  8017e0:	83 ec 38             	sub    $0x38,%esp
  8017e3:	8b 45 0c             	mov    0xc(%ebp),%eax
  8017e6:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  8017e9:	8b 45 08             	mov    0x8(%ebp),%eax
  8017ec:	89 04 24             	mov    %eax,(%esp)
  8017ef:	e8 0a fb ff ff       	call   8012fe <strlen>
  8017f4:	83 f8 03             	cmp    $0x3,%eax
  8017f7:	77 4f                	ja     801848 <forkchild+0x6b>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  8017f9:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  8017fd:	89 44 24 10          	mov    %eax,0x10(%esp)
  801801:	8b 45 08             	mov    0x8(%ebp),%eax
  801804:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801808:	c7 44 24 08 80 1d 80 	movl   $0x801d80,0x8(%esp)
  80180f:	00 
  801810:	c7 44 24 04 05 00 00 	movl   $0x5,0x4(%esp)
  801817:	00 
  801818:	8d 45 f3             	lea    -0xd(%ebp),%eax
  80181b:	89 04 24             	mov    %eax,(%esp)
  80181e:	e8 63 f9 ff ff       	call   801186 <snprintf>
    if (fork() == 0) {
  801823:	e8 cb f0 ff ff       	call   8008f3 <fork>
  801828:	85 c0                	test   %eax,%eax
  80182a:	75 1c                	jne    801848 <forkchild+0x6b>
        forktree(nxt);
  80182c:	8d 45 f3             	lea    -0xd(%ebp),%eax
  80182f:	89 04 24             	mov    %eax,(%esp)
  801832:	e8 13 00 00 00       	call   80184a <forktree>
        yield();
  801837:	e8 fa f0 ff ff       	call   800936 <yield>
        exit(0);
  80183c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801843:	e8 8c f0 ff ff       	call   8008d4 <exit>
    }
}
  801848:	c9                   	leave  
  801849:	c3                   	ret    
...
forktree(const char *cur) {
  ...
  80184d:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  801850:	e8 01 f1 ff ff       	call   800956 <getpid>
  801855:	8b 55 08             	mov    0x8(%ebp),%edx
  801858:	89 54 24 08          	mov    %edx,0x8(%esp)
  80185c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801860:	c7 04 24 85 1d 80 00 	movl   $0x801d85,(%esp)
  801867:	e8 a5 eb ff ff       	call   800411 <cprintf>

    forkchild(cur, '0');
  80186c:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
  801873:	00 
  801874:	8b 45 08             	mov    0x8(%ebp),%eax
  801877:	89 04 24             	mov    %eax,(%esp)
  80187a:	e8 5e ff ff ff       	call   8017dd <forkchild>
    forkchild(cur, '1');
  80187f:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  801886:	00 
  801887:	8b 45 08             	mov    0x8(%ebp),%eax
  80188a:	89 04 24             	mov    %eax,(%esp)
  80188d:	e8 4b ff ff ff       	call   8017dd <forkchild>
}
  801892:	c9                   	leave  
  801893:	c3                   	ret    
...
main(void) {
  ...
  801897:	83 e4 f0             	and    $0xfffffff0,%esp
  80189a:	83 ec 10             	sub    $0x10,%esp
    cprintf("forktree process will sleep %d ticks\n",SLEEP_TIME);
  80189d:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  8018a4:	00 
  8018a5:	c7 04 24 98 1d 80 00 	movl   $0x801d98,(%esp)
  8018ac:	e8 60 eb ff ff       	call   800411 <cprintf>
    sleep(SLEEP_TIME);
  8018b1:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  8018b8:	e8 c6 f0 ff ff       	call   800983 <sleep>
    forktree("");
  8018bd:	c7 04 24 be 1d 80 00 	movl   $0x801dbe,(%esp)
  8018c4:	e8 81 ff ff ff       	call   80184a <forktree>
    return 0;
