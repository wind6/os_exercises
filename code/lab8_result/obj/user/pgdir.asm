...
main(void) {
  ...
  8017ef:	c7 04 24 c0 1c 80 00 	movl   $0x801cc0,(%esp)
  8017f6:	e8 16 ec ff ff       	call   800411 <cprintf>
    print_pgdir();
  8017fb:	e8 63 f1 ff ff       	call   800963 <print_pgdir>
    cprintf("pgdir pass.\n");
  801800:	c7 04 24 d7 1c 80 00 	movl   $0x801cd7,(%esp)
  801807:	e8 05 ec ff ff       	call   800411 <cprintf>
    return 0;
