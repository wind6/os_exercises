...
read(int fd, void *base, size_t len) {
  ...
  800147:	c7 04 24 80 19 80 00 	movl   $0x801980,(%esp)
...
write(int fd, void *base, size_t len) {
  ...
  800171:	83 ec 18             	sub    $0x18,%esp
    cprintf("[user_write]\n");
  800174:	c7 04 24 90 19 80 00 	movl   $0x801990,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80029a:	c7 04 24 9e 19 80 00 	movl   $0x80199e,(%esp)
  ...
  8002b8:	c7 04 24 a9 19 80 00 	movl   $0x8019a9,(%esp)
  ...
  8002ce:	c7 04 24 bb 19 80 00 	movl   $0x8019bb,(%esp)
  ...
  8002e4:	c7 04 24 ce 19 80 00 	movl   $0x8019ce,(%esp)
  ...
  8002fa:	c7 04 24 e1 19 80 00 	movl   $0x8019e1,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80033a:	c7 04 24 f4 19 80 00 	movl   $0x8019f4,(%esp)
  ...
  800353:	e8 7e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  800358:	c7 04 24 0e 1a 80 00 	movl   $0x801a0e,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80038a:	c7 04 24 10 1a 80 00 	movl   $0x801a10,(%esp)
  ...
  8003a3:	e8 2e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  8003a8:	c7 04 24 0e 1a 80 00 	movl   $0x801a0e,(%esp)
...
exit(int error_code) {
  ...
  8008e5:	c7 04 24 2c 1a 80 00 	movl   $0x801a2c,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a51:	00 
  800a52:	c7 44 24 04 3f 1a 80 	movl   $0x801a3f,0x4(%esp)
  800a59:	00 
  ...
  800a76:	c7 44 24 08 46 1a 80 	movl   $0x801a46,0x8(%esp)
  800a7d:	00 
  800a7e:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a85:	00 
  800a86:	c7 04 24 60 1a 80 00 	movl   $0x801a60,(%esp)
  800a8d:	e8 de f8 ff ff       	call   800370 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a92:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a99:	00 
  800a9a:	c7 44 24 04 72 1a 80 	movl   $0x801a72,0x4(%esp)
  800aa1:	00 
  ...
  800abe:	c7 44 24 08 7a 1a 80 	movl   $0x801a7a,0x8(%esp)
  800ac5:	00 
  800ac6:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800acd:	00 
  800ace:	c7 04 24 60 1a 80 00 	movl   $0x801a60,(%esp)
  ...
  800ae7:	e8 99 0d 00 00       	call   801885 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c16:	05 a4 1c 80 00       	add    $0x801ca4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d7a:	8b 04 85 c8 1c 80 00 	mov    0x801cc8(,%eax,4),%eax
  ...
  800e93:	c7 44 24 0c be 1c 80 	movl   $0x801cbe,0xc(%esp)
  800e9a:	00 
  ...
  800ec6:	75 05                	jne    800ecd <vprintfmt+0x1c9>
                p = "(null)";
  800ec8:	be c1 1c 80 00       	mov    $0x801cc1,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  8017e0:	83 ec 08             	sub    $0x8,%esp
    yield();
  8017e3:	e8 4e f1 ff ff       	call   800936 <yield>
    yield();
  8017e8:	e8 49 f1 ff ff       	call   800936 <yield>
    yield();
  8017ed:	e8 44 f1 ff ff       	call   800936 <yield>
    yield();
  8017f2:	e8 3f f1 ff ff       	call   800936 <yield>
    yield();
  8017f7:	e8 3a f1 ff ff       	call   800936 <yield>
    yield();
  8017fc:	e8 35 f1 ff ff       	call   800936 <yield>
}
  801801:	c9                   	leave  
  801802:	c3                   	ret    
...
loop(void) {
  ...
  801806:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  801809:	c7 04 24 20 1e 80 00 	movl   $0x801e20,(%esp)
  801810:	e8 fc eb ff ff       	call   800411 <cprintf>
    while (1);
  801815:	eb fe                	jmp    801815 <loop+0x12>
...
work(void) {
  ...
  80181a:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  80181d:	c7 04 24 2a 1e 80 00 	movl   $0x801e2a,(%esp)
  801824:	e8 e8 eb ff ff       	call   800411 <cprintf>
    do_yield();
  801829:	e8 af ff ff ff       	call   8017dd <do_yield>
    if (kill(parent) == 0) {
  80182e:	a1 48 21 80 00       	mov    0x802148,%eax
  801833:	89 04 24             	mov    %eax,(%esp)
  801836:	e8 08 f1 ff ff       	call   800943 <kill>
  80183b:	85 c0                	test   %eax,%eax
  80183d:	75 3a                	jne    801879 <work+0x62>
        cprintf("kill parent ok.\n");
  80183f:	c7 04 24 34 1e 80 00 	movl   $0x801e34,(%esp)
  801846:	e8 c6 eb ff ff       	call   800411 <cprintf>
        do_yield();
  80184b:	e8 8d ff ff ff       	call   8017dd <do_yield>
        if (kill(pid1) == 0) {
  801850:	a1 50 21 80 00       	mov    0x802150,%eax
  801855:	89 04 24             	mov    %eax,(%esp)
  801858:	e8 e6 f0 ff ff       	call   800943 <kill>
  80185d:	85 c0                	test   %eax,%eax
  80185f:	75 18                	jne    801879 <work+0x62>
            cprintf("kill child1 ok.\n");
  801861:	c7 04 24 45 1e 80 00 	movl   $0x801e45,(%esp)
  801868:	e8 a4 eb ff ff       	call   800411 <cprintf>
            exit(0);
  80186d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801874:	e8 5b f0 ff ff       	call   8008d4 <exit>
        }
    }
    exit(-1);
  801879:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801880:	e8 4f f0 ff ff       	call   8008d4 <exit>
...
main(void) {
  ...
  801888:	83 e4 f0             	and    $0xfffffff0,%esp
  80188b:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  80188e:	e8 c3 f0 ff ff       	call   800956 <getpid>
  801893:	a3 48 21 80 00       	mov    %eax,0x802148
    if ((pid1 = fork()) == 0) {
  801898:	e8 56 f0 ff ff       	call   8008f3 <fork>
  80189d:	a3 50 21 80 00       	mov    %eax,0x802150
  8018a2:	a1 50 21 80 00       	mov    0x802150,%eax
  8018a7:	85 c0                	test   %eax,%eax
  8018a9:	75 05                	jne    8018b0 <main+0x2b>
        loop();
  8018ab:	e8 53 ff ff ff       	call   801803 <loop>
    }

    assert(pid1 > 0);
  8018b0:	a1 50 21 80 00       	mov    0x802150,%eax
  8018b5:	85 c0                	test   %eax,%eax
  8018b7:	7f 24                	jg     8018dd <main+0x58>
  8018b9:	c7 44 24 0c 56 1e 80 	movl   $0x801e56,0xc(%esp)
  8018c0:	00 
  8018c1:	c7 44 24 08 5f 1e 80 	movl   $0x801e5f,0x8(%esp)
  8018c8:	00 
  8018c9:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  8018d0:	00 
  8018d1:	c7 04 24 74 1e 80 00 	movl   $0x801e74,(%esp)
  8018d8:	e8 43 ea ff ff       	call   800320 <__panic>

    if ((pid2 = fork()) == 0) {
  8018dd:	e8 11 f0 ff ff       	call   8008f3 <fork>
  8018e2:	a3 4c 21 80 00       	mov    %eax,0x80214c
  8018e7:	a1 4c 21 80 00       	mov    0x80214c,%eax
  8018ec:	85 c0                	test   %eax,%eax
  8018ee:	75 05                	jne    8018f5 <main+0x70>
        work();
  8018f0:	e8 22 ff ff ff       	call   801817 <work>
    }
    if (pid2 > 0) {
  8018f5:	a1 4c 21 80 00       	mov    0x80214c,%eax
  8018fa:	85 c0                	test   %eax,%eax
  8018fc:	7e 46                	jle    801944 <main+0xbf>
        cprintf("wait child 1.\n");
  8018fe:	c7 04 24 84 1e 80 00 	movl   $0x801e84,(%esp)
  801905:	e8 07 eb ff ff       	call   800411 <cprintf>
        waitpid(pid1, NULL);
  80190a:	a1 50 21 80 00       	mov    0x802150,%eax
  80190f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801916:	00 
  801917:	89 04 24             	mov    %eax,(%esp)
  80191a:	e8 fd ef ff ff       	call   80091c <waitpid>
        panic("waitpid %d returns\n", pid1);
  80191f:	a1 50 21 80 00       	mov    0x802150,%eax
  801924:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801928:	c7 44 24 08 93 1e 80 	movl   $0x801e93,0x8(%esp)
  80192f:	00 
  801930:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  801937:	00 
  801938:	c7 04 24 74 1e 80 00 	movl   $0x801e74,(%esp)
  80193f:	e8 dc e9 ff ff       	call   800320 <__panic>
    }
    else {
        kill(pid1);
  801944:	a1 50 21 80 00       	mov    0x802150,%eax
  801949:	89 04 24             	mov    %eax,(%esp)
  80194c:	e8 f2 ef ff ff       	call   800943 <kill>
    }
    panic("FAIL: T.T\n");
  801951:	c7 44 24 08 a7 1e 80 	movl   $0x801ea7,0x8(%esp)
  801958:	00 
  801959:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  801960:	00 
  801961:	c7 04 24 74 1e 80 00 	movl   $0x801e74,(%esp)
  801968:	e8 b3 e9 ff ff       	call   800320 <__panic>
