...
main(void) {
  ...
  8017e6:	c7 04 24 a0 1d 80 00 	movl   $0x801da0,(%esp)
  8017ed:	e8 1f ec ff ff       	call   800411 <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  8017f2:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8017f9:	00 
  8017fa:	eb 38                	jmp    801834 <main+0x57>
        if (bigarray[i] != 0) {
  8017fc:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801800:	8b 04 85 60 21 80 00 	mov    0x802160(,%eax,4),%eax
  801807:	85 c0                	test   %eax,%eax
  801809:	74 24                	je     80182f <main+0x52>
            panic("bigarray[%d] isn't cleared!\n", i);
  80180b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80180f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801813:	c7 44 24 08 c0 1d 80 	movl   $0x801dc0,0x8(%esp)
  80181a:	00 
  80181b:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801822:	00 
  801823:	c7 04 24 dd 1d 80 00 	movl   $0x801ddd,(%esp)
  80182a:	e8 f1 ea ff ff       	call   800320 <__panic>
...
main(void) {
    ...
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  80182f:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801834:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  80183b:	00 
  80183c:	7e be                	jle    8017fc <main+0x1f>
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80183e:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801845:	00 
  801846:	eb 14                	jmp    80185c <main+0x7f>
        bigarray[i] = i;
  801848:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  80184c:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801850:	89 14 85 60 21 80 00 	mov    %edx,0x802160(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  801857:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80185c:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801863:	00 
  801864:	7e e2                	jle    801848 <main+0x6b>
        bigarray[i] = i;
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801866:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80186d:	00 
  80186e:	eb 3c                	jmp    8018ac <main+0xcf>
        if (bigarray[i] != i) {
  801870:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801874:	8b 14 85 60 21 80 00 	mov    0x802160(,%eax,4),%edx
  80187b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80187f:	39 c2                	cmp    %eax,%edx
  801881:	74 24                	je     8018a7 <main+0xca>
            panic("bigarray[%d] didn't hold its value!\n", i);
  801883:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801887:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80188b:	c7 44 24 08 ec 1d 80 	movl   $0x801dec,0x8(%esp)
  801892:	00 
  801893:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  80189a:	00 
  80189b:	c7 04 24 dd 1d 80 00 	movl   $0x801ddd,(%esp)
  8018a2:	e8 79 ea ff ff       	call   800320 <__panic>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
        bigarray[i] = i;
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  8018a7:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  8018ac:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  8018b3:	00 
  8018b4:	7e ba                	jle    801870 <main+0x93>
        if (bigarray[i] != i) {
            panic("bigarray[%d] didn't hold its value!\n", i);
        }
    }
  ...
  8018b6:	c7 04 24 14 1e 80 00 	movl   $0x801e14,(%esp)
  8018bd:	e8 4f eb ff ff       	call   800411 <cprintf>
    cprintf("testbss may pass.\n");
  8018c2:	c7 04 24 47 1e 80 00 	movl   $0x801e47,(%esp)
  8018c9:	e8 43 eb ff ff       	call   800411 <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
  8018ce:	c7 05 60 31 c0 00 00 	movl   $0x0,0xc03160
  8018d5:	00 00 00 
    asm volatile ("int $0x14");
  8018d8:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  8018da:	c7 44 24 08 5a 1e 80 	movl   $0x801e5a,0x8(%esp)
  8018e1:	00 
  8018e2:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  8018e9:	00 
  8018ea:	c7 04 24 dd 1d 80 00 	movl   $0x801ddd,(%esp)
  8018f1:	e8 2a ea ff ff       	call   800320 <__panic>
