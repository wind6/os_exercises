...
main(void) {
  ...
  8017e6:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  8017eb:	8b 00                	mov    (%eax),%eax
  8017ed:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017f1:	c7 04 24 c0 1c 80 00 	movl   $0x801cc0,(%esp)
  8017f8:	e8 14 ec ff ff       	call   800411 <cprintf>
    panic("FAIL: T.T\n");
  8017fd:	c7 44 24 08 de 1c 80 	movl   $0x801cde,0x8(%esp)
  801804:	00 
  801805:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  80180c:	00 
  80180d:	c7 04 24 e9 1c 80 00 	movl   $0x801ce9,(%esp)
  801814:	e8 07 eb ff ff       	call   800320 <__panic>
