...
read(int fd, void *base, size_t len) {
  ...
  800147:	c7 04 24 60 18 80 00 	movl   $0x801860,(%esp)
...
write(int fd, void *base, size_t len) {
  ...
  800171:	83 ec 18             	sub    $0x18,%esp
    cprintf("[user_write]\n");
  800174:	c7 04 24 70 18 80 00 	movl   $0x801870,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80029a:	c7 04 24 7e 18 80 00 	movl   $0x80187e,(%esp)
  ...
  8002b8:	c7 04 24 89 18 80 00 	movl   $0x801889,(%esp)
  ...
  8002ce:	c7 04 24 9b 18 80 00 	movl   $0x80189b,(%esp)
  ...
  8002e4:	c7 04 24 ae 18 80 00 	movl   $0x8018ae,(%esp)
  ...
  8002fa:	c7 04 24 c1 18 80 00 	movl   $0x8018c1,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80033a:	c7 04 24 d4 18 80 00 	movl   $0x8018d4,(%esp)
  ...
  800353:	e8 7e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  800358:	c7 04 24 ee 18 80 00 	movl   $0x8018ee,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80038a:	c7 04 24 f0 18 80 00 	movl   $0x8018f0,(%esp)
  ...
  8003a3:	e8 2e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  8003a8:	c7 04 24 ee 18 80 00 	movl   $0x8018ee,(%esp)
...
exit(int error_code) {
  ...
  8008e5:	c7 04 24 0c 19 80 00 	movl   $0x80190c,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a51:	00 
  800a52:	c7 44 24 04 1f 19 80 	movl   $0x80191f,0x4(%esp)
  800a59:	00 
  ...
  800a76:	c7 44 24 08 26 19 80 	movl   $0x801926,0x8(%esp)
  800a7d:	00 
  800a7e:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a85:	00 
  800a86:	c7 04 24 40 19 80 00 	movl   $0x801940,(%esp)
  800a8d:	e8 de f8 ff ff       	call   800370 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a92:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a99:	00 
  800a9a:	c7 44 24 04 52 19 80 	movl   $0x801952,0x4(%esp)
  800aa1:	00 
  ...
  800abe:	c7 44 24 08 5a 19 80 	movl   $0x80195a,0x8(%esp)
  800ac5:	00 
  800ac6:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800acd:	00 
  800ace:	c7 04 24 40 19 80 00 	movl   $0x801940,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c16:	05 84 1b 80 00       	add    $0x801b84,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d7a:	8b 04 85 a8 1b 80 00 	mov    0x801ba8(,%eax,4),%eax
  ...
  800e93:	c7 44 24 0c 9e 1b 80 	movl   $0x801b9e,0xc(%esp)
  800e9a:	00 
  ...
  800ec6:	75 05                	jne    800ecd <vprintfmt+0x1c9>
                p = "(null)";
  800ec8:	be a1 1b 80 00       	mov    $0x801ba1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017e6:	e8 6b f1 ff ff       	call   800956 <getpid>
  8017eb:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017ef:	c7 04 24 00 1d 80 00 	movl   $0x801d00,(%esp)
  8017f6:	e8 16 ec ff ff       	call   800411 <cprintf>
    for (i = 0; i < 5; i ++) {
  8017fb:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801802:	00 
  801803:	eb 27                	jmp    80182c <main+0x4f>
        yield();
  801805:	e8 2c f1 ff ff       	call   800936 <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  80180a:	e8 47 f1 ff ff       	call   800956 <getpid>
  80180f:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801813:	89 54 24 08          	mov    %edx,0x8(%esp)
  801817:	89 44 24 04          	mov    %eax,0x4(%esp)
  80181b:	c7 04 24 1c 1d 80 00 	movl   $0x801d1c,(%esp)
  801822:	e8 ea eb ff ff       	call   800411 <cprintf>
...
main(void) {
    ...
    cprintf("Hello, I am process %d.\n", getpid());
    for (i = 0; i < 5; i ++) {
  801827:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80182c:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801831:	7e d2                	jle    801805 <main+0x28>
        yield();
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
    }
    cprintf("All done in process %d.\n", getpid());
  801833:	e8 1e f1 ff ff       	call   800956 <getpid>
  801838:	89 44 24 04          	mov    %eax,0x4(%esp)
  80183c:	c7 04 24 3f 1d 80 00 	movl   $0x801d3f,(%esp)
  801843:	e8 c9 eb ff ff       	call   800411 <cprintf>
    cprintf("yield pass.\n");
  801848:	c7 04 24 58 1d 80 00 	movl   $0x801d58,(%esp)
  80184f:	e8 bd eb ff ff       	call   800411 <cprintf>
    return 0;
