...
main(void) {
  ...
  8017e3:	83 ec 10             	sub    $0x10,%esp
    cprintf("Hello world!!.\n");
  8017e6:	c7 04 24 c0 1c 80 00 	movl   $0x801cc0,(%esp)
  8017ed:	e8 1f ec ff ff       	call   800411 <cprintf>
    cprintf("I am process %d.\n", getpid());
  8017f2:	e8 5f f1 ff ff       	call   800956 <getpid>
  8017f7:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017fb:	c7 04 24 d0 1c 80 00 	movl   $0x801cd0,(%esp)
  801802:	e8 0a ec ff ff       	call   800411 <cprintf>
    cprintf("hello pass.\n");
  801807:	c7 04 24 e2 1c 80 00 	movl   $0x801ce2,(%esp)
  80180e:	e8 fe eb ff ff       	call   800411 <cprintf>
    return 0;
