...
read(int fd, void *base, size_t len) {
  ...
  800147:	c7 04 24 e0 18 80 00 	movl   $0x8018e0,(%esp)
...
write(int fd, void *base, size_t len) {
  ...
  800171:	83 ec 18             	sub    $0x18,%esp
    cprintf("[user_write]\n");
  800174:	c7 04 24 f0 18 80 00 	movl   $0x8018f0,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80029a:	c7 04 24 fe 18 80 00 	movl   $0x8018fe,(%esp)
  ...
  8002b8:	c7 04 24 09 19 80 00 	movl   $0x801909,(%esp)
  ...
  8002ce:	c7 04 24 1b 19 80 00 	movl   $0x80191b,(%esp)
  ...
  8002e4:	c7 04 24 2e 19 80 00 	movl   $0x80192e,(%esp)
  ...
  8002fa:	c7 04 24 41 19 80 00 	movl   $0x801941,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80033a:	c7 04 24 54 19 80 00 	movl   $0x801954,(%esp)
  ...
  800353:	e8 7e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  800358:	c7 04 24 6e 19 80 00 	movl   $0x80196e,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80038a:	c7 04 24 70 19 80 00 	movl   $0x801970,(%esp)
  ...
  8003a3:	e8 2e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  8003a8:	c7 04 24 6e 19 80 00 	movl   $0x80196e,(%esp)
...
exit(int error_code) {
  ...
  8008e5:	c7 04 24 8c 19 80 00 	movl   $0x80198c,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a51:	00 
  800a52:	c7 44 24 04 9f 19 80 	movl   $0x80199f,0x4(%esp)
  800a59:	00 
  ...
  800a76:	c7 44 24 08 a6 19 80 	movl   $0x8019a6,0x8(%esp)
  800a7d:	00 
  800a7e:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a85:	00 
  800a86:	c7 04 24 c0 19 80 00 	movl   $0x8019c0,(%esp)
  800a8d:	e8 de f8 ff ff       	call   800370 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a92:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a99:	00 
  800a9a:	c7 44 24 04 d2 19 80 	movl   $0x8019d2,0x4(%esp)
  800aa1:	00 
  ...
  800abe:	c7 44 24 08 da 19 80 	movl   $0x8019da,0x8(%esp)
  800ac5:	00 
  800ac6:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800acd:	00 
  800ace:	c7 04 24 c0 19 80 00 	movl   $0x8019c0,(%esp)
  ...
  800ae7:	e8 45 0d 00 00       	call   801831 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c16:	05 04 1c 80 00       	add    $0x801c04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d7a:	8b 04 85 28 1c 80 00 	mov    0x801c28(,%eax,4),%eax
  ...
  800e93:	c7 44 24 0c 1e 1c 80 	movl   $0x801c1e,0xc(%esp)
  800e9a:	00 
  ...
  800ec6:	75 05                	jne    800ecd <vprintfmt+0x1c9>
                p = "(null)";
  800ec8:	be 21 1c 80 00       	mov    $0x801c21,%esi
            }
            if (width > 0 && padc != '-') {
...
sleepy(int pid) {
  ...
  8017e0:	83 ec 28             	sub    $0x28,%esp
    int i, time = 100;
  8017e3:	c7 45 f0 64 00 00 00 	movl   $0x64,-0x10(%ebp)
    for (i = 0; i < 10; i ++) {
  8017ea:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8017f1:	eb 2c                	jmp    80181f <sleepy+0x42>
        sleep(time);
  8017f3:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8017f6:	89 04 24             	mov    %eax,(%esp)
  8017f9:	e8 85 f1 ff ff       	call   800983 <sleep>
        cprintf("sleep %d x %d slices.\n", i + 1, time);
  8017fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801801:	8d 50 01             	lea    0x1(%eax),%edx
  801804:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801807:	89 44 24 08          	mov    %eax,0x8(%esp)
  80180b:	89 54 24 04          	mov    %edx,0x4(%esp)
  80180f:	c7 04 24 80 1d 80 00 	movl   $0x801d80,(%esp)
  801816:	e8 f6 eb ff ff       	call   800411 <cprintf>
#include <ulib.h>
...
sleepy(int pid) {
    int i, time = 100;
    for (i = 0; i < 10; i ++) {
  80181b:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80181f:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  801823:	7e ce                	jle    8017f3 <sleepy+0x16>
        sleep(time);
        cprintf("sleep %d x %d slices.\n", i + 1, time);
    }
    exit(0);
  801825:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80182c:	e8 a3 f0 ff ff       	call   8008d4 <exit>
...
main(void) {
  ...
  801834:	83 e4 f0             	and    $0xfffffff0,%esp
  801837:	83 ec 20             	sub    $0x20,%esp
    unsigned int time = gettime_msec();
  80183a:	e8 57 f1 ff ff       	call   800996 <gettime_msec>
  80183f:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  801843:	e8 ab f0 ff ff       	call   8008f3 <fork>
  801848:	89 44 24 18          	mov    %eax,0x18(%esp)
  80184c:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801851:	75 0c                	jne    80185f <main+0x2e>
        sleepy(pid1);
  801853:	8b 44 24 18          	mov    0x18(%esp),%eax
  801857:	89 04 24             	mov    %eax,(%esp)
  80185a:	e8 7e ff ff ff       	call   8017dd <sleepy>
    }
    
    assert(waitpid(pid1, &exit_code) == 0 && exit_code == 0);
  80185f:	8d 44 24 14          	lea    0x14(%esp),%eax
  801863:	89 44 24 04          	mov    %eax,0x4(%esp)
  801867:	8b 44 24 18          	mov    0x18(%esp),%eax
  80186b:	89 04 24             	mov    %eax,(%esp)
  80186e:	e8 a9 f0 ff ff       	call   80091c <waitpid>
  801873:	85 c0                	test   %eax,%eax
  801875:	75 08                	jne    80187f <main+0x4e>
  801877:	8b 44 24 14          	mov    0x14(%esp),%eax
  80187b:	85 c0                	test   %eax,%eax
  80187d:	74 24                	je     8018a3 <main+0x72>
  80187f:	c7 44 24 0c 98 1d 80 	movl   $0x801d98,0xc(%esp)
  801886:	00 
  801887:	c7 44 24 08 c9 1d 80 	movl   $0x801dc9,0x8(%esp)
  80188e:	00 
  80188f:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801896:	00 
  801897:	c7 04 24 de 1d 80 00 	movl   $0x801dde,(%esp)
  80189e:	e8 7d ea ff ff       	call   800320 <__panic>
    cprintf("use %04d msecs.\n", gettime_msec() - time);
  8018a3:	e8 ee f0 ff ff       	call   800996 <gettime_msec>
  8018a8:	2b 44 24 1c          	sub    0x1c(%esp),%eax
  8018ac:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018b0:	c7 04 24 eb 1d 80 00 	movl   $0x801deb,(%esp)
  8018b7:	e8 55 eb ff ff       	call   800411 <cprintf>
    cprintf("sleep pass.\n");
  8018bc:	c7 04 24 fc 1d 80 00 	movl   $0x801dfc,(%esp)
  8018c3:	e8 49 eb ff ff       	call   800411 <cprintf>
    return 0;
