...
read(int fd, void *base, size_t len) {
  ...
  800128:	83 ec 18             	sub    $0x18,%esp
    _filestep = 0;
  80012b:	c7 05 40 30 80 00 00 	movl   $0x0,0x803040
  800132:	00 00 00 
    cprintf("%d [user_read]\n", _filestep++);
  800135:	a1 40 30 80 00       	mov    0x803040,%eax
  80013a:	8d 50 01             	lea    0x1(%eax),%edx
  80013d:	89 15 40 30 80 00    	mov    %edx,0x803040
  800143:	89 44 24 04          	mov    %eax,0x4(%esp)
  800147:	c7 04 24 a0 1b 80 00 	movl   $0x801ba0,(%esp)
...
write(int fd, void *base, size_t len) {
  ...
  800171:	83 ec 18             	sub    $0x18,%esp
    cprintf("[user_write]\n");
  800174:	c7 04 24 b0 1b 80 00 	movl   $0x801bb0,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80029a:	c7 04 24 be 1b 80 00 	movl   $0x801bbe,(%esp)
  ...
  8002b8:	c7 04 24 c9 1b 80 00 	movl   $0x801bc9,(%esp)
  ...
  8002ce:	c7 04 24 db 1b 80 00 	movl   $0x801bdb,(%esp)
  ...
  8002e4:	c7 04 24 ee 1b 80 00 	movl   $0x801bee,(%esp)
  ...
  8002fa:	c7 04 24 01 1c 80 00 	movl   $0x801c01,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80033a:	c7 04 24 14 1c 80 00 	movl   $0x801c14,(%esp)
  ...
  800353:	e8 7e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  800358:	c7 04 24 2e 1c 80 00 	movl   $0x801c2e,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80038a:	c7 04 24 30 1c 80 00 	movl   $0x801c30,(%esp)
  ...
  8003a3:	e8 2e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  8003a8:	c7 04 24 2e 1c 80 00 	movl   $0x801c2e,(%esp)
...
lock_fork(void) {
  ...
  8008af:	83 ec 18             	sub    $0x18,%esp
    lock(&fork_lock);
  8008b2:	c7 04 24 44 30 80 00 	movl   $0x803044,(%esp)
...
unlock_fork(void) {
  ...
  8008c3:	83 ec 04             	sub    $0x4,%esp
    unlock(&fork_lock);
  8008c6:	c7 04 24 44 30 80 00 	movl   $0x803044,(%esp)
...
exit(int error_code) {
  ...
  8008e5:	c7 04 24 4c 1c 80 00 	movl   $0x801c4c,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a51:	00 
  800a52:	c7 44 24 04 5f 1c 80 	movl   $0x801c5f,0x4(%esp)
  800a59:	00 
  ...
  800a76:	c7 44 24 08 66 1c 80 	movl   $0x801c66,0x8(%esp)
  800a7d:	00 
  800a7e:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a85:	00 
  800a86:	c7 04 24 80 1c 80 00 	movl   $0x801c80,(%esp)
  800a8d:	e8 de f8 ff ff       	call   800370 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a92:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a99:	00 
  800a9a:	c7 44 24 04 92 1c 80 	movl   $0x801c92,0x4(%esp)
  800aa1:	00 
  ...
  800abe:	c7 44 24 08 9a 1c 80 	movl   $0x801c9a,0x8(%esp)
  800ac5:	00 
  800ac6:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800acd:	00 
  800ace:	c7 04 24 80 1c 80 00 	movl   $0x801c80,(%esp)
  ...
  800ae7:	e8 37 10 00 00       	call   801b23 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c16:	05 c4 1e 80 00       	add    $0x801ec4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d7a:	8b 04 85 e8 1e 80 00 	mov    0x801ee8(,%eax,4),%eax
  ...
  800e93:	c7 44 24 0c de 1e 80 	movl   $0x801ede,0xc(%esp)
  800e9a:	00 
  ...
  800ec6:	75 05                	jne    800ecd <vprintfmt+0x1c9>
                p = "(null)";
  800ec8:	be e1 1e 80 00       	mov    $0x801ee1,%esi
            }
            if (width > 0 && padc != '-') {
...
getmode(uint32_t st_mode) {
  ...
  8017e0:	83 ec 10             	sub    $0x10,%esp
    char mode = '?';
  8017e3:	c6 45 ff 3f          	movb   $0x3f,-0x1(%ebp)
    if (S_ISREG(st_mode)) mode = '-';
  8017e7:	8b 45 08             	mov    0x8(%ebp),%eax
  8017ea:	25 00 70 00 00       	and    $0x7000,%eax
  8017ef:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8017f4:	75 04                	jne    8017fa <getmode+0x1d>
  8017f6:	c6 45 ff 2d          	movb   $0x2d,-0x1(%ebp)
    if (S_ISDIR(st_mode)) mode = 'd';
  8017fa:	8b 45 08             	mov    0x8(%ebp),%eax
  8017fd:	25 00 70 00 00       	and    $0x7000,%eax
  801802:	3d 00 20 00 00       	cmp    $0x2000,%eax
  801807:	75 04                	jne    80180d <getmode+0x30>
  801809:	c6 45 ff 64          	movb   $0x64,-0x1(%ebp)
    if (S_ISLNK(st_mode)) mode = 'l';
  80180d:	8b 45 08             	mov    0x8(%ebp),%eax
  801810:	25 00 70 00 00       	and    $0x7000,%eax
  801815:	3d 00 30 00 00       	cmp    $0x3000,%eax
  80181a:	75 04                	jne    801820 <getmode+0x43>
  80181c:	c6 45 ff 6c          	movb   $0x6c,-0x1(%ebp)
    if (S_ISCHR(st_mode)) mode = 'c';
  801820:	8b 45 08             	mov    0x8(%ebp),%eax
  801823:	25 00 70 00 00       	and    $0x7000,%eax
  801828:	3d 00 40 00 00       	cmp    $0x4000,%eax
  80182d:	75 04                	jne    801833 <getmode+0x56>
  80182f:	c6 45 ff 63          	movb   $0x63,-0x1(%ebp)
    if (S_ISBLK(st_mode)) mode = 'b';
  801833:	8b 45 08             	mov    0x8(%ebp),%eax
  801836:	25 00 70 00 00       	and    $0x7000,%eax
  80183b:	3d 00 50 00 00       	cmp    $0x5000,%eax
  801840:	75 04                	jne    801846 <getmode+0x69>
  801842:	c6 45 ff 62          	movb   $0x62,-0x1(%ebp)
    return mode;
  801846:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
  80184a:	c9                   	leave  
  80184b:	c3                   	ret    
...
getstat(const char *name, struct stat *stat) {
  ...
  801860:	e8 93 e8 ff ff       	call   8000f8 <open>
  801865:	89 45 f4             	mov    %eax,-0xc(%ebp)
  801868:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  80186c:	79 05                	jns    801873 <getstat+0x27>
        return fd;
  80186e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801871:	eb 23                	jmp    801896 <getstat+0x4a>
    }
    ret = fstat(fd, stat);
...
lsstat(struct stat *stat, const char *filename) {
  ...
  8018a6:	e8 32 ff ff ff       	call   8017dd <getmode>
  8018ab:	0f be c0             	movsbl %al,%eax
  8018ae:	89 44 24 08          	mov    %eax,0x8(%esp)
  8018b2:	c7 44 24 04 40 20 80 	movl   $0x802040,0x4(%esp)
  8018b9:	00 
  8018ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8018c1:	e8 2f ec ff ff       	call   8004f5 <fprintf>
  ...
  8018d0:	c7 44 24 04 48 20 80 	movl   $0x802048,0x4(%esp)
  8018d7:	00 
  8018d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8018df:	e8 11 ec ff ff       	call   8004f5 <fprintf>
  ...
  8018ee:	c7 44 24 04 50 20 80 	movl   $0x802050,0x4(%esp)
  8018f5:	00 
  8018f6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8018fd:	e8 f3 eb ff ff       	call   8004f5 <fprintf>
    printf(" %8d(s)", stat->st_size);
  801902:	8b 45 08             	mov    0x8(%ebp),%eax
  801905:	8b 40 0c             	mov    0xc(%eax),%eax
  801908:	89 44 24 08          	mov    %eax,0x8(%esp)
  80190c:	c7 44 24 04 58 20 80 	movl   $0x802058,0x4(%esp)
  801913:	00 
  801914:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  80191b:	e8 d5 eb ff ff       	call   8004f5 <fprintf>
    printf("   %s\n", filename);
  801920:	8b 45 0c             	mov    0xc(%ebp),%eax
  801923:	89 44 24 08          	mov    %eax,0x8(%esp)
  801927:	c7 44 24 04 60 20 80 	movl   $0x802060,0x4(%esp)
  80192e:	00 
  80192f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801936:	e8 ba eb ff ff       	call   8004f5 <fprintf>
}
  80193b:	c9                   	leave  
  80193c:	c3                   	ret    
...
lsdir(const char *path) {
  ...
  801940:	83 ec 38             	sub    $0x38,%esp
    struct stat __stat, *stat = &__stat;
  801943:	8d 45 d8             	lea    -0x28(%ebp),%eax
  801946:	89 45 f4             	mov    %eax,-0xc(%ebp)
    int ret;
    DIR *dirp = opendir(".");
  801949:	c7 04 24 67 20 80 00 	movl   $0x802067,(%esp)
  801950:	e8 cb e6 ff ff       	call   800020 <opendir>
  801955:	89 45 f0             	mov    %eax,-0x10(%ebp)
    
    if (dirp == NULL) {
  801958:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  80195c:	75 07                	jne    801965 <lsdir+0x28>
        return -1;
  80195e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801963:	eb 7e                	jmp    8019e3 <lsdir+0xa6>
    }
    struct dirent *direntp;
    while ((direntp = readdir(dirp)) != NULL) {
  801965:	eb 44                	jmp    8019ab <lsdir+0x6e>
  ...
  801974:	89 14 24             	mov    %edx,(%esp)
  801977:	e8 d0 fe ff ff       	call   80184c <getstat>
  80197c:	89 45 e8             	mov    %eax,-0x18(%ebp)
  80197f:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  801983:	74 11                	je     801996 <lsdir+0x59>
            goto failed;
  801985:	90                   	nop
    }
    printf("lsdir: step 4\n");
...
failed:
  ...
  80198c:	e8 38 e7 ff ff       	call   8000c9 <closedir>
    return ret;
  801991:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801994:	eb 4d                	jmp    8019e3 <lsdir+0xa6>
    struct dirent *direntp;
    while ((direntp = readdir(dirp)) != NULL) {
        if ((ret = getstat(direntp->name, stat)) != 0) {
            goto failed;
  ...
  8019b1:	e8 e3 e6 ff ff       	call   800099 <readdir>
  8019b6:	89 45 ec             	mov    %eax,-0x14(%ebp)
  8019b9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8019bd:	75 a8                	jne    801967 <lsdir+0x2a>
        if ((ret = getstat(direntp->name, stat)) != 0) {
            goto failed;
        }
        lsstat(stat, direntp->name);
    ...
    printf("lsdir: step 4\n");
  8019bf:	c7 44 24 04 69 20 80 	movl   $0x802069,0x4(%esp)
  8019c6:	00 
  8019c7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8019ce:	e8 22 eb ff ff       	call   8004f5 <fprintf>
    closedir(dirp);
  8019d3:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8019d6:	89 04 24             	mov    %eax,(%esp)
  8019d9:	e8 eb e6 ff ff       	call   8000c9 <closedir>
    return 0;
...
ls(const char *path) {
  ...
  8019e8:	83 ec 38             	sub    $0x38,%esp
    struct stat __stat, *stat = &__stat;
  8019eb:	8d 45 dc             	lea    -0x24(%ebp),%eax
  ...
  8019fe:	e8 49 fe ff ff       	call   80184c <getstat>
  801a03:	89 45 ec             	mov    %eax,-0x14(%ebp)
  801a06:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801a0a:	74 08                	je     801a14 <ls+0x2f>
        return ret;
  801a0c:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801a0f:	e9 0d 01 00 00       	jmp    801b21 <ls+0x13c>
        " [ symlink ]",
        " [character]",
        " [  block  ]",
        " [  ?????  ]",
  ...
  801a1c:	e8 bc fd ff ff       	call   8017dd <getmode>
  801a21:	0f be c0             	movsbl %al,%eax
  801a24:	83 f8 63             	cmp    $0x63,%eax
  801a27:	74 38                	je     801a61 <ls+0x7c>
  801a29:	83 f8 63             	cmp    $0x63,%eax
  801a2c:	7f 0c                	jg     801a3a <ls+0x55>
  801a2e:	83 f8 30             	cmp    $0x30,%eax
  801a31:	74 13                	je     801a46 <ls+0x61>
  801a33:	83 f8 62             	cmp    $0x62,%eax
  801a36:	74 32                	je     801a6a <ls+0x85>
  801a38:	eb 39                	jmp    801a73 <ls+0x8e>
  801a3a:	83 f8 64             	cmp    $0x64,%eax
  801a3d:	74 10                	je     801a4f <ls+0x6a>
  801a3f:	83 f8 6c             	cmp    $0x6c,%eax
  801a42:	74 14                	je     801a58 <ls+0x73>
  801a44:	eb 2d                	jmp    801a73 <ls+0x8e>
    case '0': type = 0; break;
  801a46:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801a4d:	eb 2c                	jmp    801a7b <ls+0x96>
    case 'd': type = 1; break;
  801a4f:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
  801a56:	eb 23                	jmp    801a7b <ls+0x96>
    case 'l': type = 2; break;
  801a58:	c7 45 f4 02 00 00 00 	movl   $0x2,-0xc(%ebp)
  801a5f:	eb 1a                	jmp    801a7b <ls+0x96>
    case 'c': type = 3; break;
  801a61:	c7 45 f4 03 00 00 00 	movl   $0x3,-0xc(%ebp)
  801a68:	eb 11                	jmp    801a7b <ls+0x96>
    case 'b': type = 4; break;
  801a6a:	c7 45 f4 04 00 00 00 	movl   $0x4,-0xc(%ebp)
  801a71:	eb 08                	jmp    801a7b <ls+0x96>
    default:  type = 5; break;
  801a73:	c7 45 f4 05 00 00 00 	movl   $0x5,-0xc(%ebp)
  801a7a:	90                   	nop
    }

    printf(" @ is %s", filetype[type]);
  801a7b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a7e:	8b 04 85 10 30 80 00 	mov    0x803010(,%eax,4),%eax
  801a85:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a89:	c7 44 24 04 78 20 80 	movl   $0x802078,0x4(%esp)
  801a90:	00 
  801a91:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a98:	e8 58 ea ff ff       	call   8004f5 <fprintf>
  ...
  801aa7:	c7 44 24 04 81 20 80 	movl   $0x802081,0x4(%esp)
  801aae:	00 
  801aaf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801ab6:	e8 3a ea ff ff       	call   8004f5 <fprintf>
  ...
  801ac5:	c7 44 24 04 8d 20 80 	movl   $0x80208d,0x4(%esp)
  801acc:	00 
  801acd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801ad4:	e8 1c ea ff ff       	call   8004f5 <fprintf>
    printf(" %d(bytes) : @'%s'\n", stat->st_size, path);
  801ad9:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801adc:	8b 40 0c             	mov    0xc(%eax),%eax
  801adf:	8b 55 08             	mov    0x8(%ebp),%edx
  801ae2:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801ae6:	89 44 24 08          	mov    %eax,0x8(%esp)
  801aea:	c7 44 24 04 99 20 80 	movl   $0x802099,0x4(%esp)
  801af1:	00 
  801af2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801af9:	e8 f7 e9 ff ff       	call   8004f5 <fprintf>
    if (S_ISDIR(stat->st_mode)) {
  801afe:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b01:	8b 00                	mov    (%eax),%eax
  801b03:	25 00 70 00 00       	and    $0x7000,%eax
  801b08:	3d 00 20 00 00       	cmp    $0x2000,%eax
  801b0d:	75 0d                	jne    801b1c <ls+0x137>
        return lsdir(path);
  801b0f:	8b 45 08             	mov    0x8(%ebp),%eax
  801b12:	89 04 24             	mov    %eax,(%esp)
  801b15:	e8 23 fe ff ff       	call   80193d <lsdir>
  801b1a:	eb 05                	jmp    801b21 <ls+0x13c>
    }
    return 0;
...
main(int argc, char **argv) {
  ...
  801b26:	83 e4 f0             	and    $0xfffffff0,%esp
  801b29:	83 ec 20             	sub    $0x20,%esp
    if (argc == 1) {
  801b2c:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
  801b30:	75 0e                	jne    801b40 <main+0x1d>
        return ls(".");
  801b32:	c7 04 24 67 20 80 00 	movl   $0x802067,(%esp)
  801b39:	e8 a7 fe ff ff       	call   8019e5 <ls>
  801b3e:	eb 48                	jmp    801b88 <main+0x65>
    }
    else {
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801b40:	c7 44 24 1c 01 00 00 	movl   $0x1,0x1c(%esp)
  801b47:	00 
  801b48:	eb 30                	jmp    801b7a <main+0x57>
            if ((ret = ls(argv[i])) != 0) {
  801b4a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  ...
  801b5f:	e8 81 fe ff ff       	call   8019e5 <ls>
  801b64:	89 44 24 18          	mov    %eax,0x18(%esp)
  801b68:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801b6d:	74 06                	je     801b75 <main+0x52>
                return ret;
  801b6f:	8b 44 24 18          	mov    0x18(%esp),%eax
  801b73:	eb 13                	jmp    801b88 <main+0x65>
    if (argc == 1) {
        return ls(".");
    }
    else {
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801b75:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801b7a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b7e:	3b 45 08             	cmp    0x8(%ebp),%eax
  801b81:	7c c7                	jl     801b4a <main+0x27>
            if ((ret = ls(argv[i])) != 0) {
                return ret;
            }
        }
