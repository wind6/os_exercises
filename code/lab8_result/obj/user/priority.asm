...
read(int fd, void *base, size_t len) {
  ...
  800147:	c7 04 24 e0 1a 80 00 	movl   $0x801ae0,(%esp)
...
write(int fd, void *base, size_t len) {
  ...
  800171:	83 ec 18             	sub    $0x18,%esp
    cprintf("[user_write]\n");
  800174:	c7 04 24 f0 1a 80 00 	movl   $0x801af0,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80029a:	c7 04 24 fe 1a 80 00 	movl   $0x801afe,(%esp)
  ...
  8002b8:	c7 04 24 09 1b 80 00 	movl   $0x801b09,(%esp)
  ...
  8002ce:	c7 04 24 1b 1b 80 00 	movl   $0x801b1b,(%esp)
  ...
  8002e4:	c7 04 24 2e 1b 80 00 	movl   $0x801b2e,(%esp)
  ...
  8002fa:	c7 04 24 41 1b 80 00 	movl   $0x801b41,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80033a:	c7 04 24 54 1b 80 00 	movl   $0x801b54,(%esp)
  ...
  800353:	e8 7e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  800358:	c7 04 24 6e 1b 80 00 	movl   $0x801b6e,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80038a:	c7 04 24 70 1b 80 00 	movl   $0x801b70,(%esp)
  ...
  8003a3:	e8 2e 00 00 00       	call   8003d6 <vcprintf>
    cprintf("\n");
  8003a8:	c7 04 24 6e 1b 80 00 	movl   $0x801b6e,(%esp)
...
exit(int error_code) {
  ...
  8008e5:	c7 04 24 8c 1b 80 00 	movl   $0x801b8c,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a51:	00 
  800a52:	c7 44 24 04 9f 1b 80 	movl   $0x801b9f,0x4(%esp)
  800a59:	00 
  ...
  800a76:	c7 44 24 08 a6 1b 80 	movl   $0x801ba6,0x8(%esp)
  800a7d:	00 
  800a7e:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a85:	00 
  800a86:	c7 04 24 c0 1b 80 00 	movl   $0x801bc0,(%esp)
  800a8d:	e8 de f8 ff ff       	call   800370 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a92:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a99:	00 
  800a9a:	c7 44 24 04 d2 1b 80 	movl   $0x801bd2,0x4(%esp)
  800aa1:	00 
  ...
  800abe:	c7 44 24 08 da 1b 80 	movl   $0x801bda,0x8(%esp)
  800ac5:	00 
  800ac6:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800acd:	00 
  800ace:	c7 04 24 c0 1b 80 00 	movl   $0x801bc0,(%esp)
  ...
  800ae7:	e8 1d 0d 00 00       	call   801809 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c16:	05 04 1e 80 00       	add    $0x801e04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d7a:	8b 04 85 28 1e 80 00 	mov    0x801e28(,%eax,4),%eax
  ...
  800e93:	c7 44 24 0c 1e 1e 80 	movl   $0x801e1e,0xc(%esp)
  800e9a:	00 
  ...
  800ec6:	75 05                	jne    800ecd <vprintfmt+0x1c9>
                p = "(null)";
  800ec8:	be 21 1e 80 00       	mov    $0x801e21,%esi
            }
            if (width > 0 && padc != '-') {
...
spin_delay(void)
{
  ...
  8017ea:	eb 12                	jmp    8017fe <spin_delay+0x21>
     {
          j = !j;
  ...
  8017f7:	89 45 f8             	mov    %eax,-0x8(%ebp)
static void
spin_delay(void)
{
     int i;
     volatile int j;
     for (i = 0; i != 200; ++ i)
  8017fa:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
  8017fe:	81 7d fc c8 00 00 00 	cmpl   $0xc8,-0x4(%ebp)
  801805:	75 e5                	jne    8017ec <spin_delay+0xf>
     {
          j = !j;
     }
}
...
main(void) {
  ...
  80180c:	56                   	push   %esi
  80180d:	53                   	push   %ebx
  80180e:	83 e4 f0             	and    $0xfffffff0,%esp
  801811:	83 ec 20             	sub    $0x20,%esp
     int i,time;
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
  801814:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  80181b:	00 
  80181c:	c7 04 24 80 1f 80 00 	movl   $0x801f80,(%esp)
  801823:	e8 e9 eb ff ff       	call   800411 <cprintf>
     sleep(SLEEP_TIME);
  801828:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  80182f:	e8 4f f1 ff ff       	call   800983 <sleep>
     memset(pids, 0, sizeof(pids));
  801834:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
  80183b:	00 
  80183c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801843:	00 
  801844:	c7 04 24 70 31 80 00 	movl   $0x803170,(%esp)
  80184b:	e8 04 fe ff ff       	call   801654 <memset>
     lab6_set_priority(TOTAL + 1);
  801850:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  801857:	e8 14 f1 ff ff       	call   800970 <lab6_set_priority>

     for (i = 0; i < TOTAL; i ++) {
  80185c:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801863:	00 
  801864:	e9 0e 01 00 00       	jmp    801977 <main+0x16e>
          acc[i]=0;
  801869:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80186d:	c7 04 85 48 31 80 00 	movl   $0x0,0x803148(,%eax,4)
  801874:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  801878:	e8 76 f0 ff ff       	call   8008f3 <fork>
  80187d:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801881:	89 04 95 70 31 80 00 	mov    %eax,0x803170(,%edx,4)
  801888:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80188c:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801893:	85 c0                	test   %eax,%eax
  801895:	0f 85 ba 00 00 00    	jne    801955 <main+0x14c>
               lab6_set_priority(i + 1);
  80189b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80189f:	83 c0 01             	add    $0x1,%eax
  8018a2:	89 04 24             	mov    %eax,(%esp)
  8018a5:	e8 c6 f0 ff ff       	call   800970 <lab6_set_priority>
               acc[i] = 0;
  8018aa:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018ae:	c7 04 85 48 31 80 00 	movl   $0x0,0x803148(,%eax,4)
  8018b5:	00 00 00 00 
               while (1) {
                    spin_delay();
  8018b9:	e8 1f ff ff ff       	call   8017dd <spin_delay>
                    ++ acc[i];
  8018be:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018c2:	8b 04 85 48 31 80 00 	mov    0x803148(,%eax,4),%eax
  8018c9:	8d 50 01             	lea    0x1(%eax),%edx
  8018cc:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018d0:	89 14 85 48 31 80 00 	mov    %edx,0x803148(,%eax,4)
                    if(acc[i]%4000==0) {
  8018d7:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018db:	8b 0c 85 48 31 80 00 	mov    0x803148(,%eax,4),%ecx
  8018e2:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  8018e7:	89 c8                	mov    %ecx,%eax
  8018e9:	f7 e2                	mul    %edx
  8018eb:	89 d0                	mov    %edx,%eax
  8018ed:	c1 e8 08             	shr    $0x8,%eax
  8018f0:	69 c0 a0 0f 00 00    	imul   $0xfa0,%eax,%eax
  8018f6:	29 c1                	sub    %eax,%ecx
  8018f8:	89 c8                	mov    %ecx,%eax
  8018fa:	85 c0                	test   %eax,%eax
  8018fc:	75 52                	jne    801950 <main+0x147>
                        if((time=gettime_msec())>SLEEP_TIME+MAX_TIME) {
  8018fe:	e8 93 f0 ff ff       	call   800996 <gettime_msec>
  801903:	89 44 24 18          	mov    %eax,0x18(%esp)
  801907:	81 7c 24 18 78 05 00 	cmpl   $0x578,0x18(%esp)
  80190e:	00 
  80190f:	7e 3f                	jle    801950 <main+0x147>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  801911:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801915:	8b 1c 85 48 31 80 00 	mov    0x803148(,%eax,4),%ebx
  80191c:	e8 35 f0 ff ff       	call   800956 <getpid>
  801921:	8b 54 24 18          	mov    0x18(%esp),%edx
  801925:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801929:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80192d:	89 44 24 04          	mov    %eax,0x4(%esp)
  801931:	c7 04 24 a8 1f 80 00 	movl   $0x801fa8,(%esp)
  801938:	e8 d4 ea ff ff       	call   800411 <cprintf>
                            exit(acc[i]);
  80193d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801941:	8b 04 85 48 31 80 00 	mov    0x803148(,%eax,4),%eax
  801948:	89 04 24             	mov    %eax,(%esp)
  80194b:	e8 84 ef ff ff       	call   8008d4 <exit>
                        }
                    }
               }
  801950:	e9 64 ff ff ff       	jmp    8018b9 <main+0xb0>
               
          }
          if (pids[i] < 0) {
  801955:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801959:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801960:	85 c0                	test   %eax,%eax
  801962:	79 0e                	jns    801972 <main+0x169>
               goto failed;
  801964:	90                   	nop
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801965:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80196c:	00 
  80196d:	e9 32 01 00 00       	jmp    801aa4 <main+0x29b>
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
     sleep(SLEEP_TIME);
     memset(pids, 0, sizeof(pids));
     lab6_set_priority(TOTAL + 1);
     ...
     for (i = 0; i < TOTAL; i ++) {
  801972:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801977:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  80197c:	0f 8e e7 fe ff ff    	jle    801869 <main+0x60>
          if (pids[i] < 0) {
               goto failed;
          }
     }
  ...
  801982:	c7 04 24 c8 1f 80 00 	movl   $0x801fc8,(%esp)
  801989:	e8 83 ea ff ff       	call   800411 <cprintf>

     for (i = 0; i < TOTAL; i ++) {
  80198e:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801995:	00 
  801996:	eb 6b                	jmp    801a03 <main+0x1fa>
         status[i]=0;
  801998:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80199c:	c7 04 85 5c 31 80 00 	movl   $0x0,0x80315c(,%eax,4)
  8019a3:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  8019a7:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8019ab:	c1 e0 02             	shl    $0x2,%eax
  8019ae:	8d 90 5c 31 80 00    	lea    0x80315c(%eax),%edx
  8019b4:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8019b8:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  8019bf:	89 54 24 04          	mov    %edx,0x4(%esp)
  8019c3:	89 04 24             	mov    %eax,(%esp)
  8019c6:	e8 51 ef ff ff       	call   80091c <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  8019cb:	e8 c6 ef ff ff       	call   800996 <gettime_msec>
  8019d0:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8019d4:	8b 0c 95 5c 31 80 00 	mov    0x80315c(,%edx,4),%ecx
  8019db:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8019df:	8b 14 95 70 31 80 00 	mov    0x803170(,%edx,4),%edx
  8019e6:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8019ea:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  8019ee:	89 54 24 04          	mov    %edx,0x4(%esp)
  8019f2:	c7 04 24 f0 1f 80 00 	movl   $0x801ff0,(%esp)
  8019f9:	e8 13 ea ff ff       	call   800411 <cprintf>
          }
     }
     ...
     for (i = 0; i < TOTAL; i ++) {
  8019fe:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801a03:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801a08:	7e 8e                	jle    801998 <main+0x18f>
         status[i]=0;
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
  801a0a:	c7 04 24 0f 20 80 00 	movl   $0x80200f,(%esp)
  801a11:	e8 fb e9 ff ff       	call   800411 <cprintf>
     cprintf("stride sched correct result:");
  801a16:	c7 04 24 25 20 80 00 	movl   $0x802025,(%esp)
  801a1d:	e8 ef e9 ff ff       	call   800411 <cprintf>
     for (i = 0; i < TOTAL; i ++)
  801a22:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801a29:	00 
  801a2a:	eb 37                	jmp    801a63 <main+0x25a>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  801a2c:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a30:	8b 04 85 5c 31 80 00 	mov    0x80315c(,%eax,4),%eax
  801a37:	01 c0                	add    %eax,%eax
  801a39:	8b 35 5c 31 80 00    	mov    0x80315c,%esi
  801a3f:	99                   	cltd   
  801a40:	f7 fe                	idiv   %esi
  801a42:	83 c0 01             	add    $0x1,%eax
  801a45:	89 c2                	mov    %eax,%edx
  801a47:	c1 ea 1f             	shr    $0x1f,%edx
  801a4a:	01 d0                	add    %edx,%eax
  801a4c:	d1 f8                	sar    %eax
  801a4e:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a52:	c7 04 24 42 20 80 00 	movl   $0x802042,(%esp)
  801a59:	e8 b3 e9 ff ff       	call   800411 <cprintf>
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
     cprintf("stride sched correct result:");
     for (i = 0; i < TOTAL; i ++)
  801a5e:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801a63:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801a68:	7e c2                	jle    801a2c <main+0x223>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
     }
     cprintf("\n");
  801a6a:	c7 04 24 46 20 80 00 	movl   $0x802046,(%esp)
  801a71:	e8 9b e9 ff ff       	call   800411 <cprintf>

     return 0;
  801a76:	b8 00 00 00 00       	mov    $0x0,%eax
  801a7b:	eb 4a                	jmp    801ac7 <main+0x2be>

failed:
     for (i = 0; i < TOTAL; i ++) {
          if (pids[i] > 0) {
  801a7d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a81:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801a88:	85 c0                	test   %eax,%eax
  801a8a:	7e 13                	jle    801a9f <main+0x296>
               kill(pids[i]);
  801a8c:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a90:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801a97:	89 04 24             	mov    %eax,(%esp)
  801a9a:	e8 a4 ee ff ff       	call   800943 <kill>
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801a9f:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801aa4:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801aa9:	7e d2                	jle    801a7d <main+0x274>
          if (pids[i] > 0) {
               kill(pids[i]);
          }
     }
     panic("FAIL: T.T\n");
  801aab:	c7 44 24 08 48 20 80 	movl   $0x802048,0x8(%esp)
  801ab2:	00 
  801ab3:	c7 44 24 04 4e 00 00 	movl   $0x4e,0x4(%esp)
  801aba:	00 
  801abb:	c7 04 24 53 20 80 00 	movl   $0x802053,(%esp)
  801ac2:	e8 59 e8 ff ff       	call   800320 <__panic>
}
