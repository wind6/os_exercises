...
main(void) {
  ...
  8017e3:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  8017e6:	e8 08 f1 ff ff       	call   8008f3 <fork>
  8017eb:	89 44 24 18          	mov    %eax,0x18(%esp)
  8017ef:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8017f4:	75 33                	jne    801829 <main+0x4c>
        cprintf("fork ok.\n");
  8017f6:	c7 04 24 e0 1d 80 00 	movl   $0x801de0,(%esp)
  8017fd:	e8 0f ec ff ff       	call   800411 <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  801802:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801809:	00 
  80180a:	eb 0a                	jmp    801816 <main+0x39>
            yield();
  80180c:	e8 25 f1 ff ff       	call   800936 <yield>
main(void) {
    int pid, exit_code;
    if ((pid = fork()) == 0) {
        cprintf("fork ok.\n");
        int i;
        for (i = 0; i < 10; i ++) {
  801811:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801816:	83 7c 24 1c 09       	cmpl   $0x9,0x1c(%esp)
  80181b:	7e ef                	jle    80180c <main+0x2f>
            yield();
        }
        exit(0xbeaf);
  80181d:	c7 04 24 af be 00 00 	movl   $0xbeaf,(%esp)
  801824:	e8 ab f0 ff ff       	call   8008d4 <exit>
    }
    assert(pid > 0);
  801829:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80182e:	7f 24                	jg     801854 <main+0x77>
  801830:	c7 44 24 0c ea 1d 80 	movl   $0x801dea,0xc(%esp)
  801837:	00 
  801838:	c7 44 24 08 f2 1d 80 	movl   $0x801df2,0x8(%esp)
  80183f:	00 
  801840:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  801847:	00 
  801848:	c7 04 24 07 1e 80 00 	movl   $0x801e07,(%esp)
  80184f:	e8 cc ea ff ff       	call   800320 <__panic>
    assert(waitpid(-1, NULL) != 0);
  801854:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80185b:	00 
  80185c:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801863:	e8 b4 f0 ff ff       	call   80091c <waitpid>
  801868:	85 c0                	test   %eax,%eax
  80186a:	75 24                	jne    801890 <main+0xb3>
  80186c:	c7 44 24 0c 15 1e 80 	movl   $0x801e15,0xc(%esp)
  801873:	00 
  801874:	c7 44 24 08 f2 1d 80 	movl   $0x801df2,0x8(%esp)
  80187b:	00 
  80187c:	c7 44 24 04 10 00 00 	movl   $0x10,0x4(%esp)
  801883:	00 
  801884:	c7 04 24 07 1e 80 00 	movl   $0x801e07,(%esp)
  80188b:	e8 90 ea ff ff       	call   800320 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  801890:	c7 44 24 04 00 00 00 	movl   $0xc0000000,0x4(%esp)
  801897:	c0 
  801898:	8b 44 24 18          	mov    0x18(%esp),%eax
  80189c:	89 04 24             	mov    %eax,(%esp)
  80189f:	e8 78 f0 ff ff       	call   80091c <waitpid>
  8018a4:	85 c0                	test   %eax,%eax
  8018a6:	75 24                	jne    8018cc <main+0xef>
  8018a8:	c7 44 24 0c 2c 1e 80 	movl   $0x801e2c,0xc(%esp)
  8018af:	00 
  8018b0:	c7 44 24 08 f2 1d 80 	movl   $0x801df2,0x8(%esp)
  8018b7:	00 
  8018b8:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  8018bf:	00 
  8018c0:	c7 04 24 07 1e 80 00 	movl   $0x801e07,(%esp)
  8018c7:	e8 54 ea ff ff       	call   800320 <__panic>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  8018cc:	8d 44 24 14          	lea    0x14(%esp),%eax
  8018d0:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018d4:	8b 44 24 18          	mov    0x18(%esp),%eax
  8018d8:	89 04 24             	mov    %eax,(%esp)
  8018db:	e8 3c f0 ff ff       	call   80091c <waitpid>
  8018e0:	85 c0                	test   %eax,%eax
  8018e2:	75 0b                	jne    8018ef <main+0x112>
  8018e4:	8b 44 24 14          	mov    0x14(%esp),%eax
  8018e8:	3d af be 00 00       	cmp    $0xbeaf,%eax
  8018ed:	74 24                	je     801913 <main+0x136>
  8018ef:	c7 44 24 0c 54 1e 80 	movl   $0x801e54,0xc(%esp)
  8018f6:	00 
  8018f7:	c7 44 24 08 f2 1d 80 	movl   $0x801df2,0x8(%esp)
  8018fe:	00 
  8018ff:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  801906:	00 
  801907:	c7 04 24 07 1e 80 00 	movl   $0x801e07,(%esp)
  80190e:	e8 0d ea ff ff       	call   800320 <__panic>
    cprintf("badarg pass.\n");
  801913:	c7 04 24 89 1e 80 00 	movl   $0x801e89,(%esp)
  80191a:	e8 f2 ea ff ff       	call   800411 <cprintf>
    return 0;
