...
main(void) {
  ...
  8017e3:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  8017e6:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  8017e8:	c7 44 24 08 c0 1c 80 	movl   $0x801cc0,0x8(%esp)
  8017ef:	00 
  8017f0:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  8017f7:	00 
  8017f8:	c7 04 24 cb 1c 80 00 	movl   $0x801ccb,(%esp)
  8017ff:	e8 1c eb ff ff       	call   800320 <__panic>
