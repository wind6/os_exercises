...
main(void) {
  ...
  8017e6:	66 b8 28 00          	mov    $0x28,%ax
  8017ea:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  8017ec:	c7 44 24 08 c0 1c 80 	movl   $0x801cc0,0x8(%esp)
  8017f3:	00 
  8017f4:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  8017fb:	00 
  8017fc:	c7 04 24 cb 1c 80 00 	movl   $0x801ccb,(%esp)
  801803:	e8 18 eb ff ff       	call   800320 <__panic>
