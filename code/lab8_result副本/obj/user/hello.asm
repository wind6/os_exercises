...
main(void) {
  ...
  8017d7:	83 ec 10             	sub    $0x10,%esp
    cprintf("Hello world!!.\n");
  8017da:	c7 04 24 c0 1c 80 00 	movl   $0x801cc0,(%esp)
  8017e1:	e8 1f ec ff ff       	call   800405 <cprintf>
    cprintf("I am process %d.\n", getpid());
  8017e6:	e8 5f f1 ff ff       	call   80094a <getpid>
  8017eb:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017ef:	c7 04 24 d0 1c 80 00 	movl   $0x801cd0,(%esp)
  8017f6:	e8 0a ec ff ff       	call   800405 <cprintf>
    cprintf("hello pass.\n");
  8017fb:	c7 04 24 e2 1c 80 00 	movl   $0x801ce2,(%esp)
  801802:	e8 fe eb ff ff       	call   800405 <cprintf>
    return 0;
