...
open(const char *path, uint32_t open_flags) {
  ...
  80011a:	c7 04 24 00 19 80 00 	movl   $0x801900,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80028e:	c7 04 24 10 19 80 00 	movl   $0x801910,(%esp)
  ...
  8002ac:	c7 04 24 1b 19 80 00 	movl   $0x80191b,(%esp)
  ...
  8002c2:	c7 04 24 2d 19 80 00 	movl   $0x80192d,(%esp)
  ...
  8002d8:	c7 04 24 40 19 80 00 	movl   $0x801940,(%esp)
  ...
  8002ee:	c7 04 24 53 19 80 00 	movl   $0x801953,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80032e:	c7 04 24 66 19 80 00 	movl   $0x801966,(%esp)
  ...
  800347:	e8 7e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80034c:	c7 04 24 80 19 80 00 	movl   $0x801980,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80037e:	c7 04 24 82 19 80 00 	movl   $0x801982,(%esp)
  ...
  800397:	e8 2e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80039c:	c7 04 24 80 19 80 00 	movl   $0x801980,(%esp)
...
exit(int error_code) {
  ...
  8008d9:	c7 04 24 9e 19 80 00 	movl   $0x80199e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a45:	00 
  800a46:	c7 44 24 04 b1 19 80 	movl   $0x8019b1,0x4(%esp)
  800a4d:	00 
  ...
  800a6a:	c7 44 24 08 b8 19 80 	movl   $0x8019b8,0x8(%esp)
  800a71:	00 
  800a72:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a79:	00 
  800a7a:	c7 04 24 d2 19 80 00 	movl   $0x8019d2,(%esp)
  800a81:	e8 de f8 ff ff       	call   800364 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a86:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a8d:	00 
  800a8e:	c7 44 24 04 e4 19 80 	movl   $0x8019e4,0x4(%esp)
  800a95:	00 
  ...
  800ab2:	c7 44 24 08 ec 19 80 	movl   $0x8019ec,0x8(%esp)
  800ab9:	00 
  800aba:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800ac1:	00 
  800ac2:	c7 04 24 d2 19 80 00 	movl   $0x8019d2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c0a:	05 24 1c 80 00       	add    $0x801c24,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d6e:	8b 04 85 48 1c 80 00 	mov    0x801c48(,%eax,4),%eax
  ...
  800e87:	c7 44 24 0c 3e 1c 80 	movl   $0x801c3e,0xc(%esp)
  800e8e:	00 
  ...
  800eba:	75 05                	jne    800ec1 <vprintfmt+0x1c9>
                p = "(null)";
  800ebc:	be 41 1c 80 00       	mov    $0x801c41,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017da:	c7 04 24 a0 1d 80 00 	movl   $0x801da0,(%esp)
  8017e1:	e8 1f ec ff ff       	call   800405 <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  8017e6:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8017ed:	00 
  8017ee:	eb 38                	jmp    801828 <main+0x57>
        if (bigarray[i] != 0) {
  8017f0:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8017f4:	8b 04 85 80 21 80 00 	mov    0x802180(,%eax,4),%eax
  8017fb:	85 c0                	test   %eax,%eax
  8017fd:	74 24                	je     801823 <main+0x52>
            panic("bigarray[%d] isn't cleared!\n", i);
  8017ff:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801803:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801807:	c7 44 24 08 c0 1d 80 	movl   $0x801dc0,0x8(%esp)
  80180e:	00 
  80180f:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801816:	00 
  801817:	c7 04 24 dd 1d 80 00 	movl   $0x801ddd,(%esp)
  80181e:	e8 f1 ea ff ff       	call   800314 <__panic>
...
main(void) {
    ...
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  801823:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801828:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  80182f:	00 
  801830:	7e be                	jle    8017f0 <main+0x1f>
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801832:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801839:	00 
  80183a:	eb 14                	jmp    801850 <main+0x7f>
        bigarray[i] = i;
  80183c:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801840:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801844:	89 14 85 80 21 80 00 	mov    %edx,0x802180(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
  ...
  801850:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801857:	00 
  801858:	7e e2                	jle    80183c <main+0x6b>
        bigarray[i] = i;
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80185a:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801861:	00 
  801862:	eb 3c                	jmp    8018a0 <main+0xcf>
        if (bigarray[i] != i) {
  801864:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801868:	8b 14 85 80 21 80 00 	mov    0x802180(,%eax,4),%edx
  80186f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801873:	39 c2                	cmp    %eax,%edx
  801875:	74 24                	je     80189b <main+0xca>
            panic("bigarray[%d] didn't hold its value!\n", i);
  801877:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80187b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80187f:	c7 44 24 08 ec 1d 80 	movl   $0x801dec,0x8(%esp)
  801886:	00 
  801887:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  80188e:	00 
  80188f:	c7 04 24 dd 1d 80 00 	movl   $0x801ddd,(%esp)
  801896:	e8 79 ea ff ff       	call   800314 <__panic>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
        bigarray[i] = i;
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  80189b:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  8018a0:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  8018a7:	00 
  8018a8:	7e ba                	jle    801864 <main+0x93>
        if (bigarray[i] != i) {
            panic("bigarray[%d] didn't hold its value!\n", i);
        }
    }
  ...
  8018aa:	c7 04 24 14 1e 80 00 	movl   $0x801e14,(%esp)
  8018b1:	e8 4f eb ff ff       	call   800405 <cprintf>
    cprintf("testbss may pass.\n");
  8018b6:	c7 04 24 47 1e 80 00 	movl   $0x801e47,(%esp)
  8018bd:	e8 43 eb ff ff       	call   800405 <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
  8018c2:	c7 05 80 31 c0 00 00 	movl   $0x0,0xc03180
  8018c9:	00 00 00 
    asm volatile ("int $0x14");
  8018cc:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  8018ce:	c7 44 24 08 5a 1e 80 	movl   $0x801e5a,0x8(%esp)
  8018d5:	00 
  8018d6:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  8018dd:	00 
  8018de:	c7 04 24 dd 1d 80 00 	movl   $0x801ddd,(%esp)
  8018e5:	e8 2a ea ff ff       	call   800314 <__panic>
