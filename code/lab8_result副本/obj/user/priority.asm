...
open(const char *path, uint32_t open_flags) {
  ...
  80011a:	c7 04 24 e0 1a 80 00 	movl   $0x801ae0,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80028e:	c7 04 24 f0 1a 80 00 	movl   $0x801af0,(%esp)
  ...
  8002ac:	c7 04 24 fb 1a 80 00 	movl   $0x801afb,(%esp)
  ...
  8002c2:	c7 04 24 0d 1b 80 00 	movl   $0x801b0d,(%esp)
  ...
  8002d8:	c7 04 24 20 1b 80 00 	movl   $0x801b20,(%esp)
  ...
  8002ee:	c7 04 24 33 1b 80 00 	movl   $0x801b33,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80032e:	c7 04 24 46 1b 80 00 	movl   $0x801b46,(%esp)
  ...
  800347:	e8 7e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80034c:	c7 04 24 60 1b 80 00 	movl   $0x801b60,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80037e:	c7 04 24 62 1b 80 00 	movl   $0x801b62,(%esp)
  ...
  800397:	e8 2e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80039c:	c7 04 24 60 1b 80 00 	movl   $0x801b60,(%esp)
...
exit(int error_code) {
  ...
  8008d9:	c7 04 24 7e 1b 80 00 	movl   $0x801b7e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a45:	00 
  800a46:	c7 44 24 04 91 1b 80 	movl   $0x801b91,0x4(%esp)
  800a4d:	00 
  ...
  800a6a:	c7 44 24 08 98 1b 80 	movl   $0x801b98,0x8(%esp)
  800a71:	00 
  800a72:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a79:	00 
  800a7a:	c7 04 24 b2 1b 80 00 	movl   $0x801bb2,(%esp)
  800a81:	e8 de f8 ff ff       	call   800364 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a86:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a8d:	00 
  800a8e:	c7 44 24 04 c4 1b 80 	movl   $0x801bc4,0x4(%esp)
  800a95:	00 
  ...
  800ab2:	c7 44 24 08 cc 1b 80 	movl   $0x801bcc,0x8(%esp)
  800ab9:	00 
  800aba:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800ac1:	00 
  800ac2:	c7 04 24 b2 1b 80 00 	movl   $0x801bb2,(%esp)
  ...
  800adb:	e8 1d 0d 00 00       	call   8017fd <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c0a:	05 04 1e 80 00       	add    $0x801e04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d6e:	8b 04 85 28 1e 80 00 	mov    0x801e28(,%eax,4),%eax
  ...
  800e87:	c7 44 24 0c 1e 1e 80 	movl   $0x801e1e,0xc(%esp)
  800e8e:	00 
  ...
  800eba:	75 05                	jne    800ec1 <vprintfmt+0x1c9>
                p = "(null)";
  800ebc:	be 21 1e 80 00       	mov    $0x801e21,%esi
            }
            if (width > 0 && padc != '-') {
...
spin_delay(void)
{
  ...
  8017d4:	83 ec 10             	sub    $0x10,%esp
     ...
     volatile int j;
     for (i = 0; i != 200; ++ i)
  8017d7:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
  8017de:	eb 12                	jmp    8017f2 <spin_delay+0x21>
     {
          j = !j;
  8017e0:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8017e3:	85 c0                	test   %eax,%eax
  8017e5:	0f 94 c0             	sete   %al
  8017e8:	0f b6 c0             	movzbl %al,%eax
  8017eb:	89 45 f8             	mov    %eax,-0x8(%ebp)
static void
spin_delay(void)
{
     int i;
     volatile int j;
     for (i = 0; i != 200; ++ i)
  8017ee:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
  8017f2:	81 7d fc c8 00 00 00 	cmpl   $0xc8,-0x4(%ebp)
  8017f9:	75 e5                	jne    8017e0 <spin_delay+0xf>
     {
          j = !j;
     }
}
...
main(void) {
  ...
  801800:	56                   	push   %esi
  801801:	53                   	push   %ebx
  801802:	83 e4 f0             	and    $0xfffffff0,%esp
  801805:	83 ec 20             	sub    $0x20,%esp
     int i,time;
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
  801808:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  80180f:	00 
  801810:	c7 04 24 80 1f 80 00 	movl   $0x801f80,(%esp)
  801817:	e8 e9 eb ff ff       	call   800405 <cprintf>
     sleep(SLEEP_TIME);
  80181c:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  801823:	e8 4f f1 ff ff       	call   800977 <sleep>
     memset(pids, 0, sizeof(pids));
  801828:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
  80182f:	00 
  801830:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801837:	00 
  801838:	c7 04 24 90 31 80 00 	movl   $0x803190,(%esp)
  80183f:	e8 04 fe ff ff       	call   801648 <memset>
     lab6_set_priority(TOTAL + 1);
  801844:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  80184b:	e8 14 f1 ff ff       	call   800964 <lab6_set_priority>

     for (i = 0; i < TOTAL; i ++) {
  801850:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801857:	00 
  801858:	e9 0e 01 00 00       	jmp    80196b <main+0x16e>
          acc[i]=0;
  80185d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801861:	c7 04 85 68 31 80 00 	movl   $0x0,0x803168(,%eax,4)
  801868:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  80186c:	e8 76 f0 ff ff       	call   8008e7 <fork>
  801871:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801875:	89 04 95 90 31 80 00 	mov    %eax,0x803190(,%edx,4)
  80187c:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801880:	8b 04 85 90 31 80 00 	mov    0x803190(,%eax,4),%eax
  801887:	85 c0                	test   %eax,%eax
  801889:	0f 85 ba 00 00 00    	jne    801949 <main+0x14c>
               lab6_set_priority(i + 1);
  80188f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801893:	83 c0 01             	add    $0x1,%eax
  801896:	89 04 24             	mov    %eax,(%esp)
  801899:	e8 c6 f0 ff ff       	call   800964 <lab6_set_priority>
               acc[i] = 0;
  80189e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018a2:	c7 04 85 68 31 80 00 	movl   $0x0,0x803168(,%eax,4)
  8018a9:	00 00 00 00 
               while (1) {
                    spin_delay();
  8018ad:	e8 1f ff ff ff       	call   8017d1 <spin_delay>
                    ++ acc[i];
  8018b2:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018b6:	8b 04 85 68 31 80 00 	mov    0x803168(,%eax,4),%eax
  8018bd:	8d 50 01             	lea    0x1(%eax),%edx
  8018c0:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018c4:	89 14 85 68 31 80 00 	mov    %edx,0x803168(,%eax,4)
                    if(acc[i]%4000==0) {
  8018cb:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018cf:	8b 0c 85 68 31 80 00 	mov    0x803168(,%eax,4),%ecx
  8018d6:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  8018db:	89 c8                	mov    %ecx,%eax
  8018dd:	f7 e2                	mul    %edx
  8018df:	89 d0                	mov    %edx,%eax
  8018e1:	c1 e8 08             	shr    $0x8,%eax
  8018e4:	69 c0 a0 0f 00 00    	imul   $0xfa0,%eax,%eax
  8018ea:	29 c1                	sub    %eax,%ecx
  8018ec:	89 c8                	mov    %ecx,%eax
  8018ee:	85 c0                	test   %eax,%eax
  8018f0:	75 52                	jne    801944 <main+0x147>
                        if((time=gettime_msec())>SLEEP_TIME+MAX_TIME) {
  8018f2:	e8 93 f0 ff ff       	call   80098a <gettime_msec>
  8018f7:	89 44 24 18          	mov    %eax,0x18(%esp)
  8018fb:	81 7c 24 18 78 05 00 	cmpl   $0x578,0x18(%esp)
  801902:	00 
  801903:	7e 3f                	jle    801944 <main+0x147>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  801905:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801909:	8b 1c 85 68 31 80 00 	mov    0x803168(,%eax,4),%ebx
  801910:	e8 35 f0 ff ff       	call   80094a <getpid>
  801915:	8b 54 24 18          	mov    0x18(%esp),%edx
  801919:	89 54 24 0c          	mov    %edx,0xc(%esp)
  80191d:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801921:	89 44 24 04          	mov    %eax,0x4(%esp)
  801925:	c7 04 24 a8 1f 80 00 	movl   $0x801fa8,(%esp)
  80192c:	e8 d4 ea ff ff       	call   800405 <cprintf>
                            exit(acc[i]);
  801931:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801935:	8b 04 85 68 31 80 00 	mov    0x803168(,%eax,4),%eax
  80193c:	89 04 24             	mov    %eax,(%esp)
  80193f:	e8 84 ef ff ff       	call   8008c8 <exit>
                        }
                    }
               }
  801944:	e9 64 ff ff ff       	jmp    8018ad <main+0xb0>
               
          }
          if (pids[i] < 0) {
  801949:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80194d:	8b 04 85 90 31 80 00 	mov    0x803190(,%eax,4),%eax
  801954:	85 c0                	test   %eax,%eax
  801956:	79 0e                	jns    801966 <main+0x169>
               goto failed;
  801958:	90                   	nop
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801959:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801960:	00 
  801961:	e9 32 01 00 00       	jmp    801a98 <main+0x29b>
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
     sleep(SLEEP_TIME);
     memset(pids, 0, sizeof(pids));
     lab6_set_priority(TOTAL + 1);
     ...
     for (i = 0; i < TOTAL; i ++) {
  801966:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  80196b:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801970:	0f 8e e7 fe ff ff    	jle    80185d <main+0x60>
          if (pids[i] < 0) {
               goto failed;
          }
     }
  ...
  801976:	c7 04 24 c8 1f 80 00 	movl   $0x801fc8,(%esp)
  80197d:	e8 83 ea ff ff       	call   800405 <cprintf>

     for (i = 0; i < TOTAL; i ++) {
  801982:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801989:	00 
  80198a:	eb 6b                	jmp    8019f7 <main+0x1fa>
         status[i]=0;
  80198c:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801990:	c7 04 85 7c 31 80 00 	movl   $0x0,0x80317c(,%eax,4)
  801997:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  80199b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80199f:	c1 e0 02             	shl    $0x2,%eax
  8019a2:	8d 90 7c 31 80 00    	lea    0x80317c(%eax),%edx
  8019a8:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8019ac:	8b 04 85 90 31 80 00 	mov    0x803190(,%eax,4),%eax
  8019b3:	89 54 24 04          	mov    %edx,0x4(%esp)
  8019b7:	89 04 24             	mov    %eax,(%esp)
  8019ba:	e8 51 ef ff ff       	call   800910 <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  8019bf:	e8 c6 ef ff ff       	call   80098a <gettime_msec>
  8019c4:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8019c8:	8b 0c 95 7c 31 80 00 	mov    0x80317c(,%edx,4),%ecx
  8019cf:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8019d3:	8b 14 95 90 31 80 00 	mov    0x803190(,%edx,4),%edx
  8019da:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8019de:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  8019e2:	89 54 24 04          	mov    %edx,0x4(%esp)
  8019e6:	c7 04 24 f0 1f 80 00 	movl   $0x801ff0,(%esp)
  8019ed:	e8 13 ea ff ff       	call   800405 <cprintf>
          }
     }
     ...
     for (i = 0; i < TOTAL; i ++) {
  8019f2:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  8019f7:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  8019fc:	7e 8e                	jle    80198c <main+0x18f>
         status[i]=0;
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
  8019fe:	c7 04 24 0f 20 80 00 	movl   $0x80200f,(%esp)
  801a05:	e8 fb e9 ff ff       	call   800405 <cprintf>
     cprintf("stride sched correct result:");
  801a0a:	c7 04 24 25 20 80 00 	movl   $0x802025,(%esp)
  801a11:	e8 ef e9 ff ff       	call   800405 <cprintf>
     for (i = 0; i < TOTAL; i ++)
  801a16:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801a1d:	00 
  801a1e:	eb 37                	jmp    801a57 <main+0x25a>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  801a20:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a24:	8b 04 85 7c 31 80 00 	mov    0x80317c(,%eax,4),%eax
  801a2b:	01 c0                	add    %eax,%eax
  801a2d:	8b 35 7c 31 80 00    	mov    0x80317c,%esi
  801a33:	99                   	cltd   
  801a34:	f7 fe                	idiv   %esi
  801a36:	83 c0 01             	add    $0x1,%eax
  801a39:	89 c2                	mov    %eax,%edx
  801a3b:	c1 ea 1f             	shr    $0x1f,%edx
  801a3e:	01 d0                	add    %edx,%eax
  801a40:	d1 f8                	sar    %eax
  801a42:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a46:	c7 04 24 42 20 80 00 	movl   $0x802042,(%esp)
  801a4d:	e8 b3 e9 ff ff       	call   800405 <cprintf>
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
     cprintf("stride sched correct result:");
     for (i = 0; i < TOTAL; i ++)
  801a52:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801a57:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801a5c:	7e c2                	jle    801a20 <main+0x223>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
     }
     cprintf("\n");
  801a5e:	c7 04 24 46 20 80 00 	movl   $0x802046,(%esp)
  801a65:	e8 9b e9 ff ff       	call   800405 <cprintf>

     return 0;
  801a6a:	b8 00 00 00 00       	mov    $0x0,%eax
  801a6f:	eb 4a                	jmp    801abb <main+0x2be>

failed:
     for (i = 0; i < TOTAL; i ++) {
          if (pids[i] > 0) {
  801a71:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a75:	8b 04 85 90 31 80 00 	mov    0x803190(,%eax,4),%eax
  801a7c:	85 c0                	test   %eax,%eax
  801a7e:	7e 13                	jle    801a93 <main+0x296>
               kill(pids[i]);
  801a80:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a84:	8b 04 85 90 31 80 00 	mov    0x803190(,%eax,4),%eax
  801a8b:	89 04 24             	mov    %eax,(%esp)
  801a8e:	e8 a4 ee ff ff       	call   800937 <kill>
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801a93:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801a98:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801a9d:	7e d2                	jle    801a71 <main+0x274>
          if (pids[i] > 0) {
               kill(pids[i]);
          }
     }
     panic("FAIL: T.T\n");
  801a9f:	c7 44 24 08 48 20 80 	movl   $0x802048,0x8(%esp)
  801aa6:	00 
  801aa7:	c7 44 24 04 4e 00 00 	movl   $0x4e,0x4(%esp)
  801aae:	00 
  801aaf:	c7 04 24 53 20 80 00 	movl   $0x802053,(%esp)
  801ab6:	e8 59 e8 ff ff       	call   800314 <__panic>
}
