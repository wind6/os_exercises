...
open(const char *path, uint32_t open_flags) {
  ...
  80011a:	c7 04 24 40 19 80 00 	movl   $0x801940,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80028e:	c7 04 24 50 19 80 00 	movl   $0x801950,(%esp)
  ...
  8002ac:	c7 04 24 5b 19 80 00 	movl   $0x80195b,(%esp)
  ...
  8002c2:	c7 04 24 6d 19 80 00 	movl   $0x80196d,(%esp)
  ...
  8002d8:	c7 04 24 80 19 80 00 	movl   $0x801980,(%esp)
  ...
  8002ee:	c7 04 24 93 19 80 00 	movl   $0x801993,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80032e:	c7 04 24 a6 19 80 00 	movl   $0x8019a6,(%esp)
  ...
  800347:	e8 7e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80034c:	c7 04 24 c0 19 80 00 	movl   $0x8019c0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80037e:	c7 04 24 c2 19 80 00 	movl   $0x8019c2,(%esp)
  ...
  800397:	e8 2e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80039c:	c7 04 24 c0 19 80 00 	movl   $0x8019c0,(%esp)
...
exit(int error_code) {
  ...
  8008d9:	c7 04 24 de 19 80 00 	movl   $0x8019de,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a45:	00 
  800a46:	c7 44 24 04 f1 19 80 	movl   $0x8019f1,0x4(%esp)
  800a4d:	00 
  ...
  800a6a:	c7 44 24 08 f8 19 80 	movl   $0x8019f8,0x8(%esp)
  800a71:	00 
  800a72:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a79:	00 
  800a7a:	c7 04 24 12 1a 80 00 	movl   $0x801a12,(%esp)
  800a81:	e8 de f8 ff ff       	call   800364 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a86:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a8d:	00 
  800a8e:	c7 44 24 04 24 1a 80 	movl   $0x801a24,0x4(%esp)
  800a95:	00 
  ...
  800ab2:	c7 44 24 08 2c 1a 80 	movl   $0x801a2c,0x8(%esp)
  800ab9:	00 
  800aba:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800ac1:	00 
  800ac2:	c7 04 24 12 1a 80 00 	movl   $0x801a12,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c0a:	05 64 1c 80 00       	add    $0x801c64,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d6e:	8b 04 85 88 1c 80 00 	mov    0x801c88(,%eax,4),%eax
  ...
  800e87:	c7 44 24 0c 7e 1c 80 	movl   $0x801c7e,0xc(%esp)
  800e8e:	00 
  ...
  800eba:	75 05                	jne    800ec1 <vprintfmt+0x1c9>
                p = "(null)";
  800ebc:	be 81 1c 80 00       	mov    $0x801c81,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017da:	c7 04 24 e0 1d 80 00 	movl   $0x801de0,(%esp)
  8017e1:	e8 1f ec ff ff       	call   800405 <cprintf>
    if ((pid = fork()) == 0) {
  8017e6:	e8 fc f0 ff ff       	call   8008e7 <fork>
  8017eb:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  8017ef:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8017f4:	75 3c                	jne    801832 <main+0x61>
        cprintf("I am the child.\n");
  8017f6:	c7 04 24 07 1e 80 00 	movl   $0x801e07,(%esp)
  8017fd:	e8 03 ec ff ff       	call   800405 <cprintf>
        yield();
  801802:	e8 23 f1 ff ff       	call   80092a <yield>
        yield();
  801807:	e8 1e f1 ff ff       	call   80092a <yield>
        yield();
  80180c:	e8 19 f1 ff ff       	call   80092a <yield>
        yield();
  801811:	e8 14 f1 ff ff       	call   80092a <yield>
        yield();
  801816:	e8 0f f1 ff ff       	call   80092a <yield>
        yield();
  80181b:	e8 0a f1 ff ff       	call   80092a <yield>
        yield();
  801820:	e8 05 f1 ff ff       	call   80092a <yield>
        exit(magic);
  801825:	a1 10 20 80 00       	mov    0x802010,%eax
  80182a:	89 04 24             	mov    %eax,(%esp)
  80182d:	e8 96 f0 ff ff       	call   8008c8 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  801832:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801836:	89 44 24 04          	mov    %eax,0x4(%esp)
  80183a:	c7 04 24 18 1e 80 00 	movl   $0x801e18,(%esp)
  801841:	e8 bf eb ff ff       	call   800405 <cprintf>
    }
    assert(pid > 0);
  801846:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  80184b:	7f 24                	jg     801871 <main+0xa0>
  80184d:	c7 44 24 0c 3a 1e 80 	movl   $0x801e3a,0xc(%esp)
  801854:	00 
  801855:	c7 44 24 08 42 1e 80 	movl   $0x801e42,0x8(%esp)
  80185c:	00 
  80185d:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  801864:	00 
  801865:	c7 04 24 57 1e 80 00 	movl   $0x801e57,(%esp)
  80186c:	e8 a3 ea ff ff       	call   800314 <__panic>
    cprintf("I am the parent, waiting now..\n");
  801871:	c7 04 24 64 1e 80 00 	movl   $0x801e64,(%esp)
  801878:	e8 88 eb ff ff       	call   800405 <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  80187d:	8d 44 24 18          	lea    0x18(%esp),%eax
  801881:	89 44 24 04          	mov    %eax,0x4(%esp)
  801885:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801889:	89 04 24             	mov    %eax,(%esp)
  80188c:	e8 7f f0 ff ff       	call   800910 <waitpid>
  801891:	85 c0                	test   %eax,%eax
  801893:	75 0d                	jne    8018a2 <main+0xd1>
  801895:	8b 54 24 18          	mov    0x18(%esp),%edx
  801899:	a1 10 20 80 00       	mov    0x802010,%eax
  80189e:	39 c2                	cmp    %eax,%edx
  8018a0:	74 24                	je     8018c6 <main+0xf5>
  8018a2:	c7 44 24 0c 84 1e 80 	movl   $0x801e84,0xc(%esp)
  8018a9:	00 
  8018aa:	c7 44 24 08 42 1e 80 	movl   $0x801e42,0x8(%esp)
  8018b1:	00 
  8018b2:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  8018b9:	00 
  8018ba:	c7 04 24 57 1e 80 00 	movl   $0x801e57,(%esp)
  8018c1:	e8 4e ea ff ff       	call   800314 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  8018c6:	8d 44 24 18          	lea    0x18(%esp),%eax
  8018ca:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018ce:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018d2:	89 04 24             	mov    %eax,(%esp)
  8018d5:	e8 36 f0 ff ff       	call   800910 <waitpid>
  8018da:	85 c0                	test   %eax,%eax
  8018dc:	74 09                	je     8018e7 <main+0x116>
  8018de:	e8 11 f0 ff ff       	call   8008f4 <wait>
  8018e3:	85 c0                	test   %eax,%eax
  8018e5:	75 24                	jne    80190b <main+0x13a>
  8018e7:	c7 44 24 0c b0 1e 80 	movl   $0x801eb0,0xc(%esp)
  8018ee:	00 
  8018ef:	c7 44 24 08 42 1e 80 	movl   $0x801e42,0x8(%esp)
  8018f6:	00 
  8018f7:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8018fe:	00 
  8018ff:	c7 04 24 57 1e 80 00 	movl   $0x801e57,(%esp)
  801906:	e8 09 ea ff ff       	call   800314 <__panic>
    cprintf("waitpid %d ok.\n", pid);
  80190b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80190f:	89 44 24 04          	mov    %eax,0x4(%esp)
  801913:	c7 04 24 d8 1e 80 00 	movl   $0x801ed8,(%esp)
  80191a:	e8 e6 ea ff ff       	call   800405 <cprintf>

    cprintf("exit pass.\n");
  80191f:	c7 04 24 e8 1e 80 00 	movl   $0x801ee8,(%esp)
  801926:	e8 da ea ff ff       	call   800405 <cprintf>
    return 0;
