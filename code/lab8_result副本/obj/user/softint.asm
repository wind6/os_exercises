...
main(void) {
  ...
  8017d7:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  8017da:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  8017dc:	c7 44 24 08 a0 1c 80 	movl   $0x801ca0,0x8(%esp)
  8017e3:	00 
  8017e4:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  8017eb:	00 
  8017ec:	c7 04 24 ab 1c 80 00 	movl   $0x801cab,(%esp)
  8017f3:	e8 1c eb ff ff       	call   800314 <__panic>
