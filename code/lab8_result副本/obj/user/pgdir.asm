...
main(void) {
  ...
  8017e3:	c7 04 24 c0 1c 80 00 	movl   $0x801cc0,(%esp)
  8017ea:	e8 16 ec ff ff       	call   800405 <cprintf>
    print_pgdir();
  8017ef:	e8 63 f1 ff ff       	call   800957 <print_pgdir>
    cprintf("pgdir pass.\n");
  8017f4:	c7 04 24 d7 1c 80 00 	movl   $0x801cd7,(%esp)
  8017fb:	e8 05 ec ff ff       	call   800405 <cprintf>
    return 0;
