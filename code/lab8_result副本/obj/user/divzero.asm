...
open(const char *path, uint32_t open_flags) {
  ...
  80011a:	c7 04 24 20 18 80 00 	movl   $0x801820,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80028e:	c7 04 24 30 18 80 00 	movl   $0x801830,(%esp)
  ...
  8002ac:	c7 04 24 3b 18 80 00 	movl   $0x80183b,(%esp)
  ...
  8002c2:	c7 04 24 4d 18 80 00 	movl   $0x80184d,(%esp)
  ...
  8002d8:	c7 04 24 60 18 80 00 	movl   $0x801860,(%esp)
  ...
  8002ee:	c7 04 24 73 18 80 00 	movl   $0x801873,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80032e:	c7 04 24 86 18 80 00 	movl   $0x801886,(%esp)
  ...
  800347:	e8 7e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80034c:	c7 04 24 a0 18 80 00 	movl   $0x8018a0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80037e:	c7 04 24 a2 18 80 00 	movl   $0x8018a2,(%esp)
  ...
  800397:	e8 2e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80039c:	c7 04 24 a0 18 80 00 	movl   $0x8018a0,(%esp)
...
exit(int error_code) {
  ...
  8008d9:	c7 04 24 be 18 80 00 	movl   $0x8018be,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a45:	00 
  800a46:	c7 44 24 04 d1 18 80 	movl   $0x8018d1,0x4(%esp)
  800a4d:	00 
  ...
  800a6a:	c7 44 24 08 d8 18 80 	movl   $0x8018d8,0x8(%esp)
  800a71:	00 
  800a72:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a79:	00 
  800a7a:	c7 04 24 f2 18 80 00 	movl   $0x8018f2,(%esp)
  800a81:	e8 de f8 ff ff       	call   800364 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a86:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a8d:	00 
  800a8e:	c7 44 24 04 04 19 80 	movl   $0x801904,0x4(%esp)
  800a95:	00 
  ...
  800ab2:	c7 44 24 08 0c 19 80 	movl   $0x80190c,0x8(%esp)
  800ab9:	00 
  800aba:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800ac1:	00 
  800ac2:	c7 04 24 f2 18 80 00 	movl   $0x8018f2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c0a:	05 44 1b 80 00       	add    $0x801b44,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d6e:	8b 04 85 68 1b 80 00 	mov    0x801b68(,%eax,4),%eax
  ...
  800e87:	c7 44 24 0c 5e 1b 80 	movl   $0x801b5e,0xc(%esp)
  800e8e:	00 
  ...
  800eba:	75 05                	jne    800ec1 <vprintfmt+0x1c9>
                p = "(null)";
  800ebc:	be 61 1b 80 00       	mov    $0x801b61,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017d7:	83 ec 10             	sub    $0x10,%esp
    cprintf("value is %d.\n", 1 / zero);
  8017da:	8b 0d 68 21 80 00    	mov    0x802168,%ecx
  8017e0:	b8 01 00 00 00       	mov    $0x1,%eax
  8017e5:	99                   	cltd   
  8017e6:	f7 f9                	idiv   %ecx
  8017e8:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017ec:	c7 04 24 c0 1c 80 00 	movl   $0x801cc0,(%esp)
  8017f3:	e8 0d ec ff ff       	call   800405 <cprintf>
    panic("FAIL: T.T\n");
  8017f8:	c7 44 24 08 ce 1c 80 	movl   $0x801cce,0x8(%esp)
  8017ff:	00 
  801800:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  801807:	00 
  801808:	c7 04 24 d9 1c 80 00 	movl   $0x801cd9,(%esp)
  80180f:	e8 00 eb ff ff       	call   800314 <__panic>
