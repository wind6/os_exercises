...
open(const char *path, uint32_t open_flags) {
  ...
  80011a:	c7 04 24 c0 1b 80 00 	movl   $0x801bc0,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80028e:	c7 04 24 d0 1b 80 00 	movl   $0x801bd0,(%esp)
  ...
  8002ac:	c7 04 24 db 1b 80 00 	movl   $0x801bdb,(%esp)
  ...
  8002c2:	c7 04 24 ed 1b 80 00 	movl   $0x801bed,(%esp)
  ...
  8002d8:	c7 04 24 00 1c 80 00 	movl   $0x801c00,(%esp)
  ...
  8002ee:	c7 04 24 13 1c 80 00 	movl   $0x801c13,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80032e:	c7 04 24 26 1c 80 00 	movl   $0x801c26,(%esp)
  ...
  800347:	e8 7e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80034c:	c7 04 24 40 1c 80 00 	movl   $0x801c40,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80037e:	c7 04 24 42 1c 80 00 	movl   $0x801c42,(%esp)
  ...
  800397:	e8 2e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80039c:	c7 04 24 40 1c 80 00 	movl   $0x801c40,(%esp)
...
exit(int error_code) {
  ...
  8008d9:	c7 04 24 5e 1c 80 00 	movl   $0x801c5e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a45:	00 
  800a46:	c7 44 24 04 71 1c 80 	movl   $0x801c71,0x4(%esp)
  800a4d:	00 
  ...
  800a6a:	c7 44 24 08 78 1c 80 	movl   $0x801c78,0x8(%esp)
  800a71:	00 
  800a72:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a79:	00 
  800a7a:	c7 04 24 92 1c 80 00 	movl   $0x801c92,(%esp)
  800a81:	e8 de f8 ff ff       	call   800364 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a86:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a8d:	00 
  800a8e:	c7 44 24 04 a4 1c 80 	movl   $0x801ca4,0x4(%esp)
  800a95:	00 
  ...
  800ab2:	c7 44 24 08 ac 1c 80 	movl   $0x801cac,0x8(%esp)
  800ab9:	00 
  800aba:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800ac1:	00 
  800ac2:	c7 04 24 92 1c 80 00 	movl   $0x801c92,(%esp)
  ...
  800adb:	e8 29 0f 00 00       	call   801a09 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c0a:	05 e4 1e 80 00       	add    $0x801ee4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d6e:	8b 04 85 08 1f 80 00 	mov    0x801f08(,%eax,4),%eax
  ...
  800e87:	c7 44 24 0c fe 1e 80 	movl   $0x801efe,0xc(%esp)
  800e8e:	00 
  ...
  800eba:	75 05                	jne    800ec1 <vprintfmt+0x1c9>
                p = "(null)";
  800ebc:	be 01 1f 80 00       	mov    $0x801f01,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  8017d8:	c7 45 e8 0a 00 00 00 	movl   $0xa,-0x18(%ebp)
    for (i = 0; i < size; i ++) {
  8017df:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8017e6:	eb 65                	jmp    80184d <work+0x7c>
        for (j = 0; j < size; j ++) {
  8017e8:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  8017ef:	eb 50                	jmp    801841 <work+0x70>
            mata[i][j] = matb[i][j] = 1;
  ...
  801836:	89 0c 85 80 30 80 00 	mov    %ecx,0x803080(,%eax,4)
...
work(unsigned int times) {
    ...
    for (i = 0; i < size; i ++) {
        for (j = 0; j < size; j ++) {
  80183d:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  801841:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801844:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801847:	7c a8                	jl     8017f1 <work+0x20>
static int matc[MATSIZE][MATSIZE];
...
work(unsigned int times) {
    int i, j, k, size = MATSIZE;
    for (i = 0; i < size; i ++) {
  801849:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80184d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801850:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801853:	7c 93                	jl     8017e8 <work+0x17>
        for (j = 0; j < size; j ++) {
            mata[i][j] = matb[i][j] = 1;
        }
    }
    ...
    yield();
  801855:	e8 d0 f0 ff ff       	call   80092a <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  80185a:	e8 eb f0 ff ff       	call   80094a <getpid>
  80185f:	8b 55 08             	mov    0x8(%ebp),%edx
  801862:	89 54 24 08          	mov    %edx,0x8(%esp)
  801866:	89 44 24 04          	mov    %eax,0x4(%esp)
  80186a:	c7 04 24 60 20 80 00 	movl   $0x802060,(%esp)
  801871:	e8 8f eb ff ff       	call   800405 <cprintf>

    while (times -- > 0) {
  801876:	e9 5c 01 00 00       	jmp    8019d7 <work+0x206>
        for (i = 0; i < size; i ++) {
  80187b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801882:	e9 b6 00 00 00       	jmp    80193d <work+0x16c>
            for (j = 0; j < size; j ++) {
  801887:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  80188e:	e9 9a 00 00 00       	jmp    80192d <work+0x15c>
                matc[i][j] = 0;
  ...
  8018a4:	c7 04 85 c0 33 80 00 	movl   $0x0,0x8033c0(,%eax,4)
  8018ab:	00 00 00 00 
                for (k = 0; k < size; k ++) {
  8018af:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  8018b6:	eb 69                	jmp    801921 <work+0x150>
  ...
  8018c9:	8b 0c 85 c0 33 80 00 	mov    0x8033c0(,%eax,4),%ecx
  ...
  8018e1:	8b 1c 85 80 30 80 00 	mov    0x803080(,%eax,4),%ebx
  8018e8:	8b 55 ec             	mov    -0x14(%ebp),%edx
  8018eb:	89 d0                	mov    %edx,%eax
  8018ed:	c1 e0 02             	shl    $0x2,%eax
  8018f0:	01 d0                	add    %edx,%eax
  8018f2:	01 c0                	add    %eax,%eax
  8018f4:	8b 55 f0             	mov    -0x10(%ebp),%edx
  8018f7:	01 d0                	add    %edx,%eax
  8018f9:	8b 04 85 20 32 80 00 	mov    0x803220(,%eax,4),%eax
  801900:	0f af c3             	imul   %ebx,%eax
  801903:	01 c1                	add    %eax,%ecx
  ...
  801916:	89 0c 85 c0 33 80 00 	mov    %ecx,0x8033c0(,%eax,4)
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
                matc[i][j] = 0;
                for (k = 0; k < size; k ++) {
  80191d:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  801921:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801924:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801927:	7c 8f                	jl     8018b8 <work+0xe7>
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  801929:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  80192d:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801930:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801933:	0f 8c 5a ff ff ff    	jl     801893 <work+0xc2>
    yield();
    ...
    while (times -- > 0) {
        for (i = 0; i < size; i ++) {
  801939:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80193d:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801940:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801943:	0f 8c 3e ff ff ff    	jl     801887 <work+0xb6>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
  ...
  801950:	eb 79                	jmp    8019cb <work+0x1fa>
            for (j = 0; j < size; j ++) {
  801952:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801959:	eb 64                	jmp    8019bf <work+0x1ee>
  ...
  80196c:	8b 0c 85 c0 33 80 00 	mov    0x8033c0(,%eax,4),%ecx
  ...
  801984:	89 0c 85 20 32 80 00 	mov    %ecx,0x803220(,%eax,4)
  ...
  8019b4:	89 0c 85 80 30 80 00 	mov    %ecx,0x803080(,%eax,4)
        ...
        for (i = 0; i < size; i ++) {
            for (j = 0; j < size; j ++) {
  8019bb:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
  8019bf:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8019c2:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8019c5:	7c 94                	jl     80195b <work+0x18a>
                for (k = 0; k < size; k ++) {
                    matc[i][j] += mata[i][k] * matb[k][j];
                }
            }
        ...
        for (i = 0; i < size; i ++) {
  8019c7:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  8019cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8019ce:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  8019d1:	0f 8c 7b ff ff ff    	jl     801952 <work+0x181>
  ...
  8019da:	8d 50 ff             	lea    -0x1(%eax),%edx
  8019dd:	89 55 08             	mov    %edx,0x8(%ebp)
  8019e0:	85 c0                	test   %eax,%eax
  8019e2:	0f 85 93 fe ff ff    	jne    80187b <work+0xaa>
            for (j = 0; j < size; j ++) {
                mata[i][j] = matb[i][j] = matc[i][j];
            }
        }
    ...
    cprintf("pid %d done!.\n", getpid());
  8019e8:	e8 5d ef ff ff       	call   80094a <getpid>
  8019ed:	89 44 24 04          	mov    %eax,0x4(%esp)
  8019f1:	c7 04 24 80 20 80 00 	movl   $0x802080,(%esp)
  8019f8:	e8 08 ea ff ff       	call   800405 <cprintf>
    exit(0);
  8019fd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801a04:	e8 bf ee ff ff       	call   8008c8 <exit>
...
int
main(void) {
  801a09:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  801a0d:	83 e4 f0             	and    $0xfffffff0,%esp
  801a10:	ff 71 fc             	pushl  -0x4(%ecx)
  801a13:	55                   	push   %ebp
  801a14:	89 e5                	mov    %esp,%ebp
  801a16:	56                   	push   %esi
  801a17:	53                   	push   %ebx
  801a18:	51                   	push   %ecx
  801a19:	83 ec 2c             	sub    $0x2c,%esp
  801a1c:	89 e0                	mov    %esp,%eax
  801a1e:	89 c3                	mov    %eax,%ebx
    int pids[total];
  801a20:	b8 15 00 00 00       	mov    $0x15,%eax
  801a25:	83 e8 01             	sub    $0x1,%eax
  801a28:	89 45 e0             	mov    %eax,-0x20(%ebp)
  801a2b:	b8 15 00 00 00       	mov    $0x15,%eax
  801a30:	c1 e0 02             	shl    $0x2,%eax
  801a33:	8d 50 03             	lea    0x3(%eax),%edx
  801a36:	b8 10 00 00 00       	mov    $0x10,%eax
  801a3b:	83 e8 01             	sub    $0x1,%eax
  801a3e:	01 d0                	add    %edx,%eax
  801a40:	be 10 00 00 00       	mov    $0x10,%esi
  801a45:	ba 00 00 00 00       	mov    $0x0,%edx
  801a4a:	f7 f6                	div    %esi
  801a4c:	6b c0 10             	imul   $0x10,%eax,%eax
  801a4f:	29 c4                	sub    %eax,%esp
  801a51:	8d 44 24 0c          	lea    0xc(%esp),%eax
  801a55:	83 c0 03             	add    $0x3,%eax
  801a58:	c1 e8 02             	shr    $0x2,%eax
  801a5b:	c1 e0 02             	shl    $0x2,%eax
  801a5e:	89 45 dc             	mov    %eax,-0x24(%ebp)
    memset(pids, 0, sizeof(pids));
  801a61:	b8 15 00 00 00       	mov    $0x15,%eax
  801a66:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801a6d:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801a70:	89 54 24 08          	mov    %edx,0x8(%esp)
  801a74:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801a7b:	00 
  801a7c:	89 04 24             	mov    %eax,(%esp)
  801a7f:	e8 c4 fb ff ff       	call   801648 <memset>

    int i;
    for (i = 0; i < total; i ++) {
  801a84:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801a8b:	eb 70                	jmp    801afd <main+0xf4>
        if ((pids[i] = fork()) == 0) {
  801a8d:	e8 55 ee ff ff       	call   8008e7 <fork>
  801a92:	8b 55 dc             	mov    -0x24(%ebp),%edx
  801a95:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  801a98:	89 04 8a             	mov    %eax,(%edx,%ecx,4)
  801a9b:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801a9e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801aa1:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801aa4:	85 c0                	test   %eax,%eax
  801aa6:	75 42                	jne    801aea <main+0xe1>
            srand(i * i);
  801aa8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801aab:	0f af 45 e4          	imul   -0x1c(%ebp),%eax
  801aaf:	89 04 24             	mov    %eax,(%esp)
  801ab2:	e8 23 f8 ff ff       	call   8012da <srand>
            int times = (((unsigned int)rand()) % total);
  801ab7:	e8 5e f7 ff ff       	call   80121a <rand>
  801abc:	ba 15 00 00 00       	mov    $0x15,%edx
  801ac1:	89 d1                	mov    %edx,%ecx
  801ac3:	ba 00 00 00 00       	mov    $0x0,%edx
  801ac8:	f7 f1                	div    %ecx
  801aca:	89 d0                	mov    %edx,%eax
  801acc:	89 45 d8             	mov    %eax,-0x28(%ebp)
            times = (times * times + 10) * 100;
  801acf:	8b 45 d8             	mov    -0x28(%ebp),%eax
  801ad2:	0f af 45 d8          	imul   -0x28(%ebp),%eax
  801ad6:	83 c0 0a             	add    $0xa,%eax
  801ad9:	6b c0 64             	imul   $0x64,%eax,%eax
  801adc:	89 45 d8             	mov    %eax,-0x28(%ebp)
            work(times);
  801adf:	8b 45 d8             	mov    -0x28(%ebp),%eax
  801ae2:	89 04 24             	mov    %eax,(%esp)
  801ae5:	e8 e7 fc ff ff       	call   8017d1 <work>
        }
        if (pids[i] < 0) {
  801aea:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801aed:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801af0:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801af3:	85 c0                	test   %eax,%eax
  801af5:	79 02                	jns    801af9 <main+0xf0>
            goto failed;
  801af7:	eb 5d                	jmp    801b56 <main+0x14d>
main(void) {
    int pids[total];
    memset(pids, 0, sizeof(pids));
    ...
    int i;
    for (i = 0; i < total; i ++) {
  801af9:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801afd:	b8 15 00 00 00       	mov    $0x15,%eax
  801b02:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801b05:	7c 86                	jl     801a8d <main+0x84>
        if (pids[i] < 0) {
            goto failed;
        }
    }
    ...
    cprintf("fork ok.\n");
  801b07:	c7 04 24 94 20 80 00 	movl   $0x802094,(%esp)
  801b0e:	e8 f2 e8 ff ff       	call   800405 <cprintf>

    for (i = 0; i < total; i ++) {
  801b13:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801b1a:	eb 1b                	jmp    801b37 <main+0x12e>
        if (wait() != 0) {
  801b1c:	e8 d3 ed ff ff       	call   8008f4 <wait>
  801b21:	85 c0                	test   %eax,%eax
  801b23:	74 0e                	je     801b33 <main+0x12a>
            cprintf("wait failed.\n");
  801b25:	c7 04 24 9e 20 80 00 	movl   $0x80209e,(%esp)
  801b2c:	e8 d4 e8 ff ff       	call   800405 <cprintf>
            goto failed;
  801b31:	eb 23                	jmp    801b56 <main+0x14d>
        }
    }
    ...
    for (i = 0; i < total; i ++) {
  801b33:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801b37:	b8 15 00 00 00       	mov    $0x15,%eax
  801b3c:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801b3f:	7c db                	jl     801b1c <main+0x113>
            cprintf("wait failed.\n");
            goto failed;
        }
    }
    ...
    cprintf("matrix pass.\n");
  801b41:	c7 04 24 ac 20 80 00 	movl   $0x8020ac,(%esp)
  801b48:	e8 b8 e8 ff ff       	call   800405 <cprintf>
    return 0;
  801b4d:	b8 00 00 00 00       	mov    $0x0,%eax
  801b52:	89 dc                	mov    %ebx,%esp
  801b54:	eb 51                	jmp    801ba7 <main+0x19e>

failed:
    for (i = 0; i < total; i ++) {
  801b56:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801b5d:	eb 22                	jmp    801b81 <main+0x178>
        if (pids[i] > 0) {
  801b5f:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b62:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801b65:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801b68:	85 c0                	test   %eax,%eax
  801b6a:	7e 11                	jle    801b7d <main+0x174>
            kill(pids[i]);
  801b6c:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b6f:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801b72:	8b 04 90             	mov    (%eax,%edx,4),%eax
  801b75:	89 04 24             	mov    %eax,(%esp)
  801b78:	e8 ba ed ff ff       	call   800937 <kill>
...
failed:
    for (i = 0; i < total; i ++) {
  801b7d:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  801b81:	b8 15 00 00 00       	mov    $0x15,%eax
  801b86:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801b89:	7c d4                	jl     801b5f <main+0x156>
        if (pids[i] > 0) {
            kill(pids[i]);
        }
    }
    panic("FAIL: T.T\n");
  801b8b:	c7 44 24 08 ba 20 80 	movl   $0x8020ba,0x8(%esp)
  801b92:	00 
  801b93:	c7 44 24 04 52 00 00 	movl   $0x52,0x4(%esp)
  801b9a:	00 
  801b9b:	c7 04 24 c5 20 80 00 	movl   $0x8020c5,(%esp)
  801ba2:	e8 6d e7 ff ff       	call   800314 <__panic>
}
  ...
  801bac:	5e                   	pop    %esi
  801bad:	5d                   	pop    %ebp
  801bae:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801bb1:	c3                   	ret    
