...
open(const char *path, uint32_t open_flags) {
  ...
  80011a:	c7 04 24 e0 18 80 00 	movl   $0x8018e0,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80028e:	c7 04 24 f0 18 80 00 	movl   $0x8018f0,(%esp)
  ...
  8002ac:	c7 04 24 fb 18 80 00 	movl   $0x8018fb,(%esp)
  ...
  8002c2:	c7 04 24 0d 19 80 00 	movl   $0x80190d,(%esp)
  ...
  8002d8:	c7 04 24 20 19 80 00 	movl   $0x801920,(%esp)
  ...
  8002ee:	c7 04 24 33 19 80 00 	movl   $0x801933,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80032e:	c7 04 24 46 19 80 00 	movl   $0x801946,(%esp)
  ...
  800347:	e8 7e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80034c:	c7 04 24 60 19 80 00 	movl   $0x801960,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80037e:	c7 04 24 62 19 80 00 	movl   $0x801962,(%esp)
  ...
  800397:	e8 2e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80039c:	c7 04 24 60 19 80 00 	movl   $0x801960,(%esp)
...
exit(int error_code) {
  ...
  8008d9:	c7 04 24 7e 19 80 00 	movl   $0x80197e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a45:	00 
  800a46:	c7 44 24 04 91 19 80 	movl   $0x801991,0x4(%esp)
  800a4d:	00 
  ...
  800a6a:	c7 44 24 08 98 19 80 	movl   $0x801998,0x8(%esp)
  800a71:	00 
  800a72:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a79:	00 
  800a7a:	c7 04 24 b2 19 80 00 	movl   $0x8019b2,(%esp)
  800a81:	e8 de f8 ff ff       	call   800364 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a86:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a8d:	00 
  800a8e:	c7 44 24 04 c4 19 80 	movl   $0x8019c4,0x4(%esp)
  800a95:	00 
  ...
  800ab2:	c7 44 24 08 cc 19 80 	movl   $0x8019cc,0x8(%esp)
  800ab9:	00 
  800aba:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800ac1:	00 
  800ac2:	c7 04 24 b2 19 80 00 	movl   $0x8019b2,(%esp)
  ...
  800adb:	e8 45 0d 00 00       	call   801825 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c0a:	05 04 1c 80 00       	add    $0x801c04,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d6e:	8b 04 85 28 1c 80 00 	mov    0x801c28(,%eax,4),%eax
  ...
  800e87:	c7 44 24 0c 1e 1c 80 	movl   $0x801c1e,0xc(%esp)
  800e8e:	00 
  ...
  800eba:	75 05                	jne    800ec1 <vprintfmt+0x1c9>
                p = "(null)";
  800ebc:	be 21 1c 80 00       	mov    $0x801c21,%esi
            }
            if (width > 0 && padc != '-') {
...
sleepy(int pid) {
  ...
  8017d4:	83 ec 28             	sub    $0x28,%esp
    int i, time = 100;
  8017d7:	c7 45 f0 64 00 00 00 	movl   $0x64,-0x10(%ebp)
    for (i = 0; i < 10; i ++) {
  8017de:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  8017e5:	eb 2c                	jmp    801813 <sleepy+0x42>
        sleep(time);
  8017e7:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8017ea:	89 04 24             	mov    %eax,(%esp)
  8017ed:	e8 85 f1 ff ff       	call   800977 <sleep>
  ...
  8017ff:	89 54 24 04          	mov    %edx,0x4(%esp)
  801803:	c7 04 24 80 1d 80 00 	movl   $0x801d80,(%esp)
  80180a:	e8 f6 eb ff ff       	call   800405 <cprintf>
#include <ulib.h>
...
sleepy(int pid) {
    int i, time = 100;
    for (i = 0; i < 10; i ++) {
  80180f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801813:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  801817:	7e ce                	jle    8017e7 <sleepy+0x16>
        sleep(time);
        cprintf("sleep %d x %d slices.\n", i + 1, time);
    }
    exit(0);
  801819:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801820:	e8 a3 f0 ff ff       	call   8008c8 <exit>
...
main(void) {
  ...
  801828:	83 e4 f0             	and    $0xfffffff0,%esp
  80182b:	83 ec 20             	sub    $0x20,%esp
    unsigned int time = gettime_msec();
  80182e:	e8 57 f1 ff ff       	call   80098a <gettime_msec>
  801833:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  801837:	e8 ab f0 ff ff       	call   8008e7 <fork>
  80183c:	89 44 24 18          	mov    %eax,0x18(%esp)
  801840:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801845:	75 0c                	jne    801853 <main+0x2e>
        sleepy(pid1);
  801847:	8b 44 24 18          	mov    0x18(%esp),%eax
  80184b:	89 04 24             	mov    %eax,(%esp)
  80184e:	e8 7e ff ff ff       	call   8017d1 <sleepy>
    }
    
    assert(waitpid(pid1, &exit_code) == 0 && exit_code == 0);
  801853:	8d 44 24 14          	lea    0x14(%esp),%eax
  801857:	89 44 24 04          	mov    %eax,0x4(%esp)
  80185b:	8b 44 24 18          	mov    0x18(%esp),%eax
  80185f:	89 04 24             	mov    %eax,(%esp)
  801862:	e8 a9 f0 ff ff       	call   800910 <waitpid>
  801867:	85 c0                	test   %eax,%eax
  801869:	75 08                	jne    801873 <main+0x4e>
  80186b:	8b 44 24 14          	mov    0x14(%esp),%eax
  80186f:	85 c0                	test   %eax,%eax
  801871:	74 24                	je     801897 <main+0x72>
  801873:	c7 44 24 0c 98 1d 80 	movl   $0x801d98,0xc(%esp)
  80187a:	00 
  80187b:	c7 44 24 08 c9 1d 80 	movl   $0x801dc9,0x8(%esp)
  801882:	00 
  801883:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  80188a:	00 
  80188b:	c7 04 24 de 1d 80 00 	movl   $0x801dde,(%esp)
  801892:	e8 7d ea ff ff       	call   800314 <__panic>
    cprintf("use %04d msecs.\n", gettime_msec() - time);
  801897:	e8 ee f0 ff ff       	call   80098a <gettime_msec>
  80189c:	2b 44 24 1c          	sub    0x1c(%esp),%eax
  8018a0:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018a4:	c7 04 24 eb 1d 80 00 	movl   $0x801deb,(%esp)
  8018ab:	e8 55 eb ff ff       	call   800405 <cprintf>
    cprintf("sleep pass.\n");
  8018b0:	c7 04 24 fc 1d 80 00 	movl   $0x801dfc,(%esp)
  8018b7:	e8 49 eb ff ff       	call   800405 <cprintf>
    return 0;
