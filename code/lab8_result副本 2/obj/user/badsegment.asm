...
open(const char *path, uint32_t open_flags) {
  ...
  80011a:	c7 04 24 00 18 80 00 	movl   $0x801800,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80028e:	c7 04 24 10 18 80 00 	movl   $0x801810,(%esp)
  ...
  8002ac:	c7 04 24 1b 18 80 00 	movl   $0x80181b,(%esp)
  ...
  8002c2:	c7 04 24 2d 18 80 00 	movl   $0x80182d,(%esp)
  ...
  8002d8:	c7 04 24 40 18 80 00 	movl   $0x801840,(%esp)
  ...
  8002ee:	c7 04 24 53 18 80 00 	movl   $0x801853,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80032e:	c7 04 24 66 18 80 00 	movl   $0x801866,(%esp)
  ...
  800347:	e8 7e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80034c:	c7 04 24 80 18 80 00 	movl   $0x801880,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80037e:	c7 04 24 82 18 80 00 	movl   $0x801882,(%esp)
  ...
  800397:	e8 2e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80039c:	c7 04 24 80 18 80 00 	movl   $0x801880,(%esp)
...
exit(int error_code) {
  ...
  8008d9:	c7 04 24 9e 18 80 00 	movl   $0x80189e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a45:	00 
  800a46:	c7 44 24 04 b1 18 80 	movl   $0x8018b1,0x4(%esp)
  800a4d:	00 
  ...
  800a6a:	c7 44 24 08 b8 18 80 	movl   $0x8018b8,0x8(%esp)
  800a71:	00 
  800a72:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a79:	00 
  800a7a:	c7 04 24 d2 18 80 00 	movl   $0x8018d2,(%esp)
  800a81:	e8 de f8 ff ff       	call   800364 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a86:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a8d:	00 
  800a8e:	c7 44 24 04 e4 18 80 	movl   $0x8018e4,0x4(%esp)
  800a95:	00 
  ...
  800ab2:	c7 44 24 08 ec 18 80 	movl   $0x8018ec,0x8(%esp)
  800ab9:	00 
  800aba:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800ac1:	00 
  800ac2:	c7 04 24 d2 18 80 00 	movl   $0x8018d2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c0a:	05 24 1b 80 00       	add    $0x801b24,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d6e:	8b 04 85 48 1b 80 00 	mov    0x801b48(,%eax,4),%eax
  ...
  800e87:	c7 44 24 0c 3e 1b 80 	movl   $0x801b3e,0xc(%esp)
  800e8e:	00 
  ...
  800eba:	75 05                	jne    800ec1 <vprintfmt+0x1c9>
                p = "(null)";
  800ebc:	be 41 1b 80 00       	mov    $0x801b41,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017da:	66 b8 28 00          	mov    $0x28,%ax
  8017de:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  8017e0:	c7 44 24 08 a0 1c 80 	movl   $0x801ca0,0x8(%esp)
  8017e7:	00 
  8017e8:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  8017ef:	00 
  8017f0:	c7 04 24 ab 1c 80 00 	movl   $0x801cab,(%esp)
  8017f7:	e8 18 eb ff ff       	call   800314 <__panic>
