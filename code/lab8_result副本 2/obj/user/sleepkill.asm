...
open(const char *path, uint32_t open_flags) {
  ...
  80011a:	c7 04 24 80 18 80 00 	movl   $0x801880,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80028e:	c7 04 24 90 18 80 00 	movl   $0x801890,(%esp)
  ...
  8002ac:	c7 04 24 9b 18 80 00 	movl   $0x80189b,(%esp)
  ...
  8002c2:	c7 04 24 ad 18 80 00 	movl   $0x8018ad,(%esp)
  ...
  8002d8:	c7 04 24 c0 18 80 00 	movl   $0x8018c0,(%esp)
  ...
  8002ee:	c7 04 24 d3 18 80 00 	movl   $0x8018d3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80032e:	c7 04 24 e6 18 80 00 	movl   $0x8018e6,(%esp)
  ...
  800347:	e8 7e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80034c:	c7 04 24 00 19 80 00 	movl   $0x801900,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80037e:	c7 04 24 02 19 80 00 	movl   $0x801902,(%esp)
  ...
  800397:	e8 2e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80039c:	c7 04 24 00 19 80 00 	movl   $0x801900,(%esp)
...
exit(int error_code) {
  ...
  8008d9:	c7 04 24 1e 19 80 00 	movl   $0x80191e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a45:	00 
  800a46:	c7 44 24 04 31 19 80 	movl   $0x801931,0x4(%esp)
  800a4d:	00 
  ...
  800a6a:	c7 44 24 08 38 19 80 	movl   $0x801938,0x8(%esp)
  800a71:	00 
  800a72:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a79:	00 
  800a7a:	c7 04 24 52 19 80 00 	movl   $0x801952,(%esp)
  800a81:	e8 de f8 ff ff       	call   800364 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a86:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a8d:	00 
  800a8e:	c7 44 24 04 64 19 80 	movl   $0x801964,0x4(%esp)
  800a95:	00 
  ...
  800ab2:	c7 44 24 08 6c 19 80 	movl   $0x80196c,0x8(%esp)
  800ab9:	00 
  800aba:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800ac1:	00 
  800ac2:	c7 04 24 52 19 80 00 	movl   $0x801952,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c0a:	05 a4 1b 80 00       	add    $0x801ba4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d6e:	8b 04 85 c8 1b 80 00 	mov    0x801bc8(,%eax,4),%eax
  ...
  800e87:	c7 44 24 0c be 1b 80 	movl   $0x801bbe,0xc(%esp)
  800e8e:	00 
  ...
  800eba:	75 05                	jne    800ec1 <vprintfmt+0x1c9>
                p = "(null)";
  800ebc:	be c1 1b 80 00       	mov    $0x801bc1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017df:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  8017e3:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8017e8:	75 18                	jne    801802 <main+0x31>
        sleep(~0);
  8017ea:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  8017f1:	e8 81 f1 ff ff       	call   800977 <sleep>
        exit(0xdead);
  8017f6:	c7 04 24 ad de 00 00 	movl   $0xdead,(%esp)
  8017fd:	e8 c6 f0 ff ff       	call   8008c8 <exit>
    }
    assert(pid > 0);
  801802:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801807:	7f 24                	jg     80182d <main+0x5c>
  801809:	c7 44 24 0c 20 1d 80 	movl   $0x801d20,0xc(%esp)
  801810:	00 
  801811:	c7 44 24 08 28 1d 80 	movl   $0x801d28,0x8(%esp)
  801818:	00 
  801819:	c7 44 24 04 0b 00 00 	movl   $0xb,0x4(%esp)
  801820:	00 
  801821:	c7 04 24 3d 1d 80 00 	movl   $0x801d3d,(%esp)
  801828:	e8 e7 ea ff ff       	call   800314 <__panic>

    sleep(100);
  80182d:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  801834:	e8 3e f1 ff ff       	call   800977 <sleep>
    assert(kill(pid) == 0);
  801839:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80183d:	89 04 24             	mov    %eax,(%esp)
  801840:	e8 f2 f0 ff ff       	call   800937 <kill>
  801845:	85 c0                	test   %eax,%eax
  801847:	74 24                	je     80186d <main+0x9c>
  801849:	c7 44 24 0c 4e 1d 80 	movl   $0x801d4e,0xc(%esp)
  801850:	00 
  801851:	c7 44 24 08 28 1d 80 	movl   $0x801d28,0x8(%esp)
  801858:	00 
  801859:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801860:	00 
  801861:	c7 04 24 3d 1d 80 00 	movl   $0x801d3d,(%esp)
  801868:	e8 a7 ea ff ff       	call   800314 <__panic>
    cprintf("sleepkill pass.\n");
  80186d:	c7 04 24 5d 1d 80 00 	movl   $0x801d5d,(%esp)
  801874:	e8 8c eb ff ff       	call   800405 <cprintf>
    return 0;
