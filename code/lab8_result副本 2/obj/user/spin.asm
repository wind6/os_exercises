...
main(void) {
  ...
  8017da:	c7 04 24 c0 1d 80 00 	movl   $0x801dc0,(%esp)
  ...
  8017f4:	75 0e                	jne    801804 <main+0x33>
        cprintf("I am the child. spinning ...\n");
  8017f6:	c7 04 24 e7 1d 80 00 	movl   $0x801de7,(%esp)
  8017fd:	e8 03 ec ff ff       	call   800405 <cprintf>
        while (1);
  801802:	eb fe                	jmp    801802 <main+0x31>
    }else if (pid<0) {
  801804:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801809:	79 1c                	jns    801827 <main+0x56>
        panic("fork child error\n");
  80180b:	c7 44 24 08 05 1e 80 	movl   $0x801e05,0x8(%esp)
  801812:	00 
  801813:	c7 44 24 04 0d 00 00 	movl   $0xd,0x4(%esp)
  80181a:	00 
  80181b:	c7 04 24 17 1e 80 00 	movl   $0x801e17,(%esp)
  801822:	e8 ed ea ff ff       	call   800314 <__panic>
    }
    cprintf("I am the parent. Running the child...\n");
  801827:	c7 04 24 24 1e 80 00 	movl   $0x801e24,(%esp)
  80182e:	e8 d2 eb ff ff       	call   800405 <cprintf>

    yield();
  801833:	e8 f2 f0 ff ff       	call   80092a <yield>
    yield();
  801838:	e8 ed f0 ff ff       	call   80092a <yield>
    yield();
  80183d:	e8 e8 f0 ff ff       	call   80092a <yield>
    
    cprintf("I am the parent.  Killing the child...\n");
  801842:	c7 04 24 4c 1e 80 00 	movl   $0x801e4c,(%esp)
  801849:	e8 b7 eb ff ff       	call   800405 <cprintf>

    assert((ret = kill(pid)) == 0);
  80184e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801852:	89 04 24             	mov    %eax,(%esp)
  801855:	e8 dd f0 ff ff       	call   800937 <kill>
  80185a:	89 44 24 18          	mov    %eax,0x18(%esp)
  80185e:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801863:	74 24                	je     801889 <main+0xb8>
  801865:	c7 44 24 0c 74 1e 80 	movl   $0x801e74,0xc(%esp)
  80186c:	00 
  80186d:	c7 44 24 08 8b 1e 80 	movl   $0x801e8b,0x8(%esp)
  801874:	00 
  801875:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  80187c:	00 
  80187d:	c7 04 24 17 1e 80 00 	movl   $0x801e17,(%esp)
  801884:	e8 8b ea ff ff       	call   800314 <__panic>
    cprintf("kill returns %d\n", ret);
  801889:	8b 44 24 18          	mov    0x18(%esp),%eax
  80188d:	89 44 24 04          	mov    %eax,0x4(%esp)
  801891:	c7 04 24 a0 1e 80 00 	movl   $0x801ea0,(%esp)
  801898:	e8 68 eb ff ff       	call   800405 <cprintf>

    assert((ret = waitpid(pid, NULL)) == 0);
  80189d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8018a4:	00 
  8018a5:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018a9:	89 04 24             	mov    %eax,(%esp)
  8018ac:	e8 5f f0 ff ff       	call   800910 <waitpid>
  8018b1:	89 44 24 18          	mov    %eax,0x18(%esp)
  8018b5:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8018ba:	74 24                	je     8018e0 <main+0x10f>
  8018bc:	c7 44 24 0c b4 1e 80 	movl   $0x801eb4,0xc(%esp)
  8018c3:	00 
  8018c4:	c7 44 24 08 8b 1e 80 	movl   $0x801e8b,0x8(%esp)
  8018cb:	00 
  8018cc:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  8018d3:	00 
  8018d4:	c7 04 24 17 1e 80 00 	movl   $0x801e17,(%esp)
  8018db:	e8 34 ea ff ff       	call   800314 <__panic>
    cprintf("wait returns %d\n", ret);
  8018e0:	8b 44 24 18          	mov    0x18(%esp),%eax
  8018e4:	89 44 24 04          	mov    %eax,0x4(%esp)
  8018e8:	c7 04 24 d4 1e 80 00 	movl   $0x801ed4,(%esp)
  8018ef:	e8 11 eb ff ff       	call   800405 <cprintf>

    cprintf("spin may pass.\n");
  8018f4:	c7 04 24 e5 1e 80 00 	movl   $0x801ee5,(%esp)
  8018fb:	e8 05 eb ff ff       	call   800405 <cprintf>
    return 0;
