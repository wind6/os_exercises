...
open(const char *path, uint32_t open_flags) {
  ...
  80011a:	c7 04 24 60 18 80 00 	movl   $0x801860,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80028e:	c7 04 24 70 18 80 00 	movl   $0x801870,(%esp)
  ...
  8002ac:	c7 04 24 7b 18 80 00 	movl   $0x80187b,(%esp)
  ...
  8002c2:	c7 04 24 8d 18 80 00 	movl   $0x80188d,(%esp)
  ...
  8002d8:	c7 04 24 a0 18 80 00 	movl   $0x8018a0,(%esp)
  ...
  8002ee:	c7 04 24 b3 18 80 00 	movl   $0x8018b3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80032e:	c7 04 24 c6 18 80 00 	movl   $0x8018c6,(%esp)
  ...
  800347:	e8 7e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80034c:	c7 04 24 e0 18 80 00 	movl   $0x8018e0,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80037e:	c7 04 24 e2 18 80 00 	movl   $0x8018e2,(%esp)
  ...
  800397:	e8 2e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80039c:	c7 04 24 e0 18 80 00 	movl   $0x8018e0,(%esp)
...
exit(int error_code) {
  ...
  8008d9:	c7 04 24 fe 18 80 00 	movl   $0x8018fe,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a45:	00 
  800a46:	c7 44 24 04 11 19 80 	movl   $0x801911,0x4(%esp)
  800a4d:	00 
  ...
  800a6a:	c7 44 24 08 18 19 80 	movl   $0x801918,0x8(%esp)
  800a71:	00 
  800a72:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a79:	00 
  800a7a:	c7 04 24 32 19 80 00 	movl   $0x801932,(%esp)
  800a81:	e8 de f8 ff ff       	call   800364 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a86:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a8d:	00 
  800a8e:	c7 44 24 04 44 19 80 	movl   $0x801944,0x4(%esp)
  800a95:	00 
  ...
  800ab2:	c7 44 24 08 4c 19 80 	movl   $0x80194c,0x8(%esp)
  800ab9:	00 
  800aba:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800ac1:	00 
  800ac2:	c7 04 24 32 19 80 00 	movl   $0x801932,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c0a:	05 84 1b 80 00       	add    $0x801b84,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d6e:	8b 04 85 a8 1b 80 00 	mov    0x801ba8(,%eax,4),%eax
  ...
  800e87:	c7 44 24 0c 9e 1b 80 	movl   $0x801b9e,0xc(%esp)
  800e8e:	00 
  ...
  800eba:	75 05                	jne    800ec1 <vprintfmt+0x1c9>
                p = "(null)";
  800ebc:	be a1 1b 80 00       	mov    $0x801ba1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  8017da:	e8 6b f1 ff ff       	call   80094a <getpid>
  8017df:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017e3:	c7 04 24 00 1d 80 00 	movl   $0x801d00,(%esp)
  8017ea:	e8 16 ec ff ff       	call   800405 <cprintf>
    for (i = 0; i < 5; i ++) {
  8017ef:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8017f6:	00 
  8017f7:	eb 27                	jmp    801820 <main+0x4f>
        yield();
  8017f9:	e8 2c f1 ff ff       	call   80092a <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  8017fe:	e8 47 f1 ff ff       	call   80094a <getpid>
  801803:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801807:	89 54 24 08          	mov    %edx,0x8(%esp)
  80180b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80180f:	c7 04 24 1c 1d 80 00 	movl   $0x801d1c,(%esp)
  801816:	e8 ea eb ff ff       	call   800405 <cprintf>
...
main(void) {
    ...
    cprintf("Hello, I am process %d.\n", getpid());
    for (i = 0; i < 5; i ++) {
  80181b:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801820:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801825:	7e d2                	jle    8017f9 <main+0x28>
        yield();
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
    }
    cprintf("All done in process %d.\n", getpid());
  801827:	e8 1e f1 ff ff       	call   80094a <getpid>
  80182c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801830:	c7 04 24 3f 1d 80 00 	movl   $0x801d3f,(%esp)
  801837:	e8 c9 eb ff ff       	call   800405 <cprintf>
    cprintf("yield pass.\n");
  80183c:	c7 04 24 58 1d 80 00 	movl   $0x801d58,(%esp)
  801843:	e8 bd eb ff ff       	call   800405 <cprintf>
    return 0;
