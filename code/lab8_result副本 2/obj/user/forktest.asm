...
main(void) {
  ...
  8017da:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8017e1:	00 
  8017e2:	eb 60                	jmp    801844 <main+0x73>
        if ((pid = fork()) == 0) {
  8017e4:	e8 fe f0 ff ff       	call   8008e7 <fork>
  8017e9:	89 44 24 18          	mov    %eax,0x18(%esp)
  8017ed:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8017f2:	75 20                	jne    801814 <main+0x43>
            cprintf("I am child %d\n", n);
  8017f4:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8017f8:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017fc:	c7 04 24 a4 1d 80 00 	movl   $0x801da4,(%esp)
  801803:	e8 fd eb ff ff       	call   800405 <cprintf>
            exit(0);
  801808:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80180f:	e8 b4 f0 ff ff       	call   8008c8 <exit>
        }
        assert(pid > 0);
  801814:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801819:	7f 24                	jg     80183f <main+0x6e>
  80181b:	c7 44 24 0c b3 1d 80 	movl   $0x801db3,0xc(%esp)
  801822:	00 
  801823:	c7 44 24 08 bb 1d 80 	movl   $0x801dbb,0x8(%esp)
  80182a:	00 
  80182b:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801832:	00 
  801833:	c7 04 24 d0 1d 80 00 	movl   $0x801dd0,(%esp)
  80183a:	e8 d5 ea ff ff       	call   800314 <__panic>
const int max_child = 32;
...
main(void) {
    int n, pid;
    for (n = 0; n < max_child; n ++) {
  80183f:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801844:	b8 20 00 00 00       	mov    $0x20,%eax
  801849:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  80184d:	7c 95                	jl     8017e4 <main+0x13>
            exit(0);
        }
        assert(pid > 0);
    }
    ...
    if (n > max_child) {
  80184f:	b8 20 00 00 00       	mov    $0x20,%eax
  801854:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  801858:	7e 24                	jle    80187e <main+0xad>
        panic("fork claimed to work %d times!\n", n);
  80185a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80185e:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801862:	c7 44 24 08 e0 1d 80 	movl   $0x801de0,0x8(%esp)
  801869:	00 
  80186a:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  801871:	00 
  801872:	c7 04 24 d0 1d 80 00 	movl   $0x801dd0,(%esp)
  801879:	e8 96 ea ff ff       	call   800314 <__panic>
    }

    for (; n > 0; n --) {
  80187e:	eb 2a                	jmp    8018aa <main+0xd9>
        if (wait() != 0) {
  801880:	e8 6f f0 ff ff       	call   8008f4 <wait>
  801885:	85 c0                	test   %eax,%eax
  801887:	74 1c                	je     8018a5 <main+0xd4>
            panic("wait stopped early\n");
  801889:	c7 44 24 08 00 1e 80 	movl   $0x801e00,0x8(%esp)
  801890:	00 
  801891:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  801898:	00 
  801899:	c7 04 24 d0 1d 80 00 	movl   $0x801dd0,(%esp)
  8018a0:	e8 6f ea ff ff       	call   800314 <__panic>
    ...
    for (; n > 0; n --) {
  8018a5:	83 6c 24 1c 01       	subl   $0x1,0x1c(%esp)
  8018aa:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8018af:	7f cf                	jg     801880 <main+0xaf>
        if (wait() != 0) {
            panic("wait stopped early\n");
        }
    }
    ...
    if (wait() == 0) {
  8018b1:	e8 3e f0 ff ff       	call   8008f4 <wait>
  8018b6:	85 c0                	test   %eax,%eax
  8018b8:	75 1c                	jne    8018d6 <main+0x105>
        panic("wait got too many\n");
  8018ba:	c7 44 24 08 14 1e 80 	movl   $0x801e14,0x8(%esp)
  8018c1:	00 
  8018c2:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  8018c9:	00 
  8018ca:	c7 04 24 d0 1d 80 00 	movl   $0x801dd0,(%esp)
  8018d1:	e8 3e ea ff ff       	call   800314 <__panic>
    }

    cprintf("forktest pass.\n");
  8018d6:	c7 04 24 27 1e 80 00 	movl   $0x801e27,(%esp)
  8018dd:	e8 23 eb ff ff       	call   800405 <cprintf>
    return 0;
