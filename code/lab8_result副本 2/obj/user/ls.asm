...
open(const char *path, uint32_t open_flags) {
  ...
  8000fb:	83 ec 18             	sub    $0x18,%esp
    openstep = 0;
  8000fe:	c7 05 44 30 80 00 00 	movl   $0x0,0x803044
  800105:	00 00 00 
    cprintf("%d [user_open]\n", openstep++);
  800108:	a1 44 30 80 00       	mov    0x803044,%eax
  80010d:	8d 50 01             	lea    0x1(%eax),%edx
  800110:	89 15 44 30 80 00    	mov    %edx,0x803044
  800116:	89 44 24 04          	mov    %eax,0x4(%esp)
  80011a:	c7 04 24 80 1b 80 00 	movl   $0x801b80,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80028e:	c7 04 24 90 1b 80 00 	movl   $0x801b90,(%esp)
  ...
  8002ac:	c7 04 24 9b 1b 80 00 	movl   $0x801b9b,(%esp)
  ...
  8002c2:	c7 04 24 ad 1b 80 00 	movl   $0x801bad,(%esp)
  ...
  8002d8:	c7 04 24 c0 1b 80 00 	movl   $0x801bc0,(%esp)
  ...
  8002ee:	c7 04 24 d3 1b 80 00 	movl   $0x801bd3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80032e:	c7 04 24 e6 1b 80 00 	movl   $0x801be6,(%esp)
  ...
  800347:	e8 7e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80034c:	c7 04 24 00 1c 80 00 	movl   $0x801c00,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80037e:	c7 04 24 02 1c 80 00 	movl   $0x801c02,(%esp)
  ...
  800397:	e8 2e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80039c:	c7 04 24 00 1c 80 00 	movl   $0x801c00,(%esp)
...
lock_fork(void) {
  ...
  8008a3:	83 ec 18             	sub    $0x18,%esp
    lock(&fork_lock);
  8008a6:	c7 04 24 58 30 80 00 	movl   $0x803058,(%esp)
...
unlock_fork(void) {
  ...
  8008b7:	83 ec 04             	sub    $0x4,%esp
    unlock(&fork_lock);
  8008ba:	c7 04 24 58 30 80 00 	movl   $0x803058,(%esp)
...
exit(int error_code) {
  ...
  8008d9:	c7 04 24 1e 1c 80 00 	movl   $0x801c1e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a45:	00 
  800a46:	c7 44 24 04 31 1c 80 	movl   $0x801c31,0x4(%esp)
  800a4d:	00 
  ...
  800a6a:	c7 44 24 08 38 1c 80 	movl   $0x801c38,0x8(%esp)
  800a71:	00 
  800a72:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a79:	00 
  800a7a:	c7 04 24 52 1c 80 00 	movl   $0x801c52,(%esp)
  800a81:	e8 de f8 ff ff       	call   800364 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a86:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a8d:	00 
  800a8e:	c7 44 24 04 64 1c 80 	movl   $0x801c64,0x4(%esp)
  800a95:	00 
  ...
  800ab2:	c7 44 24 08 6c 1c 80 	movl   $0x801c6c,0x8(%esp)
  800ab9:	00 
  800aba:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800ac1:	00 
  800ac2:	c7 04 24 52 1c 80 00 	movl   $0x801c52,(%esp)
  ...
  800adb:	e8 37 10 00 00       	call   801b17 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c0a:	05 a4 1e 80 00       	add    $0x801ea4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d6e:	8b 04 85 c8 1e 80 00 	mov    0x801ec8(,%eax,4),%eax
  ...
  800e87:	c7 44 24 0c be 1e 80 	movl   $0x801ebe,0xc(%esp)
  800e8e:	00 
  ...
  800eba:	75 05                	jne    800ec1 <vprintfmt+0x1c9>
                p = "(null)";
  800ebc:	be c1 1e 80 00       	mov    $0x801ec1,%esi
            }
            if (width > 0 && padc != '-') {
...
getmode(uint32_t st_mode) {
  ...
  8017d4:	83 ec 10             	sub    $0x10,%esp
    char mode = '?';
  8017d7:	c6 45 ff 3f          	movb   $0x3f,-0x1(%ebp)
    if (S_ISREG(st_mode)) mode = '-';
  8017db:	8b 45 08             	mov    0x8(%ebp),%eax
  8017de:	25 00 70 00 00       	and    $0x7000,%eax
  8017e3:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8017e8:	75 04                	jne    8017ee <getmode+0x1d>
  8017ea:	c6 45 ff 2d          	movb   $0x2d,-0x1(%ebp)
    if (S_ISDIR(st_mode)) mode = 'd';
  8017ee:	8b 45 08             	mov    0x8(%ebp),%eax
  8017f1:	25 00 70 00 00       	and    $0x7000,%eax
  8017f6:	3d 00 20 00 00       	cmp    $0x2000,%eax
  8017fb:	75 04                	jne    801801 <getmode+0x30>
  8017fd:	c6 45 ff 64          	movb   $0x64,-0x1(%ebp)
    if (S_ISLNK(st_mode)) mode = 'l';
  801801:	8b 45 08             	mov    0x8(%ebp),%eax
  801804:	25 00 70 00 00       	and    $0x7000,%eax
  801809:	3d 00 30 00 00       	cmp    $0x3000,%eax
  80180e:	75 04                	jne    801814 <getmode+0x43>
  801810:	c6 45 ff 6c          	movb   $0x6c,-0x1(%ebp)
    if (S_ISCHR(st_mode)) mode = 'c';
  801814:	8b 45 08             	mov    0x8(%ebp),%eax
  801817:	25 00 70 00 00       	and    $0x7000,%eax
  80181c:	3d 00 40 00 00       	cmp    $0x4000,%eax
  801821:	75 04                	jne    801827 <getmode+0x56>
  801823:	c6 45 ff 63          	movb   $0x63,-0x1(%ebp)
    if (S_ISBLK(st_mode)) mode = 'b';
  801827:	8b 45 08             	mov    0x8(%ebp),%eax
  80182a:	25 00 70 00 00       	and    $0x7000,%eax
  80182f:	3d 00 50 00 00       	cmp    $0x5000,%eax
  801834:	75 04                	jne    80183a <getmode+0x69>
  801836:	c6 45 ff 62          	movb   $0x62,-0x1(%ebp)
    return mode;
  80183a:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
  80183e:	c9                   	leave  
  80183f:	c3                   	ret    
...
getstat(const char *name, struct stat *stat) {
  ...
  801854:	e8 9f e8 ff ff       	call   8000f8 <open>
  801859:	89 45 f4             	mov    %eax,-0xc(%ebp)
  80185c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801860:	79 05                	jns    801867 <getstat+0x27>
        return fd;
  801862:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801865:	eb 23                	jmp    80188a <getstat+0x4a>
    }
    ret = fstat(fd, stat);
...
lsstat(struct stat *stat, const char *filename) {
  ...
  80189a:	e8 32 ff ff ff       	call   8017d1 <getmode>
  80189f:	0f be c0             	movsbl %al,%eax
  8018a2:	89 44 24 08          	mov    %eax,0x8(%esp)
  8018a6:	c7 44 24 04 20 20 80 	movl   $0x802020,0x4(%esp)
  8018ad:	00 
  8018ae:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8018b5:	e8 2f ec ff ff       	call   8004e9 <fprintf>
    printf(" %3d(h)", stat->st_nlinks);
  8018ba:	8b 45 08             	mov    0x8(%ebp),%eax
  8018bd:	8b 40 04             	mov    0x4(%eax),%eax
  8018c0:	89 44 24 08          	mov    %eax,0x8(%esp)
  8018c4:	c7 44 24 04 28 20 80 	movl   $0x802028,0x4(%esp)
  8018cb:	00 
  8018cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8018d3:	e8 11 ec ff ff       	call   8004e9 <fprintf>
  ...
  8018e2:	c7 44 24 04 30 20 80 	movl   $0x802030,0x4(%esp)
  8018e9:	00 
  8018ea:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8018f1:	e8 f3 eb ff ff       	call   8004e9 <fprintf>
    printf(" %8d(s)", stat->st_size);
  8018f6:	8b 45 08             	mov    0x8(%ebp),%eax
  8018f9:	8b 40 0c             	mov    0xc(%eax),%eax
  8018fc:	89 44 24 08          	mov    %eax,0x8(%esp)
  801900:	c7 44 24 04 38 20 80 	movl   $0x802038,0x4(%esp)
  801907:	00 
  801908:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  80190f:	e8 d5 eb ff ff       	call   8004e9 <fprintf>
    printf("   %s\n", filename);
  801914:	8b 45 0c             	mov    0xc(%ebp),%eax
  801917:	89 44 24 08          	mov    %eax,0x8(%esp)
  80191b:	c7 44 24 04 40 20 80 	movl   $0x802040,0x4(%esp)
  801922:	00 
  801923:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  80192a:	e8 ba eb ff ff       	call   8004e9 <fprintf>
}
  80192f:	c9                   	leave  
  801930:	c3                   	ret    
...
lsdir(const char *path) {
  ...
  801934:	83 ec 38             	sub    $0x38,%esp
    struct stat __stat, *stat = &__stat;
  801937:	8d 45 d8             	lea    -0x28(%ebp),%eax
  80193a:	89 45 f4             	mov    %eax,-0xc(%ebp)
    int ret;
    DIR *dirp = opendir(".");
  80193d:	c7 04 24 47 20 80 00 	movl   $0x802047,(%esp)
  801944:	e8 d7 e6 ff ff       	call   800020 <opendir>
  801949:	89 45 f0             	mov    %eax,-0x10(%ebp)
    
    if (dirp == NULL) {
  80194c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801950:	75 07                	jne    801959 <lsdir+0x28>
        return -1;
  801952:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801957:	eb 7e                	jmp    8019d7 <lsdir+0xa6>
    }
    struct dirent *direntp;
    while ((direntp = readdir(dirp)) != NULL) {
  801959:	eb 44                	jmp    80199f <lsdir+0x6e>
  ...
  80196b:	e8 d0 fe ff ff       	call   801840 <getstat>
  801970:	89 45 e8             	mov    %eax,-0x18(%ebp)
  801973:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  801977:	74 11                	je     80198a <lsdir+0x59>
            goto failed;
  801979:	90                   	nop
    }
    printf("lsdir: step 4\n");
...
failed:
  ...
  801980:	e8 44 e7 ff ff       	call   8000c9 <closedir>
    return ret;
  801985:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801988:	eb 4d                	jmp    8019d7 <lsdir+0xa6>
    struct dirent *direntp;
    while ((direntp = readdir(dirp)) != NULL) {
        if ((ret = getstat(direntp->name, stat)) != 0) {
            goto failed;
  ...
  80199a:	e8 ed fe ff ff       	call   80188c <lsstat>
  ...
  8019a5:	e8 ef e6 ff ff       	call   800099 <readdir>
  8019aa:	89 45 ec             	mov    %eax,-0x14(%ebp)
  8019ad:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8019b1:	75 a8                	jne    80195b <lsdir+0x2a>
        if ((ret = getstat(direntp->name, stat)) != 0) {
            goto failed;
        }
        lsstat(stat, direntp->name);
    ...
    printf("lsdir: step 4\n");
  8019b3:	c7 44 24 04 49 20 80 	movl   $0x802049,0x4(%esp)
  8019ba:	00 
  8019bb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  8019c2:	e8 22 eb ff ff       	call   8004e9 <fprintf>
    closedir(dirp);
  8019c7:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8019ca:	89 04 24             	mov    %eax,(%esp)
  8019cd:	e8 f7 e6 ff ff       	call   8000c9 <closedir>
    return 0;
...
ls(const char *path) {
  ...
  8019dc:	83 ec 38             	sub    $0x38,%esp
    struct stat __stat, *stat = &__stat;
  8019df:	8d 45 dc             	lea    -0x24(%ebp),%eax
  ...
  8019f2:	e8 49 fe ff ff       	call   801840 <getstat>
  8019f7:	89 45 ec             	mov    %eax,-0x14(%ebp)
  8019fa:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  8019fe:	74 08                	je     801a08 <ls+0x2f>
        return ret;
  801a00:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801a03:	e9 0d 01 00 00       	jmp    801b15 <ls+0x13c>
        " [ symlink ]",
        " [character]",
        " [  block  ]",
        " [  ?????  ]",
  ...
  801a10:	e8 bc fd ff ff       	call   8017d1 <getmode>
  801a15:	0f be c0             	movsbl %al,%eax
  801a18:	83 f8 63             	cmp    $0x63,%eax
  801a1b:	74 38                	je     801a55 <ls+0x7c>
  801a1d:	83 f8 63             	cmp    $0x63,%eax
  801a20:	7f 0c                	jg     801a2e <ls+0x55>
  801a22:	83 f8 30             	cmp    $0x30,%eax
  801a25:	74 13                	je     801a3a <ls+0x61>
  801a27:	83 f8 62             	cmp    $0x62,%eax
  801a2a:	74 32                	je     801a5e <ls+0x85>
  801a2c:	eb 39                	jmp    801a67 <ls+0x8e>
  801a2e:	83 f8 64             	cmp    $0x64,%eax
  801a31:	74 10                	je     801a43 <ls+0x6a>
  801a33:	83 f8 6c             	cmp    $0x6c,%eax
  801a36:	74 14                	je     801a4c <ls+0x73>
  801a38:	eb 2d                	jmp    801a67 <ls+0x8e>
    case '0': type = 0; break;
  801a3a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  801a41:	eb 2c                	jmp    801a6f <ls+0x96>
    case 'd': type = 1; break;
  801a43:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
  801a4a:	eb 23                	jmp    801a6f <ls+0x96>
    case 'l': type = 2; break;
  801a4c:	c7 45 f4 02 00 00 00 	movl   $0x2,-0xc(%ebp)
  801a53:	eb 1a                	jmp    801a6f <ls+0x96>
    case 'c': type = 3; break;
  801a55:	c7 45 f4 03 00 00 00 	movl   $0x3,-0xc(%ebp)
  801a5c:	eb 11                	jmp    801a6f <ls+0x96>
    case 'b': type = 4; break;
  801a5e:	c7 45 f4 04 00 00 00 	movl   $0x4,-0xc(%ebp)
  801a65:	eb 08                	jmp    801a6f <ls+0x96>
    default:  type = 5; break;
  801a67:	c7 45 f4 05 00 00 00 	movl   $0x5,-0xc(%ebp)
  801a6e:	90                   	nop
    }

    printf(" @ is %s", filetype[type]);
  801a6f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801a72:	8b 04 85 10 30 80 00 	mov    0x803010(,%eax,4),%eax
  801a79:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a7d:	c7 44 24 04 58 20 80 	movl   $0x802058,0x4(%esp)
  801a84:	00 
  801a85:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801a8c:	e8 58 ea ff ff       	call   8004e9 <fprintf>
    printf(" %d(hlinks)", stat->st_nlinks);
  801a91:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801a94:	8b 40 04             	mov    0x4(%eax),%eax
  801a97:	89 44 24 08          	mov    %eax,0x8(%esp)
  801a9b:	c7 44 24 04 61 20 80 	movl   $0x802061,0x4(%esp)
  801aa2:	00 
  801aa3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801aaa:	e8 3a ea ff ff       	call   8004e9 <fprintf>
    printf(" %d(blocks)", stat->st_blocks);
  801aaf:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801ab2:	8b 40 08             	mov    0x8(%eax),%eax
  801ab5:	89 44 24 08          	mov    %eax,0x8(%esp)
  801ab9:	c7 44 24 04 6d 20 80 	movl   $0x80206d,0x4(%esp)
  801ac0:	00 
  801ac1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801ac8:	e8 1c ea ff ff       	call   8004e9 <fprintf>
    printf(" %d(bytes) : @'%s'\n", stat->st_size, path);
  801acd:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801ad0:	8b 40 0c             	mov    0xc(%eax),%eax
  801ad3:	8b 55 08             	mov    0x8(%ebp),%edx
  801ad6:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801ada:	89 44 24 08          	mov    %eax,0x8(%esp)
  801ade:	c7 44 24 04 79 20 80 	movl   $0x802079,0x4(%esp)
  801ae5:	00 
  801ae6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  801aed:	e8 f7 e9 ff ff       	call   8004e9 <fprintf>
    if (S_ISDIR(stat->st_mode)) {
  801af2:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801af5:	8b 00                	mov    (%eax),%eax
  801af7:	25 00 70 00 00       	and    $0x7000,%eax
  801afc:	3d 00 20 00 00       	cmp    $0x2000,%eax
  801b01:	75 0d                	jne    801b10 <ls+0x137>
        return lsdir(path);
  801b03:	8b 45 08             	mov    0x8(%ebp),%eax
  801b06:	89 04 24             	mov    %eax,(%esp)
  801b09:	e8 23 fe ff ff       	call   801931 <lsdir>
  801b0e:	eb 05                	jmp    801b15 <ls+0x13c>
    }
    return 0;
...
main(int argc, char **argv) {
  ...
  801b1a:	83 e4 f0             	and    $0xfffffff0,%esp
  801b1d:	83 ec 20             	sub    $0x20,%esp
    if (argc == 1) {
  801b20:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
  801b24:	75 0e                	jne    801b34 <main+0x1d>
        return ls(".");
  801b26:	c7 04 24 47 20 80 00 	movl   $0x802047,(%esp)
  801b2d:	e8 a7 fe ff ff       	call   8019d9 <ls>
  801b32:	eb 48                	jmp    801b7c <main+0x65>
    }
    else {
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801b34:	c7 44 24 1c 01 00 00 	movl   $0x1,0x1c(%esp)
  801b3b:	00 
  801b3c:	eb 30                	jmp    801b6e <main+0x57>
            if ((ret = ls(argv[i])) != 0) {
  801b3e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b42:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801b49:	8b 45 0c             	mov    0xc(%ebp),%eax
  801b4c:	01 d0                	add    %edx,%eax
  801b4e:	8b 00                	mov    (%eax),%eax
  801b50:	89 04 24             	mov    %eax,(%esp)
  801b53:	e8 81 fe ff ff       	call   8019d9 <ls>
  801b58:	89 44 24 18          	mov    %eax,0x18(%esp)
  801b5c:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801b61:	74 06                	je     801b69 <main+0x52>
                return ret;
  801b63:	8b 44 24 18          	mov    0x18(%esp),%eax
  801b67:	eb 13                	jmp    801b7c <main+0x65>
    if (argc == 1) {
        return ls(".");
    }
    else {
        int i, ret;
        for (i = 1; i < argc; i ++) {
  801b69:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801b6e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801b72:	3b 45 08             	cmp    0x8(%ebp),%eax
  801b75:	7c c7                	jl     801b3e <main+0x27>
            if ((ret = ls(argv[i])) != 0) {
                return ret;
            }
        }
