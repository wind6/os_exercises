...
umain(int argc, char *argv[]) {
  ...
  800adb:	e8 a8 0d 00 00       	call   801888 <main>
...
forkchild(const char *cur, char branch) {
  ...
  8017d4:	83 ec 38             	sub    $0x38,%esp
  8017d7:	8b 45 0c             	mov    0xc(%ebp),%eax
  8017da:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  8017dd:	8b 45 08             	mov    0x8(%ebp),%eax
  8017e0:	89 04 24             	mov    %eax,(%esp)
  8017e3:	e8 0a fb ff ff       	call   8012f2 <strlen>
  8017e8:	83 f8 03             	cmp    $0x3,%eax
  8017eb:	77 4f                	ja     80183c <forkchild+0x6b>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  8017ed:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  8017f1:	89 44 24 10          	mov    %eax,0x10(%esp)
  8017f5:	8b 45 08             	mov    0x8(%ebp),%eax
  8017f8:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8017fc:	c7 44 24 08 80 1d 80 	movl   $0x801d80,0x8(%esp)
  801803:	00 
  801804:	c7 44 24 04 05 00 00 	movl   $0x5,0x4(%esp)
  80180b:	00 
  80180c:	8d 45 f3             	lea    -0xd(%ebp),%eax
  80180f:	89 04 24             	mov    %eax,(%esp)
  801812:	e8 63 f9 ff ff       	call   80117a <snprintf>
    if (fork() == 0) {
  801817:	e8 cb f0 ff ff       	call   8008e7 <fork>
  80181c:	85 c0                	test   %eax,%eax
  80181e:	75 1c                	jne    80183c <forkchild+0x6b>
        forktree(nxt);
  801820:	8d 45 f3             	lea    -0xd(%ebp),%eax
  801823:	89 04 24             	mov    %eax,(%esp)
  801826:	e8 13 00 00 00       	call   80183e <forktree>
        yield();
  80182b:	e8 fa f0 ff ff       	call   80092a <yield>
        exit(0);
  801830:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801837:	e8 8c f0 ff ff       	call   8008c8 <exit>
    }
}
  80183c:	c9                   	leave  
  80183d:	c3                   	ret    
...
forktree(const char *cur) {
  ...
  801841:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  801844:	e8 01 f1 ff ff       	call   80094a <getpid>
  801849:	8b 55 08             	mov    0x8(%ebp),%edx
  80184c:	89 54 24 08          	mov    %edx,0x8(%esp)
  801850:	89 44 24 04          	mov    %eax,0x4(%esp)
  801854:	c7 04 24 85 1d 80 00 	movl   $0x801d85,(%esp)
  80185b:	e8 a5 eb ff ff       	call   800405 <cprintf>

    forkchild(cur, '0');
  801860:	c7 44 24 04 30 00 00 	movl   $0x30,0x4(%esp)
  801867:	00 
  801868:	8b 45 08             	mov    0x8(%ebp),%eax
  80186b:	89 04 24             	mov    %eax,(%esp)
  80186e:	e8 5e ff ff ff       	call   8017d1 <forkchild>
    forkchild(cur, '1');
  801873:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  80187a:	00 
  80187b:	8b 45 08             	mov    0x8(%ebp),%eax
  80187e:	89 04 24             	mov    %eax,(%esp)
  801881:	e8 4b ff ff ff       	call   8017d1 <forkchild>
}
  801886:	c9                   	leave  
  801887:	c3                   	ret    
...
main(void) {
  ...
  80188b:	83 e4 f0             	and    $0xfffffff0,%esp
  80188e:	83 ec 10             	sub    $0x10,%esp
    cprintf("forktree process will sleep %d ticks\n",SLEEP_TIME);
  801891:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  801898:	00 
  801899:	c7 04 24 98 1d 80 00 	movl   $0x801d98,(%esp)
  8018a0:	e8 60 eb ff ff       	call   800405 <cprintf>
    sleep(SLEEP_TIME);
  8018a5:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  8018ac:	e8 c6 f0 ff ff       	call   800977 <sleep>
    forktree("");
  8018b1:	c7 04 24 be 1d 80 00 	movl   $0x801dbe,(%esp)
  8018b8:	e8 81 ff ff ff       	call   80183e <forktree>
    return 0;
