...
main(void) {
  ...
  8017da:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  8017df:	8b 00                	mov    (%eax),%eax
  8017e1:	89 44 24 04          	mov    %eax,0x4(%esp)
  8017e5:	c7 04 24 c0 1c 80 00 	movl   $0x801cc0,(%esp)
  8017ec:	e8 14 ec ff ff       	call   800405 <cprintf>
    panic("FAIL: T.T\n");
  8017f1:	c7 44 24 08 de 1c 80 	movl   $0x801cde,0x8(%esp)
  8017f8:	00 
  8017f9:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  801800:	00 
  801801:	c7 04 24 e9 1c 80 00 	movl   $0x801ce9,(%esp)
  801808:	e8 07 eb ff ff       	call   800314 <__panic>
