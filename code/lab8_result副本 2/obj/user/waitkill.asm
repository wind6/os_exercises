...
open(const char *path, uint32_t open_flags) {
  ...
  80011a:	c7 04 24 80 19 80 00 	movl   $0x801980,(%esp)
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  80028e:	c7 04 24 90 19 80 00 	movl   $0x801990,(%esp)
  ...
  8002ac:	c7 04 24 9b 19 80 00 	movl   $0x80199b,(%esp)
  ...
  8002c2:	c7 04 24 ad 19 80 00 	movl   $0x8019ad,(%esp)
  ...
  8002d8:	c7 04 24 c0 19 80 00 	movl   $0x8019c0,(%esp)
  ...
  8002ee:	c7 04 24 d3 19 80 00 	movl   $0x8019d3,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80032e:	c7 04 24 e6 19 80 00 	movl   $0x8019e6,(%esp)
  ...
  800347:	e8 7e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80034c:	c7 04 24 00 1a 80 00 	movl   $0x801a00,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80037e:	c7 04 24 02 1a 80 00 	movl   $0x801a02,(%esp)
  ...
  800397:	e8 2e 00 00 00       	call   8003ca <vcprintf>
    cprintf("\n");
  80039c:	c7 04 24 00 1a 80 00 	movl   $0x801a00,(%esp)
...
exit(int error_code) {
  ...
  8008d9:	c7 04 24 1e 1a 80 00 	movl   $0x801a1e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a45:	00 
  800a46:	c7 44 24 04 31 1a 80 	movl   $0x801a31,0x4(%esp)
  800a4d:	00 
  ...
  800a6a:	c7 44 24 08 38 1a 80 	movl   $0x801a38,0x8(%esp)
  800a71:	00 
  800a72:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a79:	00 
  800a7a:	c7 04 24 52 1a 80 00 	movl   $0x801a52,(%esp)
  800a81:	e8 de f8 ff ff       	call   800364 <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a86:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a8d:	00 
  800a8e:	c7 44 24 04 64 1a 80 	movl   $0x801a64,0x4(%esp)
  800a95:	00 
  ...
  800ab2:	c7 44 24 08 6c 1a 80 	movl   $0x801a6c,0x8(%esp)
  800ab9:	00 
  800aba:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800ac1:	00 
  800ac2:	c7 04 24 52 1a 80 00 	movl   $0x801a52,(%esp)
  ...
  800adb:	e8 99 0d 00 00       	call   801879 <main>
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c0a:	05 a4 1c 80 00       	add    $0x801ca4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d6e:	8b 04 85 c8 1c 80 00 	mov    0x801cc8(,%eax,4),%eax
  ...
  800e87:	c7 44 24 0c be 1c 80 	movl   $0x801cbe,0xc(%esp)
  800e8e:	00 
  ...
  800eba:	75 05                	jne    800ec1 <vprintfmt+0x1c9>
                p = "(null)";
  800ebc:	be c1 1c 80 00       	mov    $0x801cc1,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  8017d4:	83 ec 08             	sub    $0x8,%esp
    yield();
  8017d7:	e8 4e f1 ff ff       	call   80092a <yield>
    yield();
  8017dc:	e8 49 f1 ff ff       	call   80092a <yield>
    yield();
  8017e1:	e8 44 f1 ff ff       	call   80092a <yield>
    yield();
  8017e6:	e8 3f f1 ff ff       	call   80092a <yield>
    yield();
  8017eb:	e8 3a f1 ff ff       	call   80092a <yield>
    yield();
  8017f0:	e8 35 f1 ff ff       	call   80092a <yield>
}
  8017f5:	c9                   	leave  
  8017f6:	c3                   	ret    
...
loop(void) {
  ...
  8017fa:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  8017fd:	c7 04 24 20 1e 80 00 	movl   $0x801e20,(%esp)
  801804:	e8 fc eb ff ff       	call   800405 <cprintf>
    while (1);
  801809:	eb fe                	jmp    801809 <loop+0x12>
...
work(void) {
  ...
  80180e:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  801811:	c7 04 24 2a 1e 80 00 	movl   $0x801e2a,(%esp)
  801818:	e8 e8 eb ff ff       	call   800405 <cprintf>
    do_yield();
  80181d:	e8 af ff ff ff       	call   8017d1 <do_yield>
    if (kill(parent) == 0) {
  801822:	a1 68 21 80 00       	mov    0x802168,%eax
  801827:	89 04 24             	mov    %eax,(%esp)
  80182a:	e8 08 f1 ff ff       	call   800937 <kill>
  80182f:	85 c0                	test   %eax,%eax
  801831:	75 3a                	jne    80186d <work+0x62>
        cprintf("kill parent ok.\n");
  801833:	c7 04 24 34 1e 80 00 	movl   $0x801e34,(%esp)
  80183a:	e8 c6 eb ff ff       	call   800405 <cprintf>
        do_yield();
  80183f:	e8 8d ff ff ff       	call   8017d1 <do_yield>
        if (kill(pid1) == 0) {
  801844:	a1 70 21 80 00       	mov    0x802170,%eax
  801849:	89 04 24             	mov    %eax,(%esp)
  80184c:	e8 e6 f0 ff ff       	call   800937 <kill>
  801851:	85 c0                	test   %eax,%eax
  801853:	75 18                	jne    80186d <work+0x62>
            cprintf("kill child1 ok.\n");
  801855:	c7 04 24 45 1e 80 00 	movl   $0x801e45,(%esp)
  80185c:	e8 a4 eb ff ff       	call   800405 <cprintf>
            exit(0);
  801861:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801868:	e8 5b f0 ff ff       	call   8008c8 <exit>
        }
    }
    exit(-1);
  80186d:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801874:	e8 4f f0 ff ff       	call   8008c8 <exit>
...
main(void) {
  ...
  80187c:	83 e4 f0             	and    $0xfffffff0,%esp
  80187f:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  801882:	e8 c3 f0 ff ff       	call   80094a <getpid>
  801887:	a3 68 21 80 00       	mov    %eax,0x802168
    if ((pid1 = fork()) == 0) {
  80188c:	e8 56 f0 ff ff       	call   8008e7 <fork>
  801891:	a3 70 21 80 00       	mov    %eax,0x802170
  801896:	a1 70 21 80 00       	mov    0x802170,%eax
  80189b:	85 c0                	test   %eax,%eax
  80189d:	75 05                	jne    8018a4 <main+0x2b>
        loop();
  80189f:	e8 53 ff ff ff       	call   8017f7 <loop>
    }

    assert(pid1 > 0);
  8018a4:	a1 70 21 80 00       	mov    0x802170,%eax
  8018a9:	85 c0                	test   %eax,%eax
  8018ab:	7f 24                	jg     8018d1 <main+0x58>
  8018ad:	c7 44 24 0c 56 1e 80 	movl   $0x801e56,0xc(%esp)
  8018b4:	00 
  8018b5:	c7 44 24 08 5f 1e 80 	movl   $0x801e5f,0x8(%esp)
  8018bc:	00 
  8018bd:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  8018c4:	00 
  8018c5:	c7 04 24 74 1e 80 00 	movl   $0x801e74,(%esp)
  8018cc:	e8 43 ea ff ff       	call   800314 <__panic>

    if ((pid2 = fork()) == 0) {
  8018d1:	e8 11 f0 ff ff       	call   8008e7 <fork>
  8018d6:	a3 6c 21 80 00       	mov    %eax,0x80216c
  8018db:	a1 6c 21 80 00       	mov    0x80216c,%eax
  8018e0:	85 c0                	test   %eax,%eax
  8018e2:	75 05                	jne    8018e9 <main+0x70>
        work();
  8018e4:	e8 22 ff ff ff       	call   80180b <work>
    }
    if (pid2 > 0) {
  8018e9:	a1 6c 21 80 00       	mov    0x80216c,%eax
  8018ee:	85 c0                	test   %eax,%eax
  8018f0:	7e 46                	jle    801938 <main+0xbf>
        cprintf("wait child 1.\n");
  8018f2:	c7 04 24 84 1e 80 00 	movl   $0x801e84,(%esp)
  8018f9:	e8 07 eb ff ff       	call   800405 <cprintf>
        waitpid(pid1, NULL);
  8018fe:	a1 70 21 80 00       	mov    0x802170,%eax
  801903:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80190a:	00 
  80190b:	89 04 24             	mov    %eax,(%esp)
  80190e:	e8 fd ef ff ff       	call   800910 <waitpid>
        panic("waitpid %d returns\n", pid1);
  801913:	a1 70 21 80 00       	mov    0x802170,%eax
  801918:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80191c:	c7 44 24 08 93 1e 80 	movl   $0x801e93,0x8(%esp)
  801923:	00 
  801924:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  80192b:	00 
  80192c:	c7 04 24 74 1e 80 00 	movl   $0x801e74,(%esp)
  801933:	e8 dc e9 ff ff       	call   800314 <__panic>
    }
    else {
        kill(pid1);
  801938:	a1 70 21 80 00       	mov    0x802170,%eax
  80193d:	89 04 24             	mov    %eax,(%esp)
  801940:	e8 f2 ef ff ff       	call   800937 <kill>
    }
    panic("FAIL: T.T\n");
  801945:	c7 44 24 08 a7 1e 80 	movl   $0x801ea7,0x8(%esp)
  80194c:	00 
  80194d:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  801954:	00 
  801955:	c7 04 24 74 1e 80 00 	movl   $0x801e74,(%esp)
  80195c:	e8 b3 e9 ff ff       	call   800314 <__panic>
